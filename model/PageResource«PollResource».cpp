...
PageResource«PollResource»::PageResource«PollResource»()
{
...
void PageResource«PollResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«PollResource»::toJson() const
{
...
void PageResource«PollResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<PollResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<PollResource> newItem(new PollResource());
...
void PageResource«PollResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«PollResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<PollResource>>& PageResource«PollResource»::getContent()
{
    return m_Content;
}

void PageResource«PollResource»::setContent(std::vector<std::shared_ptr<PollResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«PollResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«PollResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«PollResource»::getFirst() const
{
    return m_First;
}


void PageResource«PollResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«PollResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«PollResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«PollResource»::getLast() const
{
    return m_Last;
}


void PageResource«PollResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«PollResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«PollResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«PollResource»::getNumber() const
{
    return m_number;
}


void PageResource«PollResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«PollResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«PollResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«PollResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«PollResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«PollResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«PollResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«PollResource»::getSize() const
{
    return m_Size;
}


void PageResource«PollResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«PollResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«PollResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«PollResource»::getSort()
{
    return m_Sort;
}

void PageResource«PollResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«PollResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«PollResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«PollResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«PollResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«PollResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«PollResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«PollResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«PollResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«PollResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«PollResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
