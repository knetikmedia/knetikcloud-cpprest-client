...
PageResource«ChatMessageResource»::PageResource«ChatMessageResource»()
{
...
void PageResource«ChatMessageResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«ChatMessageResource»::toJson() const
{
...
void PageResource«ChatMessageResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<ChatMessageResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<ChatMessageResource> newItem(new ChatMessageResource());
...
void PageResource«ChatMessageResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«ChatMessageResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<ChatMessageResource>>& PageResource«ChatMessageResource»::getContent()
{
    return m_Content;
}

void PageResource«ChatMessageResource»::setContent(std::vector<std::shared_ptr<ChatMessageResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«ChatMessageResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«ChatMessageResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«ChatMessageResource»::getFirst() const
{
    return m_First;
}


void PageResource«ChatMessageResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«ChatMessageResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«ChatMessageResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«ChatMessageResource»::getLast() const
{
    return m_Last;
}


void PageResource«ChatMessageResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«ChatMessageResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«ChatMessageResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«ChatMessageResource»::getNumber() const
{
    return m_number;
}


void PageResource«ChatMessageResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«ChatMessageResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«ChatMessageResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«ChatMessageResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«ChatMessageResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«ChatMessageResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«ChatMessageResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«ChatMessageResource»::getSize() const
{
    return m_Size;
}


void PageResource«ChatMessageResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«ChatMessageResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«ChatMessageResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«ChatMessageResource»::getSort()
{
    return m_Sort;
}

void PageResource«ChatMessageResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«ChatMessageResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«ChatMessageResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«ChatMessageResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«ChatMessageResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«ChatMessageResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«ChatMessageResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«ChatMessageResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«ChatMessageResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«ChatMessageResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«ChatMessageResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
