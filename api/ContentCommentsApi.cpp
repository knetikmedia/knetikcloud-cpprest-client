...
pplx::task<std::shared_ptr<PageResource«CommentResource»>> ContentCommentsApi::searchComments(std::shared_ptr<Object> query, int32_t size, int32_t page)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , U("error calling searchComments: unsupported response type"));
        }
