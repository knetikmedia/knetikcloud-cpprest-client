...
PageResource«VideoResource»::PageResource«VideoResource»()
{
...
void PageResource«VideoResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«VideoResource»::toJson() const
{
...
void PageResource«VideoResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<VideoResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<VideoResource> newItem(new VideoResource());
...
void PageResource«VideoResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«VideoResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<VideoResource>>& PageResource«VideoResource»::getContent()
{
    return m_Content;
}

void PageResource«VideoResource»::setContent(std::vector<std::shared_ptr<VideoResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«VideoResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«VideoResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«VideoResource»::getFirst() const
{
    return m_First;
}


void PageResource«VideoResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«VideoResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«VideoResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«VideoResource»::getLast() const
{
    return m_Last;
}


void PageResource«VideoResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«VideoResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«VideoResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«VideoResource»::getNumber() const
{
    return m_number;
}


void PageResource«VideoResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«VideoResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«VideoResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«VideoResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«VideoResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«VideoResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«VideoResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«VideoResource»::getSize() const
{
    return m_Size;
}


void PageResource«VideoResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«VideoResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«VideoResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«VideoResource»::getSort()
{
    return m_Sort;
}

void PageResource«VideoResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«VideoResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«VideoResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«VideoResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«VideoResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«VideoResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«VideoResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«VideoResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«VideoResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«VideoResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«VideoResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
