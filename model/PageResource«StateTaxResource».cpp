...
PageResource«StateTaxResource»::PageResource«StateTaxResource»()
{
...
void PageResource«StateTaxResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«StateTaxResource»::toJson() const
{
...
void PageResource«StateTaxResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<StateTaxResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<StateTaxResource> newItem(new StateTaxResource());
...
void PageResource«StateTaxResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«StateTaxResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<StateTaxResource>>& PageResource«StateTaxResource»::getContent()
{
    return m_Content;
}

void PageResource«StateTaxResource»::setContent(std::vector<std::shared_ptr<StateTaxResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«StateTaxResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«StateTaxResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«StateTaxResource»::getFirst() const
{
    return m_First;
}


void PageResource«StateTaxResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«StateTaxResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«StateTaxResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«StateTaxResource»::getLast() const
{
    return m_Last;
}


void PageResource«StateTaxResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«StateTaxResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«StateTaxResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«StateTaxResource»::getNumber() const
{
    return m_number;
}


void PageResource«StateTaxResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«StateTaxResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«StateTaxResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«StateTaxResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«StateTaxResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«StateTaxResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«StateTaxResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«StateTaxResource»::getSize() const
{
    return m_Size;
}


void PageResource«StateTaxResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«StateTaxResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«StateTaxResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«StateTaxResource»::getSort()
{
    return m_Sort;
}

void PageResource«StateTaxResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«StateTaxResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«StateTaxResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«StateTaxResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«StateTaxResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«StateTaxResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«StateTaxResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«StateTaxResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«StateTaxResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«StateTaxResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«StateTaxResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
