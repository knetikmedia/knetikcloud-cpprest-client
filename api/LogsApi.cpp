...
pplx::task<std::shared_ptr<BreEventLog>> LogsApi::getBREEventLog(utility::string_t id)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , U("error calling getBREEventLog: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<PageResource«BreEventLog»>> LogsApi::getBREEventLogs(utility::string_t filterStartDate, utility::string_t filterEventName, utility::string_t filterEventId, int32_t size, int32_t page, utility::string_t order)
{
    ...
    {
        queryParams[U("filter_event_id")] = ApiClient::parameterToString(filterEventId);
    }
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , U("error calling getBREEventLogs: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<ForwardLog>> LogsApi::getBREForwardLog(utility::string_t id)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , U("error calling getBREForwardLog: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<PageResource«ForwardLog»>> LogsApi::getBREForwardLogs(utility::string_t filterStartDate, utility::string_t filterEndDate, int32_t filterStatusCode, int32_t size, int32_t page, utility::string_t order)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , U("error calling getBREForwardLogs: unsupported response type"));
        }
...
pplx::task<std::shared_ptr<UserActionLog>> LogsApi::getUserLog(utility::string_t id)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , U("error calling getUserLog: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<PageResource«UserActionLog»>> LogsApi::getUserLogs(int32_t filterUser, utility::string_t filterActionName, int32_t size, int32_t page, utility::string_t order)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , U("error calling getUserLogs: unsupported response type"));
        }
