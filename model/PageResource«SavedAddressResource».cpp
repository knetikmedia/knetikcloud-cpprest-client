...
PageResource«SavedAddressResource»::PageResource«SavedAddressResource»()
{
...
void PageResource«SavedAddressResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«SavedAddressResource»::toJson() const
{
...
void PageResource«SavedAddressResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<SavedAddressResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<SavedAddressResource> newItem(new SavedAddressResource());
...
void PageResource«SavedAddressResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«SavedAddressResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<SavedAddressResource>>& PageResource«SavedAddressResource»::getContent()
{
    return m_Content;
}

void PageResource«SavedAddressResource»::setContent(std::vector<std::shared_ptr<SavedAddressResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«SavedAddressResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«SavedAddressResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«SavedAddressResource»::getFirst() const
{
    return m_First;
}


void PageResource«SavedAddressResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«SavedAddressResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«SavedAddressResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«SavedAddressResource»::getLast() const
{
    return m_Last;
}


void PageResource«SavedAddressResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«SavedAddressResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«SavedAddressResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«SavedAddressResource»::getNumber() const
{
    return m_number;
}


void PageResource«SavedAddressResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«SavedAddressResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«SavedAddressResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«SavedAddressResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«SavedAddressResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«SavedAddressResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«SavedAddressResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«SavedAddressResource»::getSize() const
{
    return m_Size;
}


void PageResource«SavedAddressResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«SavedAddressResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«SavedAddressResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«SavedAddressResource»::getSort()
{
    return m_Sort;
}

void PageResource«SavedAddressResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«SavedAddressResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«SavedAddressResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«SavedAddressResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«SavedAddressResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«SavedAddressResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«SavedAddressResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«SavedAddressResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«SavedAddressResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«SavedAddressResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«SavedAddressResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
