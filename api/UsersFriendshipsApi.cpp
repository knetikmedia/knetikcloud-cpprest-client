...
pplx::task<std::shared_ptr<PageResource«SimpleUserResource»>> UsersFriendshipsApi::getFriends(utility::string_t userId, utility::string_t filterUsername, int32_t filterUserId, int32_t size, int32_t page)
{
...
pplx::task<void> UsersFriendshipsApi::redeemFriendshipToken(utility::string_t userId, std::shared_ptr<StringWrapper> token)
{
