...
Payments_XsollaApi::Payments_XsollaApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<utility::string_t> Payments_XsollaApi::createXsollaTokenUrl(std::shared_ptr<XsollaPaymentRequest> request)
{
    ...
    {
        throw ApiException(400, U("Payments_XsollaApi->createXsollaTokenUrl does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Payments_XsollaApi->createXsollaTokenUrl does not consume any supported media type"));
    }
