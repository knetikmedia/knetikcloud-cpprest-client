...
pplx::task<void> SearchApi::addSearchIndex(utility::string_t type, utility::string_t id, std::shared_ptr<Object> object)
{
    

    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/search/index/{type}/{id}");
...
boost::replace_all(path, U("{") U("id") U("}"), ApiClient::parameterToString(id));
    ...
    {
        throw ApiException(400, U("SearchApi->addSearchIndex does not produce any supported media type"));
    }
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
                if(object.get())
        {
            object->toMultipart(multipart, U("object"));
        }
    ...
    {
        throw ApiException(415, U("SearchApi->addSearchIndex does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        if (response.status_code() >= 400)
        {
            throw ApiException(response.status_code()
                , U("error calling addSearchIndex: ") + response.reason_phrase()
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            if( contentType.find(responseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , U("error calling addSearchIndex: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> SearchApi::addSearchMappings(std::vector<std::shared_ptr<SearchReferenceMapping>> mappings)
{
    

    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/search/mappings");
    ...
    {
        throw ApiException(400, U("SearchApi->addSearchMappings does not produce any supported media type"));
    }
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
        {
            ...
            multipart->add(ModelBase::toHttpContent(U("mappings"), web::json::value::array(jsonArray), U("application/json")));
        }
    ...
    {
        throw ApiException(415, U("SearchApi->addSearchMappings does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling addSearchMappings: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling addSearchMappings: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> SearchApi::deleteSearchIndex(utility::string_t type, utility::string_t id)
{
...
boost::replace_all(path, U("{") U("id") U("}"), ApiClient::parameterToString(id));
    ...
    {
        throw ApiException(400, U("SearchApi->deleteSearchIndex does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("SearchApi->deleteSearchIndex does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling deleteSearchIndex: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling deleteSearchIndex: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<void> SearchApi::deleteSearchIndexes(utility::string_t type)
{
    ...
    {
        throw ApiException(400, U("SearchApi->deleteSearchIndexes does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("SearchApi->deleteSearchIndexes does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling deleteSearchIndexes: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling deleteSearchIndexes: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
