...
/*
 * PageResource«BillingReport».h
 *
 * 
 */

#ifndef PageResource«BillingReport»_H_
#define PageResource«BillingReport»_H_
...
/// 
/// </summary>
class  PageResource«BillingReport»
    : public ModelBase
{
public:
    PageResource«BillingReport»();
    virtual ~PageResource«BillingReport»();
    ...
    /////////////////////////////////////////////
    /// PageResource«BillingReport» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BillingReport>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<BillingReport>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<BillingReport>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«BillingReport»_H_ */
