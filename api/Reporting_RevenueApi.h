...
/*
 * Reporting_RevenueApi.h
 *
 * 
 */

#ifndef Reporting_RevenueApi_H_
#define Reporting_RevenueApi_H_
...
{
public:
    Reporting_RevenueApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Reporting_RevenueApi();
    /// <summary>
