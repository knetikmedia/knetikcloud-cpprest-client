...
bool PropertyFieldResource::inner_typeIsSet() const
{
...
bool PropertyFieldResource::inner_type_fieldsIsSet() const
{
...
bool PropertyFieldResource::valid_valuesIsSet() const
{
