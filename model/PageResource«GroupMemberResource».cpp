...
void PageResource«GroupMemberResource»::setContent(std::vector<std::shared_ptr<GroupMemberResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
bool PageResource«GroupMemberResource»::numberOfElementsIsSet() const
{
...
void PageResource«GroupMemberResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
...
bool PageResource«GroupMemberResource»::totalElementsIsSet() const
{
...
bool PageResource«GroupMemberResource»::totalPagesIsSet() const
{
