...
Sku::Sku()
{
    ...
    m_Not_available = false;
    m_Not_availableIsSet = false;
    m_Not_displayable = false;
    m_Not_displayableIsSet = false;
...
web::json::value Sku::toJson() const
{
    ...
    if(m_Not_availableIsSet)
    {
        val[U("not_available")] = ModelBase::toJson(m_Not_available);
    }
    if(m_Not_displayableIsSet)
    {
        val[U("not_displayable")] = ModelBase::toJson(m_Not_displayable);
    }
...
void Sku::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("not_available")))
    {
        setNotAvailable(ModelBase::boolFromJson(val[U("not_available")]));
    }
    if(val.has_field(U("not_displayable")))
    {
        setNotDisplayable(ModelBase::boolFromJson(val[U("not_displayable")]));
    }
...
void Sku::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Not_availableIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + U("not_available"), m_Not_available));
    }
    if(m_Not_displayableIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + U("not_displayable"), m_Not_displayable));
    }
...
void Sku::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(U("not_available")))
    {
        setNotAvailable(ModelBase::boolFromHttpContent(multipart->getContent(U("not_available"))));
    }
    if(multipart->hasContent(U("not_displayable")))
    {
        setNotDisplayable(ModelBase::boolFromHttpContent(multipart->getContent(U("not_displayable"))));
    }
...
bool Sku::getNotAvailable() const
{
    return m_Not_available;
}


void Sku::setNotAvailable(bool value)
{
    m_Not_available = value;
    m_Not_availableIsSet = true;
}
bool Sku::notAvailableIsSet() const
{
    return m_Not_availableIsSet;
}

void Sku::unsetNot_available()
{
    m_Not_availableIsSet = false;
}

bool Sku::getNotDisplayable() const
{
    return m_Not_displayable;
}


void Sku::setNotDisplayable(bool value)
{
    m_Not_displayable = value;
    m_Not_displayableIsSet = true;
}
bool Sku::notDisplayableIsSet() const
{
    return m_Not_displayableIsSet;
}

void Sku::unsetNot_displayable()
{
    m_Not_displayableIsSet = false;
}
