...
/*
 * Rule_Engine_TriggersApi.h
 *
 * 
 */

#ifndef Rule_Engine_TriggersApi_H_
#define Rule_Engine_TriggersApi_H_
...
class  Rule_Engine_TriggersApi
{
public:
    Rule_Engine_TriggersApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Rule_Engine_TriggersApi();
    /// <summary>
    /// Create a trigger
    /// </summary>
    /// <remarks>
...
#endif /* Rule_Engine_TriggersApi_H_ */
