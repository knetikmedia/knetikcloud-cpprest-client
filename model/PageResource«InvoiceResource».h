...
/*
 * PageResource«InvoiceResource».h
 *
 * 
 */

#ifndef PageResource«InvoiceResource»_H_
#define PageResource«InvoiceResource»_H_
...
/// 
/// </summary>
class  PageResource«InvoiceResource»
    : public ModelBase
{
public:
    PageResource«InvoiceResource»();
    virtual ~PageResource«InvoiceResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«InvoiceResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<InvoiceResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<InvoiceResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<InvoiceResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«InvoiceResource»_H_ */
