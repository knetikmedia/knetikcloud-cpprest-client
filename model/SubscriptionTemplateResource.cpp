...
bool SubscriptionTemplateResource::getAllowAdditional() const
{
    return m_Allow_additional;
}


void SubscriptionTemplateResource::setAllowAdditional(bool value)
{
    m_Allow_additional = value;
    m_Allow_additionalIsSet = true;
}
bool SubscriptionTemplateResource::allowAdditionalIsSet() const
{
    return m_Allow_additionalIsSet;
}

void SubscriptionTemplateResource::unsetAllow_additional()
{
    m_Allow_additionalIsSet = false;
}
...
bool SubscriptionTemplateResource::createdDateIsSet() const
{
...
bool SubscriptionTemplateResource::planTemplateIsSet() const
{
...
void SubscriptionTemplateResource::setProperties(std::vector<std::shared_ptr<PropertyDefinitionResource>> value)
{
    m_Properties = value;
...
bool SubscriptionTemplateResource::updatedDateIsSet() const
{
