...
/*
 * PageResource«MessageTemplateResource».h
 *
 * 
 */

#ifndef PageResource«MessageTemplateResource»_H_
#define PageResource«MessageTemplateResource»_H_
...
public:
    ...
    virtual ~PageResource«MessageTemplateResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«MessageTemplateResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<MessageTemplateResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<MessageTemplateResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<MessageTemplateResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«MessageTemplateResource»_H_ */
