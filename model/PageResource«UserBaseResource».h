...
/*
 * PageResource«UserBaseResource».h
 *
 * 
 */

#ifndef PageResource«UserBaseResource»_H_
#define PageResource«UserBaseResource»_H_
...
/// 
/// </summary>
class  PageResource«UserBaseResource»
    : public ModelBase
{
public:
    PageResource«UserBaseResource»();
    virtual ~PageResource«UserBaseResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«UserBaseResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UserBaseResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<UserBaseResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<UserBaseResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«UserBaseResource»_H_ */
