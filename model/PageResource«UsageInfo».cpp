...
bool PageResource«UsageInfo»::number_of_elementsIsSet() const
{
...
bool PageResource«UsageInfo»::total_elementsIsSet() const
{
...
bool PageResource«UsageInfo»::total_pagesIsSet() const
{
