...
bool ActivityOccurrenceResource::challengeActivityIdIsSet() const
{
...
bool ActivityOccurrenceResource::createdDateIsSet() const
{
...
bool ActivityOccurrenceResource::eventIdIsSet() const
{
...
bool ActivityOccurrenceResource::rewardStatusIsSet() const
{
...
void ActivityOccurrenceResource::setSettings(std::vector<std::shared_ptr<SelectedSettingResource>> value)
{
    m_Settings = value;
...
bool ActivityOccurrenceResource::startDateIsSet() const
{
...
bool ActivityOccurrenceResource::updatedDateIsSet() const
{
...
void ActivityOccurrenceResource::setUsers(std::vector<std::shared_ptr<ActivityUserResource>> value)
{
    m_Users = value;
    m_UsersIsSet = true;
}
