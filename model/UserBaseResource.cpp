...
bool UserBaseResource::avatarUrlIsSet() const
{
...
bool UserBaseResource::displayNameIsSet() const
{
...
int64_t UserBaseResource::getLastActivity() const
{
    return m_Last_activity;
}


void UserBaseResource::setLastActivity(int64_t value)
{
    m_Last_activity = value;
    m_Last_activityIsSet = true;
}
bool UserBaseResource::lastActivityIsSet() const
{
    return m_Last_activityIsSet;
}

void UserBaseResource::unsetLast_activity()
{
    m_Last_activityIsSet = false;
}

int64_t UserBaseResource::getLastUpdated() const
{
    return m_Last_updated;
}


void UserBaseResource::setLastUpdated(int64_t value)
{
    m_Last_updated = value;
    m_Last_updatedIsSet = true;
}
bool UserBaseResource::lastUpdatedIsSet() const
{
    return m_Last_updatedIsSet;
}

void UserBaseResource::unsetLast_updated()
{
    m_Last_updatedIsSet = false;
}

int64_t UserBaseResource::getMemberSince() const
{
    return m_Member_since;
}


void UserBaseResource::setMemberSince(int64_t value)
{
    m_Member_since = value;
    m_Member_sinceIsSet = true;
}
bool UserBaseResource::memberSinceIsSet() const
{
    return m_Member_sinceIsSet;
}

void UserBaseResource::unsetMember_since()
{
    m_Member_sinceIsSet = false;
}
