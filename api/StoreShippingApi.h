...
#ifndef StoreShippingApi_H_
#define StoreShippingApi_H_
...
{
public:
    StoreShippingApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~StoreShippingApi();
    /// <summary>
