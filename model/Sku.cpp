...
bool Sku::additional_propertiesIsSet() const
{
...
bool Sku::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}
void Sku::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
bool Sku::min_inventory_thresholdIsSet() const
{
...
bool Sku::start_dateIsSet() const
{
