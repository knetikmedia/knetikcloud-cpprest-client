...
PageResource«ChallengeEventResource»::PageResource«ChallengeEventResource»()
{
...
void PageResource«ChallengeEventResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«ChallengeEventResource»::toJson() const
{
...
void PageResource«ChallengeEventResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<ChallengeEventResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<ChallengeEventResource> newItem(new ChallengeEventResource());
...
void PageResource«ChallengeEventResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«ChallengeEventResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<ChallengeEventResource>>& PageResource«ChallengeEventResource»::getContent()
{
    return m_Content;
}

void PageResource«ChallengeEventResource»::setContent(std::vector<std::shared_ptr<ChallengeEventResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«ChallengeEventResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«ChallengeEventResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«ChallengeEventResource»::getFirst() const
{
    return m_First;
}


void PageResource«ChallengeEventResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«ChallengeEventResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«ChallengeEventResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«ChallengeEventResource»::getLast() const
{
    return m_Last;
}


void PageResource«ChallengeEventResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«ChallengeEventResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«ChallengeEventResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«ChallengeEventResource»::getNumber() const
{
    return m_number;
}


void PageResource«ChallengeEventResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«ChallengeEventResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«ChallengeEventResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«ChallengeEventResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«ChallengeEventResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«ChallengeEventResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«ChallengeEventResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«ChallengeEventResource»::getSize() const
{
    return m_Size;
}


void PageResource«ChallengeEventResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«ChallengeEventResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«ChallengeEventResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«ChallengeEventResource»::getSort()
{
    return m_Sort;
}

void PageResource«ChallengeEventResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«ChallengeEventResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«ChallengeEventResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«ChallengeEventResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«ChallengeEventResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«ChallengeEventResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«ChallengeEventResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«ChallengeEventResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«ChallengeEventResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«ChallengeEventResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«ChallengeEventResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
