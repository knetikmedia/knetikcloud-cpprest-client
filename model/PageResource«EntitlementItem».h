...
/*
 * PageResource«EntitlementItem».h
 *
 * 
 */

#ifndef PageResource«EntitlementItem»_H_
#define PageResource«EntitlementItem»_H_
...
/// 
/// </summary>
class  PageResource«EntitlementItem»
    : public ModelBase
{
public:
    PageResource«EntitlementItem»();
    virtual ~PageResource«EntitlementItem»();
    ...
    /////////////////////////////////////////////
    /// PageResource«EntitlementItem» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<EntitlementItem>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<EntitlementItem>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<EntitlementItem>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«EntitlementItem»_H_ */
