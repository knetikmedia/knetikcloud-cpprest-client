...
/*
 * PageResource«FulfillmentType».h
 *
 * 
 */

#ifndef PageResource«FulfillmentType»_H_
#define PageResource«FulfillmentType»_H_
...
/// 
/// </summary>
class  PageResource«FulfillmentType»
    : public ModelBase
{
public:
    PageResource«FulfillmentType»();
    virtual ~PageResource«FulfillmentType»();
    ...
    /////////////////////////////////////////////
    /// PageResource«FulfillmentType» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<FulfillmentType>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<FulfillmentType>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<FulfillmentType>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«FulfillmentType»_H_ */
