...
/*
 * PageResource«VideoResource».h
 *
 * 
 */

#ifndef PageResource«VideoResource»_H_
#define PageResource«VideoResource»_H_
...
/// 
/// </summary>
class  PageResource«VideoResource»
    : public ModelBase
{
public:
    PageResource«VideoResource»();
    virtual ~PageResource«VideoResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«VideoResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<VideoResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<VideoResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<VideoResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«VideoResource»_H_ */
