...
bool PageResource«Map«string,object»»::number_of_elementsIsSet() const
{
...
bool PageResource«Map«string,object»»::total_elementsIsSet() const
{
...
bool PageResource«Map«string,object»»::total_pagesIsSet() const
{
