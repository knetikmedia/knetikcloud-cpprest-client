...
PageResource«RevenueProductReportResource»::PageResource«RevenueProductReportResource»()
{
...
void PageResource«RevenueProductReportResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«RevenueProductReportResource»::toJson() const
{
...
void PageResource«RevenueProductReportResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<RevenueProductReportResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<RevenueProductReportResource> newItem(new RevenueProductReportResource());
...
void PageResource«RevenueProductReportResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«RevenueProductReportResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<RevenueProductReportResource>>& PageResource«RevenueProductReportResource»::getContent()
{
    return m_Content;
}

void PageResource«RevenueProductReportResource»::setContent(std::vector<std::shared_ptr<RevenueProductReportResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«RevenueProductReportResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«RevenueProductReportResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«RevenueProductReportResource»::getFirst() const
{
    return m_First;
}


void PageResource«RevenueProductReportResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«RevenueProductReportResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«RevenueProductReportResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«RevenueProductReportResource»::getLast() const
{
    return m_Last;
}


void PageResource«RevenueProductReportResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«RevenueProductReportResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«RevenueProductReportResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«RevenueProductReportResource»::getNumber() const
{
    return m_number;
}


void PageResource«RevenueProductReportResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«RevenueProductReportResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«RevenueProductReportResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«RevenueProductReportResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«RevenueProductReportResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«RevenueProductReportResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«RevenueProductReportResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«RevenueProductReportResource»::getSize() const
{
    return m_Size;
}


void PageResource«RevenueProductReportResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«RevenueProductReportResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«RevenueProductReportResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«RevenueProductReportResource»::getSort()
{
    return m_Sort;
}

void PageResource«RevenueProductReportResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«RevenueProductReportResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«RevenueProductReportResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«RevenueProductReportResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«RevenueProductReportResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«RevenueProductReportResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«RevenueProductReportResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«RevenueProductReportResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«RevenueProductReportResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«RevenueProductReportResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«RevenueProductReportResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
