...
public:
    ...
    /// 
    /// </remarks>
    /// <param name="filterSystem">Filter for triggers that are system triggers when true, or not when false. Leave off for both mixed (optional)</param>/// <param name="filterCategory">Filter for triggers that are within a specific category (optional)</param>/// <param name="filterName">Filter for triggers that have names containing the given string (optional)</param>/// <param name="size">The number of objects returned per page (optional, default to 25)</param>/// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>
    pplx::task<std::shared_ptr<PageResource«BreTriggerResource»>> getBRETriggers(bool filterSystem, utility::string_t filterCategory, utility::string_t filterName, int32_t size, int32_t page);
    /// <summary>
    /// Update a trigger
    /// </summary>
    /// <remarks>
