...
/*
 * PageResource«UserActionLog».h
 *
 * 
 */

#ifndef PageResource«UserActionLog»_H_
#define PageResource«UserActionLog»_H_
...
/// 
/// </summary>
class  PageResource«UserActionLog»
    : public ModelBase
{
public:
    PageResource«UserActionLog»();
    virtual ~PageResource«UserActionLog»();
    ...
    /////////////////////////////////////////////
    /// PageResource«UserActionLog» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UserActionLog>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<UserActionLog>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<UserActionLog>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«UserActionLog»_H_ */
