...
PageResource«QuestionResource»::PageResource«QuestionResource»()
{
...
void PageResource«QuestionResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«QuestionResource»::toJson() const
{
...
void PageResource«QuestionResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<QuestionResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<QuestionResource> newItem(new QuestionResource());
...
void PageResource«QuestionResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«QuestionResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<QuestionResource>>& PageResource«QuestionResource»::getContent()
{
    return m_Content;
}

void PageResource«QuestionResource»::setContent(std::vector<std::shared_ptr<QuestionResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«QuestionResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«QuestionResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«QuestionResource»::getFirst() const
{
    return m_First;
}


void PageResource«QuestionResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«QuestionResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«QuestionResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«QuestionResource»::getLast() const
{
    return m_Last;
}


void PageResource«QuestionResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«QuestionResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«QuestionResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«QuestionResource»::getNumber() const
{
    return m_number;
}


void PageResource«QuestionResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«QuestionResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«QuestionResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«QuestionResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«QuestionResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«QuestionResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«QuestionResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«QuestionResource»::getSize() const
{
    return m_Size;
}


void PageResource«QuestionResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«QuestionResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«QuestionResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«QuestionResource»::getSort()
{
    return m_Sort;
}

void PageResource«QuestionResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«QuestionResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«QuestionResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«QuestionResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«QuestionResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«QuestionResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«QuestionResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«QuestionResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«QuestionResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«QuestionResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«QuestionResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
