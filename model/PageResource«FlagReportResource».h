...
/*
 * PageResource«FlagReportResource».h
 *
 * 
 */

#ifndef PageResource«FlagReportResource»_H_
#define PageResource«FlagReportResource»_H_
...
/// 
/// </summary>
class  PageResource«FlagReportResource»
    : public ModelBase
{
public:
    PageResource«FlagReportResource»();
    virtual ~PageResource«FlagReportResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«FlagReportResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<FlagReportResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<FlagReportResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<FlagReportResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«FlagReportResource»_H_ */
