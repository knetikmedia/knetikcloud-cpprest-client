...
/*
 * PageResource«ChatUserThreadResource».h
 *
 * 
 */

#ifndef PageResource«ChatUserThreadResource»_H_
#define PageResource«ChatUserThreadResource»_H_
...
/// 
/// </summary>
class  PageResource«ChatUserThreadResource»
    : public ModelBase
{
public:
    PageResource«ChatUserThreadResource»();
    virtual ~PageResource«ChatUserThreadResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«ChatUserThreadResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ChatUserThreadResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ChatUserThreadResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ChatUserThreadResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ChatUserThreadResource»_H_ */
