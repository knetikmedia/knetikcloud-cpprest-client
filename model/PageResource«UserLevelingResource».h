...
/*
 * PageResource«UserLevelingResource».h
 *
 * 
 */

#ifndef PageResource«UserLevelingResource»_H_
#define PageResource«UserLevelingResource»_H_
...
/// 
/// </summary>
class  PageResource«UserLevelingResource»
    : public ModelBase
{
public:
    PageResource«UserLevelingResource»();
    virtual ~PageResource«UserLevelingResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«UserLevelingResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UserLevelingResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<UserLevelingResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<UserLevelingResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«UserLevelingResource»_H_ */
