...
#ifndef Store_VendorsApi_H_
#define Store_VendorsApi_H_
...
{
public:
    Store_VendorsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Store_VendorsApi();
    /// <summary>
    /// Create a vendor
    /// </summary>
    /// <remarks>
