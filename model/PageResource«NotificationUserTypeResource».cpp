...
PageResource«NotificationUserTypeResource»::PageResource«NotificationUserTypeResource»()
{
...
void PageResource«NotificationUserTypeResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«NotificationUserTypeResource»::toJson() const
{
...
void PageResource«NotificationUserTypeResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<NotificationUserTypeResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<NotificationUserTypeResource> newItem(new NotificationUserTypeResource());
...
void PageResource«NotificationUserTypeResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«NotificationUserTypeResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<NotificationUserTypeResource>>& PageResource«NotificationUserTypeResource»::getContent()
{
    return m_Content;
}

void PageResource«NotificationUserTypeResource»::setContent(std::vector<std::shared_ptr<NotificationUserTypeResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«NotificationUserTypeResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«NotificationUserTypeResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«NotificationUserTypeResource»::getFirst() const
{
    return m_First;
}


void PageResource«NotificationUserTypeResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«NotificationUserTypeResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«NotificationUserTypeResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«NotificationUserTypeResource»::getLast() const
{
    return m_Last;
}


void PageResource«NotificationUserTypeResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«NotificationUserTypeResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«NotificationUserTypeResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«NotificationUserTypeResource»::getNumber() const
{
    return m_number;
}


void PageResource«NotificationUserTypeResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«NotificationUserTypeResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«NotificationUserTypeResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«NotificationUserTypeResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«NotificationUserTypeResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«NotificationUserTypeResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«NotificationUserTypeResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«NotificationUserTypeResource»::getSize() const
{
    return m_Size;
}


void PageResource«NotificationUserTypeResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«NotificationUserTypeResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«NotificationUserTypeResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«NotificationUserTypeResource»::getSort()
{
    return m_Sort;
}

void PageResource«NotificationUserTypeResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«NotificationUserTypeResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«NotificationUserTypeResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«NotificationUserTypeResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«NotificationUserTypeResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«NotificationUserTypeResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«NotificationUserTypeResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«NotificationUserTypeResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«NotificationUserTypeResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«NotificationUserTypeResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«NotificationUserTypeResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
