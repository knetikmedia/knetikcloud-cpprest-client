...
void PageResource«QuestionTemplateResource»::setContent(std::vector<std::shared_ptr<QuestionTemplateResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
bool PageResource«QuestionTemplateResource»::numberOfElementsIsSet() const
{
...
void PageResource«QuestionTemplateResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
...
bool PageResource«QuestionTemplateResource»::totalElementsIsSet() const
{
...
bool PageResource«QuestionTemplateResource»::totalPagesIsSet() const
{
