...
void PageResource«ItemTemplateResource»::setContent(std::vector<std::shared_ptr<ItemTemplateResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
bool PageResource«ItemTemplateResource»::numberOfElementsIsSet() const
{
...
void PageResource«ItemTemplateResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
...
bool PageResource«ItemTemplateResource»::totalElementsIsSet() const
{
...
bool PageResource«ItemTemplateResource»::totalPagesIsSet() const
{
