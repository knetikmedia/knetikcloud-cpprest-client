...
PageResource«WalletTotalResponse»::PageResource«WalletTotalResponse»()
{
...
void PageResource«WalletTotalResponse»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«WalletTotalResponse»::toJson() const
{
...
void PageResource«WalletTotalResponse»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<WalletTotalResponse>(nullptr) );
            }
            else
            {
                std::shared_ptr<WalletTotalResponse> newItem(new WalletTotalResponse());
...
void PageResource«WalletTotalResponse»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«WalletTotalResponse»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<WalletTotalResponse>>& PageResource«WalletTotalResponse»::getContent()
{
    return m_Content;
}

void PageResource«WalletTotalResponse»::setContent(std::vector<std::shared_ptr<WalletTotalResponse>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«WalletTotalResponse»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«WalletTotalResponse»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«WalletTotalResponse»::getFirst() const
{
    return m_First;
}


void PageResource«WalletTotalResponse»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«WalletTotalResponse»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«WalletTotalResponse»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«WalletTotalResponse»::getLast() const
{
    return m_Last;
}


void PageResource«WalletTotalResponse»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«WalletTotalResponse»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«WalletTotalResponse»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«WalletTotalResponse»::getNumber() const
{
    return m_number;
}


void PageResource«WalletTotalResponse»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«WalletTotalResponse»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«WalletTotalResponse»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«WalletTotalResponse»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«WalletTotalResponse»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«WalletTotalResponse»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«WalletTotalResponse»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«WalletTotalResponse»::getSize() const
{
    return m_Size;
}


void PageResource«WalletTotalResponse»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«WalletTotalResponse»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«WalletTotalResponse»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«WalletTotalResponse»::getSort()
{
    return m_Sort;
}

void PageResource«WalletTotalResponse»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«WalletTotalResponse»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«WalletTotalResponse»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«WalletTotalResponse»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«WalletTotalResponse»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«WalletTotalResponse»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«WalletTotalResponse»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«WalletTotalResponse»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«WalletTotalResponse»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«WalletTotalResponse»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«WalletTotalResponse»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
