...
#ifndef PageResource«UsageInfo»_H_
#define PageResource«UsageInfo»_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«UsageInfo» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UsageInfo>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<UsageInfo>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<UsageInfo>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«UsageInfo»_H_ */
