...
web::json::value Order::toJson() const
{
    ...
    {
        val[U("descending")] = ModelBase::toJson(m_Descending);
    }
    if(m_DirectionIsSet)
    {
...
void Order::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("descending")))
    {
        setDescending(ModelBase::boolFromJson(val[U("descending")]));
    }
...
void Order::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_DescendingIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + U("descending"), m_Descending));
    }
    if(m_DirectionIsSet)
    {
...
void Order::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(U("descending")))
    {
        setDescending(ModelBase::boolFromHttpContent(multipart->getContent(U("descending"))));
    }
...
bool Order::getDescending() const
{
    return m_Descending;
}


void Order::setDescending(bool value)
{
    m_Descending = value;
    m_DescendingIsSet = true;
}
bool Order::descendingIsSet() const
{
    return m_DescendingIsSet;
}

void Order::unsetDescending()
{
    m_DescendingIsSet = false;
}
...
bool Order::ignoreCaseIsSet() const
{
...
bool Order::nullHandlingIsSet() const
{
