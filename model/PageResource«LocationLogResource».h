...
/*
 * PageResource«LocationLogResource».h
 *
 * 
 */

#ifndef PageResource«LocationLogResource»_H_
#define PageResource«LocationLogResource»_H_
...
/// 
/// </summary>
class  PageResource«LocationLogResource»
    : public ModelBase
{
public:
    PageResource«LocationLogResource»();
    virtual ~PageResource«LocationLogResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«LocationLogResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<LocationLogResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<LocationLogResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<LocationLogResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«LocationLogResource»_H_ */
