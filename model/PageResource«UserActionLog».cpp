...
PageResource«UserActionLog»::PageResource«UserActionLog»()
{
...
void PageResource«UserActionLog»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«UserActionLog»::toJson() const
{
...
void PageResource«UserActionLog»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<UserActionLog>(nullptr) );
            }
            else
            {
                std::shared_ptr<UserActionLog> newItem(new UserActionLog());
...
void PageResource«UserActionLog»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«UserActionLog»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<UserActionLog>>& PageResource«UserActionLog»::getContent()
{
    return m_Content;
}

void PageResource«UserActionLog»::setContent(std::vector<std::shared_ptr<UserActionLog>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«UserActionLog»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«UserActionLog»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«UserActionLog»::getFirst() const
{
    return m_First;
}


void PageResource«UserActionLog»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«UserActionLog»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«UserActionLog»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«UserActionLog»::getLast() const
{
    return m_Last;
}


void PageResource«UserActionLog»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«UserActionLog»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«UserActionLog»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«UserActionLog»::getNumber() const
{
    return m_number;
}


void PageResource«UserActionLog»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«UserActionLog»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«UserActionLog»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«UserActionLog»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«UserActionLog»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«UserActionLog»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«UserActionLog»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«UserActionLog»::getSize() const
{
    return m_Size;
}


void PageResource«UserActionLog»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«UserActionLog»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«UserActionLog»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«UserActionLog»::getSort()
{
    return m_Sort;
}

void PageResource«UserActionLog»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«UserActionLog»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«UserActionLog»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«UserActionLog»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«UserActionLog»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«UserActionLog»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«UserActionLog»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«UserActionLog»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«UserActionLog»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«UserActionLog»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«UserActionLog»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
