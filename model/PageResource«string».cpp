...
PageResource«string»::PageResource«string»()
{
...
void PageResource«string»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«string»::toJson() const
{
...
void PageResource«string»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        {
            m_Content.push_back(ModelBase::stringFromJson(item));
        }
        }
    }
...
void PageResource«string»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«string»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<utility::string_t>& PageResource«string»::getContent()
{
    return m_Content;
}

void PageResource«string»::setContent(std::vector<utility::string_t> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«string»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«string»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«string»::getFirst() const
{
    return m_First;
}


void PageResource«string»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«string»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«string»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«string»::getLast() const
{
    return m_Last;
}


void PageResource«string»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«string»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«string»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«string»::getNumber() const
{
    return m_number;
}


void PageResource«string»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«string»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«string»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«string»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«string»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«string»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«string»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«string»::getSize() const
{
    return m_Size;
}


void PageResource«string»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«string»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«string»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«string»::getSort()
{
    return m_Sort;
}

void PageResource«string»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«string»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«string»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«string»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«string»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«string»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«string»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«string»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«string»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«string»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«string»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
