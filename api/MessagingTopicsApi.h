...
/*
 * MessagingTopicsApi.h
 *
 * 
 */

#ifndef MessagingTopicsApi_H_
#define MessagingTopicsApi_H_
...
{
public:
    MessagingTopicsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~MessagingTopicsApi();
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PageResource«TopicSubscriberResource»>> getTopicSubscribers(utility::string_t id);
    /// <summary>
