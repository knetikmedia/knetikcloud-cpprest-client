...
PageResource«LocationLogResource»::PageResource«LocationLogResource»()
{
...
void PageResource«LocationLogResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«LocationLogResource»::toJson() const
{
...
void PageResource«LocationLogResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<LocationLogResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<LocationLogResource> newItem(new LocationLogResource());
...
void PageResource«LocationLogResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«LocationLogResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<LocationLogResource>>& PageResource«LocationLogResource»::getContent()
{
    return m_Content;
}

void PageResource«LocationLogResource»::setContent(std::vector<std::shared_ptr<LocationLogResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«LocationLogResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«LocationLogResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«LocationLogResource»::getFirst() const
{
    return m_First;
}


void PageResource«LocationLogResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«LocationLogResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«LocationLogResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«LocationLogResource»::getLast() const
{
    return m_Last;
}


void PageResource«LocationLogResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«LocationLogResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«LocationLogResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«LocationLogResource»::getNumber() const
{
    return m_number;
}


void PageResource«LocationLogResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«LocationLogResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«LocationLogResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«LocationLogResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«LocationLogResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«LocationLogResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«LocationLogResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«LocationLogResource»::getSize() const
{
    return m_Size;
}


void PageResource«LocationLogResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«LocationLogResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«LocationLogResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«LocationLogResource»::getSort()
{
    return m_Sort;
}

void PageResource«LocationLogResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«LocationLogResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«LocationLogResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«LocationLogResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«LocationLogResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«LocationLogResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«LocationLogResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«LocationLogResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«LocationLogResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«LocationLogResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«LocationLogResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
