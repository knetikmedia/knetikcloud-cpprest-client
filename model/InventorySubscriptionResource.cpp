...
InventorySubscriptionResource::InventorySubscriptionResource()
{
    ...
    m_Price_override_reason = U("");
    m_Price_override_reasonIsSet = false;
...
web::json::value InventorySubscriptionResource::toJson() const
{
    ...
    if(m_Price_override_reasonIsSet)
    {
        val[U("price_override_reason")] = ModelBase::toJson(m_Price_override_reason);
    }
...
void InventorySubscriptionResource::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("price_override_reason")))
    {
        setPriceOverrideReason(ModelBase::stringFromJson(val[U("price_override_reason")]));
    }
...
void InventorySubscriptionResource::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Price_override_reasonIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + U("price_override_reason"), m_Price_override_reason));
...
void InventorySubscriptionResource::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(U("price_override_reason")))
    {
        setPriceOverrideReason(ModelBase::stringFromHttpContent(multipart->getContent(U("price_override_reason"))));
    }
...
bool InventorySubscriptionResource::billDateIsSet() const
{
...
void InventorySubscriptionResource::setCreditLog(std::vector<std::shared_ptr<SubscriptionCreditResource>> value)
{
    m_Credit_log = value;
    m_Credit_logIsSet = true;
}
bool InventorySubscriptionResource::creditLogIsSet() const
{
...
bool InventorySubscriptionResource::graceEndIsSet() const
{
...
bool InventorySubscriptionResource::inventoryIdIsSet() const
{
...
bool InventorySubscriptionResource::inventoryStatusIsSet() const
{
...
bool InventorySubscriptionResource::itemIdIsSet() const
{
...
bool InventorySubscriptionResource::paymentMethodIsSet() const
{
...
double InventorySubscriptionResource::getPriceOverride() const
{
    return m_Price_override;
}


void InventorySubscriptionResource::setPriceOverride(double value)
{
    m_Price_override = value;
    m_Price_overrideIsSet = true;
}
bool InventorySubscriptionResource::priceOverrideIsSet() const
{
    return m_Price_overrideIsSet;
}

void InventorySubscriptionResource::unsetPrice_override()
{
    m_Price_overrideIsSet = false;
}

utility::string_t InventorySubscriptionResource::getPriceOverrideReason() const
{
    return m_Price_override_reason;
}


void InventorySubscriptionResource::setPriceOverrideReason(utility::string_t value)
{
    m_Price_override_reason = value;
    m_Price_override_reasonIsSet = true;
}
bool InventorySubscriptionResource::priceOverrideReasonIsSet() const
{
    return m_Price_override_reasonIsSet;
}

void InventorySubscriptionResource::unsetPrice_override_reason()
{
    m_Price_override_reasonIsSet = false;
}
...
bool InventorySubscriptionResource::recurringPriceIsSet() const
{
...
bool InventorySubscriptionResource::startDateIsSet() const
{
...
bool InventorySubscriptionResource::subscriptionStatusIsSet() const
{
