...
PageResource«TopicSubscriberResource»::PageResource«TopicSubscriberResource»()
{
...
void PageResource«TopicSubscriberResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«TopicSubscriberResource»::toJson() const
{
...
void PageResource«TopicSubscriberResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<TopicSubscriberResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<TopicSubscriberResource> newItem(new TopicSubscriberResource());
...
void PageResource«TopicSubscriberResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«TopicSubscriberResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<TopicSubscriberResource>>& PageResource«TopicSubscriberResource»::getContent()
{
    return m_Content;
}

void PageResource«TopicSubscriberResource»::setContent(std::vector<std::shared_ptr<TopicSubscriberResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«TopicSubscriberResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«TopicSubscriberResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«TopicSubscriberResource»::getFirst() const
{
    return m_First;
}


void PageResource«TopicSubscriberResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«TopicSubscriberResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«TopicSubscriberResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«TopicSubscriberResource»::getLast() const
{
    return m_Last;
}


void PageResource«TopicSubscriberResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«TopicSubscriberResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«TopicSubscriberResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«TopicSubscriberResource»::getNumber() const
{
    return m_number;
}


void PageResource«TopicSubscriberResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«TopicSubscriberResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«TopicSubscriberResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«TopicSubscriberResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«TopicSubscriberResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«TopicSubscriberResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«TopicSubscriberResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«TopicSubscriberResource»::getSize() const
{
    return m_Size;
}


void PageResource«TopicSubscriberResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«TopicSubscriberResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«TopicSubscriberResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«TopicSubscriberResource»::getSort()
{
    return m_Sort;
}

void PageResource«TopicSubscriberResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«TopicSubscriberResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«TopicSubscriberResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«TopicSubscriberResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«TopicSubscriberResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«TopicSubscriberResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«TopicSubscriberResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«TopicSubscriberResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«TopicSubscriberResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«TopicSubscriberResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«TopicSubscriberResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
