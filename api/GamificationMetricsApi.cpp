...
#include "GamificationMetricsApi.h"
#include "IHttpBody.h"
#include "JsonBody.h"
...
GamificationMetricsApi::GamificationMetricsApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<void> GamificationMetricsApi::addMetric(std::shared_ptr<MetricResource> metric)
{
    ...
    {
        throw ApiException(400, U("GamificationMetricsApi->addMetric does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("GamificationMetricsApi->addMetric does not consume any supported media type"));
    }
