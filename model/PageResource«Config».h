...
/*
 * PageResource«Config».h
 *
 * 
 */

#ifndef PageResource«Config»_H_
#define PageResource«Config»_H_
...
/// 
/// </summary>
class  PageResource«Config»
    : public ModelBase
{
public:
    PageResource«Config»();
    virtual ~PageResource«Config»();
    ...
    /////////////////////////////////////////////
    /// PageResource«Config» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Config>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<Config>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<Config>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
