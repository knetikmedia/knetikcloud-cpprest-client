...
void PageResource«CommentResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«CommentResource»::toJson() const
{
...
void PageResource«CommentResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<CommentResource>(nullptr) );
            }
            else
            {
...
void PageResource«CommentResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«CommentResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<CommentResource>>& PageResource«CommentResource»::getContent()
{
    return m_Content;
}

void PageResource«CommentResource»::setContent(std::vector<std::shared_ptr<CommentResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«CommentResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«CommentResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«CommentResource»::getFirst() const
{
    return m_First;
}


void PageResource«CommentResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«CommentResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«CommentResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«CommentResource»::getLast() const
{
    return m_Last;
}


void PageResource«CommentResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«CommentResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«CommentResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«CommentResource»::getNumber() const
{
    return m_number;
}


void PageResource«CommentResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«CommentResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«CommentResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«CommentResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«CommentResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«CommentResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«CommentResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«CommentResource»::getSize() const
{
    return m_Size;
}


void PageResource«CommentResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«CommentResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«CommentResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«CommentResource»::getSort()
{
    return m_Sort;
}

void PageResource«CommentResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«CommentResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«CommentResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«CommentResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«CommentResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«CommentResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«CommentResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«CommentResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«CommentResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«CommentResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«CommentResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
