...
void RemoveCustomerEvent::validate()
{
    // TODO: implement validation
}

web::json::value RemoveCustomerEvent::toJson() const
{
...
void RemoveCustomerEvent::fromJson(web::json::value& val)
{
...
void RemoveCustomerEvent::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void RemoveCustomerEvent::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::shared_ptr<CustomerConfig> RemoveCustomerEvent::getCustomerConfig() const
{
    return m_Customer_config;
}


void RemoveCustomerEvent::setCustomerConfig(std::shared_ptr<CustomerConfig> value)
{
    m_Customer_config = value;
    m_Customer_configIsSet = true;
}
bool RemoveCustomerEvent::customerConfigIsSet() const
{
    return m_Customer_configIsSet;
}

void RemoveCustomerEvent::unsetCustomer_config()
{
    m_Customer_configIsSet = false;
}
