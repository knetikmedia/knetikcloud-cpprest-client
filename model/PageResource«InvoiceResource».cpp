...
void PageResource«InvoiceResource»::setContent(std::vector<std::shared_ptr<InvoiceResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
bool PageResource«InvoiceResource»::numberOfElementsIsSet() const
{
...
void PageResource«InvoiceResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
...
bool PageResource«InvoiceResource»::totalElementsIsSet() const
{
...
bool PageResource«InvoiceResource»::totalPagesIsSet() const
{
