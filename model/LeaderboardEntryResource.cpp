...
int64_t LeaderboardEntryResource::getUpdatedDate() const
{
    return m_Updated_date;
}


void LeaderboardEntryResource::setUpdatedDate(int64_t value)
{
    m_Updated_date = value;
    m_Updated_dateIsSet = true;
}
bool LeaderboardEntryResource::updatedDateIsSet() const
{
    return m_Updated_dateIsSet;
}

void LeaderboardEntryResource::unsetUpdated_date()
{
    m_Updated_dateIsSet = false;
}
