...
/*
 * PageResource«StoreItemTemplateResource».h
 *
 * 
 */

#ifndef PageResource«StoreItemTemplateResource»_H_
#define PageResource«StoreItemTemplateResource»_H_
...
/// 
/// </summary>
class  PageResource«StoreItemTemplateResource»
    : public ModelBase
{
public:
    PageResource«StoreItemTemplateResource»();
    virtual ~PageResource«StoreItemTemplateResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«StoreItemTemplateResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<StoreItemTemplateResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<StoreItemTemplateResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<StoreItemTemplateResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«StoreItemTemplateResource»_H_ */
