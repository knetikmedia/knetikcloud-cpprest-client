...
void PageResource«VideoRelationshipResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«VideoRelationshipResource»::toJson() const
{
...
void PageResource«VideoRelationshipResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<VideoRelationshipResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<VideoRelationshipResource> newItem(new VideoRelationshipResource());
...
void PageResource«VideoRelationshipResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«VideoRelationshipResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<VideoRelationshipResource>>& PageResource«VideoRelationshipResource»::getContent()
{
    return m_Content;
}

void PageResource«VideoRelationshipResource»::setContent(std::vector<std::shared_ptr<VideoRelationshipResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«VideoRelationshipResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«VideoRelationshipResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«VideoRelationshipResource»::getFirst() const
{
    return m_First;
}


void PageResource«VideoRelationshipResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«VideoRelationshipResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«VideoRelationshipResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«VideoRelationshipResource»::getLast() const
{
    return m_Last;
}


void PageResource«VideoRelationshipResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«VideoRelationshipResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«VideoRelationshipResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«VideoRelationshipResource»::getNumber() const
{
    return m_number;
}


void PageResource«VideoRelationshipResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«VideoRelationshipResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«VideoRelationshipResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«VideoRelationshipResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«VideoRelationshipResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«VideoRelationshipResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«VideoRelationshipResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«VideoRelationshipResource»::getSize() const
{
    return m_Size;
}


void PageResource«VideoRelationshipResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«VideoRelationshipResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«VideoRelationshipResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«VideoRelationshipResource»::getSort()
{
    return m_Sort;
}

void PageResource«VideoRelationshipResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«VideoRelationshipResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«VideoRelationshipResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«VideoRelationshipResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«VideoRelationshipResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«VideoRelationshipResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«VideoRelationshipResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«VideoRelationshipResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«VideoRelationshipResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«VideoRelationshipResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«VideoRelationshipResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
