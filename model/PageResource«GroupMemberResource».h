...
/*
 * PageResource«GroupMemberResource».h
 *
 * 
 */

#ifndef PageResource«GroupMemberResource»_H_
#define PageResource«GroupMemberResource»_H_
...
public:
    ...
    virtual ~PageResource«GroupMemberResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«GroupMemberResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<GroupMemberResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<GroupMemberResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<GroupMemberResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«GroupMemberResource»_H_ */
