...
public:
    ...
    /// 
    /// </remarks>
    /// <param name="id">The id of the invoice</param>/// <param name="request">The payment method details. Will default to the appropriate user&#39;s wallet in the invoice currency if ommited. (optional)</param>
    ...
    pplx::task<void> setBundledInvoiceItemFulfillmentStatus(int32_t id, utility::string_t bundleSku, utility::string_t sku, std::shared_ptr<StringWrapper> status);
    /// <summary>
    ...
    pplx::task<void> setExternalRef(int32_t id, std::shared_ptr<StringWrapper> externalRef);
    /// <summary>
    ...
    pplx::task<void> setInvoiceItemFulfillmentStatus(int32_t id, utility::string_t sku, std::shared_ptr<StringWrapper> status);
    /// <summary>
    ...
    pplx::task<void> setOrderNotes(int32_t id, std::shared_ptr<StringWrapper> orderNotes);
    /// <summary>
