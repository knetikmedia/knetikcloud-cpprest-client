...
PageResource«UserLevelingResource»::PageResource«UserLevelingResource»()
{
...
void PageResource«UserLevelingResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«UserLevelingResource»::toJson() const
{
...
void PageResource«UserLevelingResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<UserLevelingResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<UserLevelingResource> newItem(new UserLevelingResource());
...
void PageResource«UserLevelingResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«UserLevelingResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<UserLevelingResource>>& PageResource«UserLevelingResource»::getContent()
{
    return m_Content;
}

void PageResource«UserLevelingResource»::setContent(std::vector<std::shared_ptr<UserLevelingResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«UserLevelingResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«UserLevelingResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«UserLevelingResource»::getFirst() const
{
    return m_First;
}


void PageResource«UserLevelingResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«UserLevelingResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«UserLevelingResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«UserLevelingResource»::getLast() const
{
    return m_Last;
}


void PageResource«UserLevelingResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«UserLevelingResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«UserLevelingResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«UserLevelingResource»::getNumber() const
{
    return m_number;
}


void PageResource«UserLevelingResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«UserLevelingResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«UserLevelingResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«UserLevelingResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«UserLevelingResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«UserLevelingResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«UserLevelingResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«UserLevelingResource»::getSize() const
{
    return m_Size;
}


void PageResource«UserLevelingResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«UserLevelingResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«UserLevelingResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«UserLevelingResource»::getSort()
{
    return m_Sort;
}

void PageResource«UserLevelingResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«UserLevelingResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«UserLevelingResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«UserLevelingResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«UserLevelingResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«UserLevelingResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«UserLevelingResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«UserLevelingResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«UserLevelingResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«UserLevelingResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«UserLevelingResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
