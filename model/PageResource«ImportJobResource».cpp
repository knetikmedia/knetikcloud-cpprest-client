...
PageResource«ImportJobResource»::PageResource«ImportJobResource»()
{
...
void PageResource«ImportJobResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«ImportJobResource»::toJson() const
{
...
void PageResource«ImportJobResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<ImportJobResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<ImportJobResource> newItem(new ImportJobResource());
...
void PageResource«ImportJobResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«ImportJobResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<ImportJobResource>>& PageResource«ImportJobResource»::getContent()
{
    return m_Content;
}

void PageResource«ImportJobResource»::setContent(std::vector<std::shared_ptr<ImportJobResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«ImportJobResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«ImportJobResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«ImportJobResource»::getFirst() const
{
    return m_First;
}


void PageResource«ImportJobResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«ImportJobResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«ImportJobResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«ImportJobResource»::getLast() const
{
    return m_Last;
}


void PageResource«ImportJobResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«ImportJobResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«ImportJobResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«ImportJobResource»::getNumber() const
{
    return m_number;
}


void PageResource«ImportJobResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«ImportJobResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«ImportJobResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«ImportJobResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«ImportJobResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«ImportJobResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«ImportJobResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«ImportJobResource»::getSize() const
{
    return m_Size;
}


void PageResource«ImportJobResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«ImportJobResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«ImportJobResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«ImportJobResource»::getSort()
{
    return m_Sort;
}

void PageResource«ImportJobResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«ImportJobResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«ImportJobResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«ImportJobResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«ImportJobResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«ImportJobResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«ImportJobResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«ImportJobResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«ImportJobResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«ImportJobResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«ImportJobResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
