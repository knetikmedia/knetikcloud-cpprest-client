...
/*
 * PageResource«BreGlobalResource».h
 *
 * 
 */

#ifndef PageResource«BreGlobalResource»_H_
#define PageResource«BreGlobalResource»_H_
...
/// 
/// </summary>
class  PageResource«BreGlobalResource»
    : public ModelBase
{
public:
    PageResource«BreGlobalResource»();
    virtual ~PageResource«BreGlobalResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«BreGlobalResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BreGlobalResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<BreGlobalResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<BreGlobalResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«BreGlobalResource»_H_ */
