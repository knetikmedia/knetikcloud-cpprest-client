...
#ifndef PageResource«ActivityOccurrenceResource»_H_
#define PageResource«ActivityOccurrenceResource»_H_
...
/// 
/// </summary>
class  PageResource«ActivityOccurrenceResource»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«ActivityOccurrenceResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ActivityOccurrenceResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ActivityOccurrenceResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ActivityOccurrenceResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ActivityOccurrenceResource»_H_ */
