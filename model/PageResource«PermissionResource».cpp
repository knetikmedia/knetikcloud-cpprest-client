...
PageResource«PermissionResource»::PageResource«PermissionResource»()
{
...
void PageResource«PermissionResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«PermissionResource»::toJson() const
{
...
void PageResource«PermissionResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<PermissionResource>(nullptr) );
            }
            else
            {
...
void PageResource«PermissionResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«PermissionResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<PermissionResource>>& PageResource«PermissionResource»::getContent()
{
    return m_Content;
}

void PageResource«PermissionResource»::setContent(std::vector<std::shared_ptr<PermissionResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«PermissionResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«PermissionResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«PermissionResource»::getFirst() const
{
    return m_First;
}


void PageResource«PermissionResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«PermissionResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«PermissionResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«PermissionResource»::getLast() const
{
    return m_Last;
}


void PageResource«PermissionResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«PermissionResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«PermissionResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«PermissionResource»::getNumber() const
{
    return m_number;
}


void PageResource«PermissionResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«PermissionResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«PermissionResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«PermissionResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«PermissionResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«PermissionResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«PermissionResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«PermissionResource»::getSize() const
{
    return m_Size;
}


void PageResource«PermissionResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«PermissionResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«PermissionResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«PermissionResource»::getSort()
{
    return m_Sort;
}

void PageResource«PermissionResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«PermissionResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«PermissionResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«PermissionResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«PermissionResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«PermissionResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«PermissionResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«PermissionResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«PermissionResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«PermissionResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«PermissionResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
