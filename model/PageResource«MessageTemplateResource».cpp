...
PageResource«MessageTemplateResource»::PageResource«MessageTemplateResource»()
{
...
void PageResource«MessageTemplateResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«MessageTemplateResource»::toJson() const
{
...
void PageResource«MessageTemplateResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<MessageTemplateResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<MessageTemplateResource> newItem(new MessageTemplateResource());
...
void PageResource«MessageTemplateResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«MessageTemplateResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<MessageTemplateResource>>& PageResource«MessageTemplateResource»::getContent()
{
    return m_Content;
}

void PageResource«MessageTemplateResource»::setContent(std::vector<std::shared_ptr<MessageTemplateResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«MessageTemplateResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«MessageTemplateResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«MessageTemplateResource»::getFirst() const
{
    return m_First;
}


void PageResource«MessageTemplateResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«MessageTemplateResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«MessageTemplateResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«MessageTemplateResource»::getLast() const
{
    return m_Last;
}


void PageResource«MessageTemplateResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«MessageTemplateResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«MessageTemplateResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«MessageTemplateResource»::getNumber() const
{
    return m_number;
}


void PageResource«MessageTemplateResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«MessageTemplateResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«MessageTemplateResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«MessageTemplateResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«MessageTemplateResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«MessageTemplateResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«MessageTemplateResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«MessageTemplateResource»::getSize() const
{
    return m_Size;
}


void PageResource«MessageTemplateResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«MessageTemplateResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«MessageTemplateResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«MessageTemplateResource»::getSort()
{
    return m_Sort;
}

void PageResource«MessageTemplateResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«MessageTemplateResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«MessageTemplateResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«MessageTemplateResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«MessageTemplateResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«MessageTemplateResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«MessageTemplateResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«MessageTemplateResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«MessageTemplateResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«MessageTemplateResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«MessageTemplateResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
