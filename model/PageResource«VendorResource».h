...
/*
 * PageResource«VendorResource».h
 *
 * 
 */

#ifndef PageResource«VendorResource»_H_
#define PageResource«VendorResource»_H_
...
/// 
/// </summary>
class  PageResource«VendorResource»
    : public ModelBase
{
public:
    PageResource«VendorResource»();
    virtual ~PageResource«VendorResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«VendorResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<VendorResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<VendorResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<VendorResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«VendorResource»_H_ */
