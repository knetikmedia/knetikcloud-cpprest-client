...
PageResource«ArticleResource»::PageResource«ArticleResource»()
{
...
void PageResource«ArticleResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«ArticleResource»::toJson() const
{
...
void PageResource«ArticleResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<ArticleResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<ArticleResource> newItem(new ArticleResource());
...
void PageResource«ArticleResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«ArticleResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<ArticleResource>>& PageResource«ArticleResource»::getContent()
{
    return m_Content;
}

void PageResource«ArticleResource»::setContent(std::vector<std::shared_ptr<ArticleResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«ArticleResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«ArticleResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«ArticleResource»::getFirst() const
{
    return m_First;
}


void PageResource«ArticleResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«ArticleResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«ArticleResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«ArticleResource»::getLast() const
{
    return m_Last;
}


void PageResource«ArticleResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«ArticleResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«ArticleResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«ArticleResource»::getNumber() const
{
    return m_number;
}


void PageResource«ArticleResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«ArticleResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«ArticleResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«ArticleResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«ArticleResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«ArticleResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«ArticleResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«ArticleResource»::getSize() const
{
    return m_Size;
}


void PageResource«ArticleResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«ArticleResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«ArticleResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«ArticleResource»::getSort()
{
    return m_Sort;
}

void PageResource«ArticleResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«ArticleResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«ArticleResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«ArticleResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«ArticleResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«ArticleResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«ArticleResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«ArticleResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«ArticleResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«ArticleResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«ArticleResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
