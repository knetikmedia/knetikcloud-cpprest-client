...
/*
 * PageResource«BreRule».h
 *
 * 
 */

#ifndef PageResource«BreRule»_H_
#define PageResource«BreRule»_H_
...
/// 
/// </summary>
class  PageResource«BreRule»
    : public ModelBase
{
public:
    PageResource«BreRule»();
    virtual ~PageResource«BreRule»();
    ...
    /////////////////////////////////////////////
    /// PageResource«BreRule» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BreRule>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<BreRule>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<BreRule>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«BreRule»_H_ */
