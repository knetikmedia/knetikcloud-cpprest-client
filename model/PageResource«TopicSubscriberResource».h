...
/*
 * PageResource«TopicSubscriberResource».h
 *
 * 
 */

#ifndef PageResource«TopicSubscriberResource»_H_
#define PageResource«TopicSubscriberResource»_H_
...
/// 
/// </summary>
class  PageResource«TopicSubscriberResource»
    : public ModelBase
{
public:
    PageResource«TopicSubscriberResource»();
    virtual ~PageResource«TopicSubscriberResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«TopicSubscriberResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<TopicSubscriberResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<TopicSubscriberResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<TopicSubscriberResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«TopicSubscriberResource»_H_ */
