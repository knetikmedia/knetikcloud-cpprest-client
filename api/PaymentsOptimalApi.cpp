...
PaymentsOptimalApi::PaymentsOptimalApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<utility::string_t> PaymentsOptimalApi::silentPostOptimal(std::shared_ptr<OptimalPaymentRequest> request)
{
    ...
    {
        throw ApiException(400, U("PaymentsOptimalApi->silentPostOptimal does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("PaymentsOptimalApi->silentPostOptimal does not consume any supported media type"));
    }
