...
/*
 * Gamification_LevelingApi.h
 *
 * 
 */

#ifndef Gamification_LevelingApi_H_
#define Gamification_LevelingApi_H_
...
{
public:
    Gamification_LevelingApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Gamification_LevelingApi();
    /// <summary>
...
#endif /* Gamification_LevelingApi_H_ */
