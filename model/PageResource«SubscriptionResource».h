...
/*
 * PageResource«SubscriptionResource».h
 *
 * 
 */

#ifndef PageResource«SubscriptionResource»_H_
#define PageResource«SubscriptionResource»_H_
...
/// 
/// </summary>
class  PageResource«SubscriptionResource»
    : public ModelBase
{
public:
    PageResource«SubscriptionResource»();
    virtual ~PageResource«SubscriptionResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«SubscriptionResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SubscriptionResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<SubscriptionResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<SubscriptionResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«SubscriptionResource»_H_ */
