...
/*
 * PageResource«UserItemLogResource».h
 *
 * 
 */

#ifndef PageResource«UserItemLogResource»_H_
#define PageResource«UserItemLogResource»_H_
...
/// 
/// </summary>
class  PageResource«UserItemLogResource»
    : public ModelBase
{
public:
    PageResource«UserItemLogResource»();
    virtual ~PageResource«UserItemLogResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«UserItemLogResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UserItemLogResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<UserItemLogResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<UserItemLogResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«UserItemLogResource»_H_ */
