...
void PageResource«RevenueCountryReportResource»::setContent(std::vector<std::shared_ptr<RevenueCountryReportResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
bool PageResource«RevenueCountryReportResource»::numberOfElementsIsSet() const
{
...
void PageResource«RevenueCountryReportResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
...
bool PageResource«RevenueCountryReportResource»::totalElementsIsSet() const
{
...
bool PageResource«RevenueCountryReportResource»::totalPagesIsSet() const
{
