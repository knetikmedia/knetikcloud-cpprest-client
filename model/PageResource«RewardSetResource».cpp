...
PageResource«RewardSetResource»::PageResource«RewardSetResource»()
{
...
void PageResource«RewardSetResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«RewardSetResource»::toJson() const
{
...
void PageResource«RewardSetResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<RewardSetResource>(nullptr) );
            }
            else
            {
...
void PageResource«RewardSetResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«RewardSetResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<RewardSetResource>>& PageResource«RewardSetResource»::getContent()
{
    return m_Content;
}

void PageResource«RewardSetResource»::setContent(std::vector<std::shared_ptr<RewardSetResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«RewardSetResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«RewardSetResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«RewardSetResource»::getFirst() const
{
    return m_First;
}


void PageResource«RewardSetResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«RewardSetResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«RewardSetResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«RewardSetResource»::getLast() const
{
    return m_Last;
}


void PageResource«RewardSetResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«RewardSetResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«RewardSetResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«RewardSetResource»::getNumber() const
{
    return m_number;
}


void PageResource«RewardSetResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«RewardSetResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«RewardSetResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«RewardSetResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«RewardSetResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«RewardSetResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«RewardSetResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«RewardSetResource»::getSize() const
{
    return m_Size;
}


void PageResource«RewardSetResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«RewardSetResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«RewardSetResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«RewardSetResource»::getSort()
{
    return m_Sort;
}

void PageResource«RewardSetResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«RewardSetResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«RewardSetResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«RewardSetResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«RewardSetResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«RewardSetResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«RewardSetResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«RewardSetResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«RewardSetResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«RewardSetResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«RewardSetResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
