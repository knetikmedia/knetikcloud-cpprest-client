...
/*
 * PageResource«SimpleReferenceResource«object»».h
 *
 * 
 */

#ifndef PageResource«SimpleReferenceResource«object»»_H_
#define PageResource«SimpleReferenceResource«object»»_H_
...
/// 
/// </summary>
class  PageResource«SimpleReferenceResource«object»»
    : public ModelBase
{
public:
    PageResource«SimpleReferenceResource«object»»();
    virtual ~PageResource«SimpleReferenceResource«object»»();
    ...
    /////////////////////////////////////////////
    /// PageResource«SimpleReferenceResource«object»» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SimpleReferenceResource«object»>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<SimpleReferenceResource«object»>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<SimpleReferenceResource«object»>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«SimpleReferenceResource«object»»_H_ */
