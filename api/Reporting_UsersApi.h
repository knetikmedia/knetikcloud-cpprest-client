...
/*
 * Reporting_UsersApi.h
 *
 * 
 */

#ifndef Reporting_UsersApi_H_
#define Reporting_UsersApi_H_
...
{
public:
    Reporting_UsersApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Reporting_UsersApi();
    /// <summary>
