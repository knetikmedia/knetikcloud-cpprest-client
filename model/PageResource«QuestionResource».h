...
#ifndef PageResource«QuestionResource»_H_
#define PageResource«QuestionResource»_H_
...
/// 
/// </summary>
class  PageResource«QuestionResource»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«QuestionResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<QuestionResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<QuestionResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<QuestionResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«QuestionResource»_H_ */
