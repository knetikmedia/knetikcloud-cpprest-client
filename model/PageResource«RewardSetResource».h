...
/*
 * PageResource«RewardSetResource».h
 *
 * 
 */

#ifndef PageResource«RewardSetResource»_H_
#define PageResource«RewardSetResource»_H_
...
/// 
/// </summary>
class  PageResource«RewardSetResource»
    : public ModelBase
{
public:
    PageResource«RewardSetResource»();
    virtual ~PageResource«RewardSetResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«RewardSetResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<RewardSetResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<RewardSetResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<RewardSetResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«RewardSetResource»_H_ */
