...
/*
 * PageResource«ChallengeEventResource».h
 *
 * 
 */

#ifndef PageResource«ChallengeEventResource»_H_
#define PageResource«ChallengeEventResource»_H_
...
public:
    ...
    virtual ~PageResource«ChallengeEventResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«ChallengeEventResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ChallengeEventResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ChallengeEventResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ChallengeEventResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ChallengeEventResource»_H_ */
