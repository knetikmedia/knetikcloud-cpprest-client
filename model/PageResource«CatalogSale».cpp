...
PageResource«CatalogSale»::PageResource«CatalogSale»()
{
...
void PageResource«CatalogSale»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«CatalogSale»::toJson() const
{
...
void PageResource«CatalogSale»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<CatalogSale>(nullptr) );
            }
            else
            {
                std::shared_ptr<CatalogSale> newItem(new CatalogSale());
...
void PageResource«CatalogSale»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«CatalogSale»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<CatalogSale>>& PageResource«CatalogSale»::getContent()
{
    return m_Content;
}

void PageResource«CatalogSale»::setContent(std::vector<std::shared_ptr<CatalogSale>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«CatalogSale»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«CatalogSale»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«CatalogSale»::getFirst() const
{
    return m_First;
}


void PageResource«CatalogSale»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«CatalogSale»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«CatalogSale»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«CatalogSale»::getLast() const
{
    return m_Last;
}


void PageResource«CatalogSale»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«CatalogSale»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«CatalogSale»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«CatalogSale»::getNumber() const
{
    return m_number;
}


void PageResource«CatalogSale»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«CatalogSale»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«CatalogSale»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«CatalogSale»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«CatalogSale»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«CatalogSale»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«CatalogSale»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«CatalogSale»::getSize() const
{
    return m_Size;
}


void PageResource«CatalogSale»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«CatalogSale»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«CatalogSale»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«CatalogSale»::getSort()
{
    return m_Sort;
}

void PageResource«CatalogSale»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«CatalogSale»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«CatalogSale»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«CatalogSale»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«CatalogSale»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«CatalogSale»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«CatalogSale»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«CatalogSale»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«CatalogSale»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«CatalogSale»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«CatalogSale»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
