...
/*
 * PageResource«CommentResource».h
 *
 * 
 */

#ifndef PageResource«CommentResource»_H_
#define PageResource«CommentResource»_H_
...
/// 
/// </summary>
class  PageResource«CommentResource»
    : public ModelBase
{
public:
    PageResource«CommentResource»();
    virtual ~PageResource«CommentResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«CommentResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CommentResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<CommentResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<CommentResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«CommentResource»_H_ */
