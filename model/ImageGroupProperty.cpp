...
utility::string_t ImageGroupProperty::getType() const
{
    return m_Type;
}
void ImageGroupProperty::setType(utility::string_t value)
{
    m_Type = value;
    
}
std::vector<std::shared_ptr<FileProperty>>& ImageGroupProperty::getFiles()
{
    return m_Files;
}
bool ImageGroupProperty::filesIsSet() const
{
    return m_FilesIsSet;
}
void ImageGroupProperty::unsetFiles()
{
    m_FilesIsSet = false;
}
