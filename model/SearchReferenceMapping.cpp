...
web::json::value SearchReferenceMapping::toJson() const
{
    ...
    val[U("ref_type")] = ModelBase::toJson(m_Ref_type);
    {
        ...
        for( auto& item : m_Source_field_to_destination_field )
        {
        ...
        val[U("source_field_to_destination_field")] = web::json::value::array(jsonArray);
    }
...
void SearchReferenceMapping::fromJson(web::json::value& val)
{
    ...
    {
        m_Source_field_to_destination_field.clear();
        std::vector<web::json::value> jsonArray;
        for( auto& item : val[U("source_field_to_destination_field")].as_array() )
        {  
            ...
            m_Source_field_to_destination_field.insert(std::pair<utility::string_t,utility::string_t>( key, ModelBase::stringFromJson(item[U("value")])));
        }
    }
...
void SearchReferenceMapping::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    multipart->add(ModelBase::toHttpContent(namePrefix + U("ref_type"), m_Ref_type));
    {
        ...
        multipart->add(ModelBase::toHttpContent(namePrefix + U("source_field_to_destination_field"), web::json::value::array(jsonArray), U("application/json")));
            }
...
void SearchReferenceMapping::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    setRefType(ModelBase::stringFromHttpContent(multipart->getContent(U("ref_type"))));
    {
        ...
        web::json::value jsonArray = web::json::value::parse(ModelBase::stringFromHttpContent(multipart->getContent(U("source_field_to_destination_field"))));
...
void SearchReferenceMapping::setSourceFieldToDestinationField(std::map<utility::string_t, utility::string_t> value)
{
    m_Source_field_to_destination_field = value;
