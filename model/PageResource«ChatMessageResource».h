...
/*
 * PageResource«ChatMessageResource».h
 *
 * 
 */

#ifndef PageResource«ChatMessageResource»_H_
#define PageResource«ChatMessageResource»_H_
...
/// 
/// </summary>
class  PageResource«ChatMessageResource»
    : public ModelBase
{
public:
    PageResource«ChatMessageResource»();
    virtual ~PageResource«ChatMessageResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«ChatMessageResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ChatMessageResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ChatMessageResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ChatMessageResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ChatMessageResource»_H_ */
