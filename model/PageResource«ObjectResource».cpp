...
PageResource«ObjectResource»::PageResource«ObjectResource»()
{
...
void PageResource«ObjectResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«ObjectResource»::toJson() const
{
...
void PageResource«ObjectResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<ObjectResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<ObjectResource> newItem(new ObjectResource());
...
void PageResource«ObjectResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«ObjectResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<ObjectResource>>& PageResource«ObjectResource»::getContent()
{
    return m_Content;
}

void PageResource«ObjectResource»::setContent(std::vector<std::shared_ptr<ObjectResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«ObjectResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«ObjectResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«ObjectResource»::getFirst() const
{
    return m_First;
}


void PageResource«ObjectResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«ObjectResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«ObjectResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«ObjectResource»::getLast() const
{
    return m_Last;
}


void PageResource«ObjectResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«ObjectResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«ObjectResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«ObjectResource»::getNumber() const
{
    return m_number;
}


void PageResource«ObjectResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«ObjectResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«ObjectResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«ObjectResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«ObjectResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«ObjectResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«ObjectResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«ObjectResource»::getSize() const
{
    return m_Size;
}


void PageResource«ObjectResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«ObjectResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«ObjectResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«ObjectResource»::getSort()
{
    return m_Sort;
}

void PageResource«ObjectResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«ObjectResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«ObjectResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«ObjectResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«ObjectResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«ObjectResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«ObjectResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«ObjectResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«ObjectResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«ObjectResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«ObjectResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
