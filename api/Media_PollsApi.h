...
#ifndef Media_PollsApi_H_
#define Media_PollsApi_H_
...
class  Media_PollsApi
{
public:
    Media_PollsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Media_PollsApi();
    /// <summary>
