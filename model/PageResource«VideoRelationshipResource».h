...
/*
 * PageResource«VideoRelationshipResource».h
 *
 * 
 */

#ifndef PageResource«VideoRelationshipResource»_H_
#define PageResource«VideoRelationshipResource»_H_
...
/// 
/// </summary>
class  PageResource«VideoRelationshipResource»
    : public ModelBase
{
public:
    PageResource«VideoRelationshipResource»();
    virtual ~PageResource«VideoRelationshipResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«VideoRelationshipResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<VideoRelationshipResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<VideoRelationshipResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<VideoRelationshipResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«VideoRelationshipResource»_H_ */
