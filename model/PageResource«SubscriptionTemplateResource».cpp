...
PageResource«SubscriptionTemplateResource»::PageResource«SubscriptionTemplateResource»()
{
...
void PageResource«SubscriptionTemplateResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«SubscriptionTemplateResource»::toJson() const
{
...
void PageResource«SubscriptionTemplateResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<SubscriptionTemplateResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<SubscriptionTemplateResource> newItem(new SubscriptionTemplateResource());
...
void PageResource«SubscriptionTemplateResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«SubscriptionTemplateResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<SubscriptionTemplateResource>>& PageResource«SubscriptionTemplateResource»::getContent()
{
    return m_Content;
}

void PageResource«SubscriptionTemplateResource»::setContent(std::vector<std::shared_ptr<SubscriptionTemplateResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«SubscriptionTemplateResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«SubscriptionTemplateResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«SubscriptionTemplateResource»::getFirst() const
{
    return m_First;
}


void PageResource«SubscriptionTemplateResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«SubscriptionTemplateResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«SubscriptionTemplateResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«SubscriptionTemplateResource»::getLast() const
{
    return m_Last;
}


void PageResource«SubscriptionTemplateResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«SubscriptionTemplateResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«SubscriptionTemplateResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«SubscriptionTemplateResource»::getNumber() const
{
    return m_number;
}


void PageResource«SubscriptionTemplateResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«SubscriptionTemplateResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«SubscriptionTemplateResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«SubscriptionTemplateResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«SubscriptionTemplateResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«SubscriptionTemplateResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«SubscriptionTemplateResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«SubscriptionTemplateResource»::getSize() const
{
    return m_Size;
}


void PageResource«SubscriptionTemplateResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«SubscriptionTemplateResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«SubscriptionTemplateResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«SubscriptionTemplateResource»::getSort()
{
    return m_Sort;
}

void PageResource«SubscriptionTemplateResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«SubscriptionTemplateResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«SubscriptionTemplateResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«SubscriptionTemplateResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«SubscriptionTemplateResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«SubscriptionTemplateResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«SubscriptionTemplateResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«SubscriptionTemplateResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«SubscriptionTemplateResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«SubscriptionTemplateResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«SubscriptionTemplateResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
