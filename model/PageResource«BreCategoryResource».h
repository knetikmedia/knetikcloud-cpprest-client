...
/*
 * PageResource«BreCategoryResource».h
 *
 * 
 */

#ifndef PageResource«BreCategoryResource»_H_
#define PageResource«BreCategoryResource»_H_
...
/// 
/// </summary>
class  PageResource«BreCategoryResource»
    : public ModelBase
{
public:
    PageResource«BreCategoryResource»();
    virtual ~PageResource«BreCategoryResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«BreCategoryResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BreCategoryResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<BreCategoryResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<BreCategoryResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«BreCategoryResource»_H_ */
