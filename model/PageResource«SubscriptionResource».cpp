...
PageResource«SubscriptionResource»::PageResource«SubscriptionResource»()
{
...
void PageResource«SubscriptionResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«SubscriptionResource»::toJson() const
{
...
void PageResource«SubscriptionResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<SubscriptionResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<SubscriptionResource> newItem(new SubscriptionResource());
...
void PageResource«SubscriptionResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«SubscriptionResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<SubscriptionResource>>& PageResource«SubscriptionResource»::getContent()
{
    return m_Content;
}

void PageResource«SubscriptionResource»::setContent(std::vector<std::shared_ptr<SubscriptionResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«SubscriptionResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«SubscriptionResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«SubscriptionResource»::getFirst() const
{
    return m_First;
}


void PageResource«SubscriptionResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«SubscriptionResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«SubscriptionResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«SubscriptionResource»::getLast() const
{
    return m_Last;
}


void PageResource«SubscriptionResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«SubscriptionResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«SubscriptionResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«SubscriptionResource»::getNumber() const
{
    return m_number;
}


void PageResource«SubscriptionResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«SubscriptionResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«SubscriptionResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«SubscriptionResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«SubscriptionResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«SubscriptionResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«SubscriptionResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«SubscriptionResource»::getSize() const
{
    return m_Size;
}


void PageResource«SubscriptionResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«SubscriptionResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«SubscriptionResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«SubscriptionResource»::getSort()
{
    return m_Sort;
}

void PageResource«SubscriptionResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«SubscriptionResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«SubscriptionResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«SubscriptionResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«SubscriptionResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«SubscriptionResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«SubscriptionResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«SubscriptionResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«SubscriptionResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«SubscriptionResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«SubscriptionResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
