...
/*
 * Rule_Engine_RulesApi.h
 *
 * 
 */

#ifndef Rule_Engine_RulesApi_H_
#define Rule_Engine_RulesApi_H_
...
class  Rule_Engine_RulesApi
{
public:
    Rule_Engine_RulesApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Rule_Engine_RulesApi();
    /// <summary>
    /// Create a rule
    /// </summary>
    /// <remarks>
