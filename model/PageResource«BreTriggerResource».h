...
/*
 * PageResource«BreTriggerResource».h
 *
 * 
 */

#ifndef PageResource«BreTriggerResource»_H_
#define PageResource«BreTriggerResource»_H_
...
/// 
/// </summary>
class  PageResource«BreTriggerResource»
    : public ModelBase
{
public:
    PageResource«BreTriggerResource»();
    virtual ~PageResource«BreTriggerResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«BreTriggerResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BreTriggerResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<BreTriggerResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<BreTriggerResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«BreTriggerResource»_H_ */
