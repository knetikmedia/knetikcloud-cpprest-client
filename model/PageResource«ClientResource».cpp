...
PageResource«ClientResource»::PageResource«ClientResource»()
{
...
void PageResource«ClientResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«ClientResource»::toJson() const
{
...
void PageResource«ClientResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<ClientResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<ClientResource> newItem(new ClientResource());
...
void PageResource«ClientResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«ClientResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<ClientResource>>& PageResource«ClientResource»::getContent()
{
    return m_Content;
}

void PageResource«ClientResource»::setContent(std::vector<std::shared_ptr<ClientResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«ClientResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«ClientResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«ClientResource»::getFirst() const
{
    return m_First;
}


void PageResource«ClientResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«ClientResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«ClientResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«ClientResource»::getLast() const
{
    return m_Last;
}


void PageResource«ClientResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«ClientResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«ClientResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«ClientResource»::getNumber() const
{
    return m_number;
}


void PageResource«ClientResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«ClientResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«ClientResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«ClientResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«ClientResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«ClientResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«ClientResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«ClientResource»::getSize() const
{
    return m_Size;
}


void PageResource«ClientResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«ClientResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«ClientResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«ClientResource»::getSort()
{
    return m_Sort;
}

void PageResource«ClientResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«ClientResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«ClientResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«ClientResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«ClientResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«ClientResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«ClientResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«ClientResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«ClientResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«ClientResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«ClientResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
