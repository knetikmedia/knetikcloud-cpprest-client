...
Social_GoogleApi::Social_GoogleApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<void> Social_GoogleApi::linkAccounts1(std::shared_ptr<GoogleToken> googleToken)
{
    ...
    {
        throw ApiException(400, U("Social_GoogleApi->linkAccounts1 does not produce any supported media type"));
    }
    ...
    if ( consumeHttpContentTypes.size() == 0 || consumeHttpContentTypes.find(U("application/json")) != consumeHttpContentTypes.end() )
    {
        ...
        json = ModelBase::toJson(googleToken);
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
                if(googleToken.get())
        {
            googleToken->toMultipart(multipart, U("googleToken"));
        }
    ...
    {
        throw ApiException(415, U("Social_GoogleApi->linkAccounts1 does not consume any supported media type"));
    }
