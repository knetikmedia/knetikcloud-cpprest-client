...
Util_SecurityApi::Util_SecurityApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<PageResource«LocationLogResource»>> Util_SecurityApi::getUserLocationLog(int32_t userId, int32_t size, int32_t page, utility::string_t order)
{
    ...
    {
        throw ApiException(400, U("Util_SecurityApi->getUserLocationLog does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Util_SecurityApi->getUserLocationLog does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<TokenDetailsResource>> Util_SecurityApi::getUserTokenDetails()
{
    ...
    {
        throw ApiException(400, U("Util_SecurityApi->getUserTokenDetails does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Util_SecurityApi->getUserTokenDetails does not consume any supported media type"));
    }
