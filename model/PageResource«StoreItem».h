...
/*
 * PageResource«StoreItem».h
 *
 * 
 */

#ifndef PageResource«StoreItem»_H_
#define PageResource«StoreItem»_H_
...
/// 
/// </summary>
class  PageResource«StoreItem»
    : public ModelBase
{
public:
    PageResource«StoreItem»();
    virtual ~PageResource«StoreItem»();
    ...
    /////////////////////////////////////////////
    /// PageResource«StoreItem» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<StoreItem>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<StoreItem>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<StoreItem>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«StoreItem»_H_ */
