...
public:
    ...
    /// </remarks>
    /// <param name="userId">The id of the user</param>/// <param name="filterName">Filter for level schemas whose name contains a given string (optional)</param>/// <param name="size">The number of objects returned per page (optional, default to 25)</param>/// <param name="page">The number of the page returned, starting with 1 (optional, default to 1)</param>/// <param name="order">A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional)</param>
    pplx::task<std::shared_ptr<PageResource«UserLevelingResource»>> getUserLevels(int32_t userId, utility::string_t filterName, int32_t size, int32_t page, utility::string_t order);
    /// <summary>
    ...
    pplx::task<void> incrementProgress(int32_t userId, utility::string_t name, int32_t progress);
    /// <summary>
    ...
    pplx::task<void> setProgress(int32_t userId, utility::string_t name, int32_t progress);
    /// <summary>
    /// Update a level
    /// </summary>
    /// <remarks>
