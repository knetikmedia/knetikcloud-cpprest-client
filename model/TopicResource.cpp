...
void TopicResource::validate()
{
    // TODO: implement validation
}

web::json::value TopicResource::toJson() const
{
...
void TopicResource::fromJson(web::json::value& val)
{
...
void TopicResource::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void TopicResource::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
int64_t TopicResource::getCreatedDate() const
{
    return m_Created_date;
}


void TopicResource::setCreatedDate(int64_t value)
{
    m_Created_date = value;
    m_Created_dateIsSet = true;
}
bool TopicResource::createdDateIsSet() const
{
    return m_Created_dateIsSet;
}

void TopicResource::unsetCreated_date()
{
    m_Created_dateIsSet = false;
}

utility::string_t TopicResource::getDisplayName() const
{
    return m_Display_name;
}


void TopicResource::setDisplayName(utility::string_t value)
{
    m_Display_name = value;
    m_Display_nameIsSet = true;
}
bool TopicResource::displayNameIsSet() const
{
    return m_Display_nameIsSet;
}

void TopicResource::unsetDisplay_name()
{
    m_Display_nameIsSet = false;
}

utility::string_t TopicResource::getId() const
{
    return m_Id;
}


void TopicResource::setId(utility::string_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}
bool TopicResource::idIsSet() const
{
    return m_IdIsSet;
}

void TopicResource::unsetId()
{
    m_IdIsSet = false;
}

bool TopicResource::getLocked() const
{
    return m_Locked;
}


void TopicResource::setLocked(bool value)
{
    m_Locked = value;
    m_LockedIsSet = true;
}
bool TopicResource::lockedIsSet() const
{
    return m_LockedIsSet;
}

void TopicResource::unsetLocked()
{
    m_LockedIsSet = false;
}

std::vector<utility::string_t>& TopicResource::getTags()
{
    return m_Tags;
}

void TopicResource::setTags(std::vector<utility::string_t> value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}
bool TopicResource::tagsIsSet() const
{
    return m_TagsIsSet;
}

void TopicResource::unsetTags()
{
    m_TagsIsSet = false;
}

int64_t TopicResource::getUpdatedDate() const
{
    return m_Updated_date;
}


void TopicResource::setUpdatedDate(int64_t value)
{
    m_Updated_date = value;
    m_Updated_dateIsSet = true;
}
bool TopicResource::updatedDateIsSet() const
{
    return m_Updated_dateIsSet;
}

void TopicResource::unsetUpdated_date()
{
    m_Updated_dateIsSet = false;
}

int32_t TopicResource::getUserCount() const
{
    return m_User_count;
}


void TopicResource::setUserCount(int32_t value)
{
    m_User_count = value;
    m_User_countIsSet = true;
}
bool TopicResource::userCountIsSet() const
{
    return m_User_countIsSet;
}

void TopicResource::unsetUser_count()
{
    m_User_countIsSet = false;
}
