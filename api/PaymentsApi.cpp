...
pplx::task<std::shared_ptr<PaymentMethodTypeResource>> PaymentsApi::getPaymentMethodType(int32_t id)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/payment/types/{id}");
    boost::replace_all(path, U("{") U("id") U("}"), ApiClient::parameterToString(id));
    ...
    {
        throw ApiException(400, U("PaymentsApi->getPaymentMethodType does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("PaymentsApi->getPaymentMethodType does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling getPaymentMethodType: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling getPaymentMethodType: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<PaymentMethodTypeResource> result(new PaymentMethodTypeResource());
        ...
        {
            throw ApiException(500
                , U("error calling getPaymentMethodType: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<PageResource«PaymentMethodTypeResource»>> PaymentsApi::getPaymentMethodTypes(utility::string_t filterName, int32_t size, int32_t page, utility::string_t order)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/payment/types");
    ...
    {
        throw ApiException(400, U("PaymentsApi->getPaymentMethodTypes does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("PaymentsApi->getPaymentMethodTypes does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , U("error calling getPaymentMethodTypes: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling getPaymentMethodTypes: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<PageResource«PaymentMethodTypeResource»> result(new PageResource«PaymentMethodTypeResource»());
        ...
        {
            throw ApiException(500
                , U("error calling getPaymentMethodTypes: unsupported response type"));
        }
