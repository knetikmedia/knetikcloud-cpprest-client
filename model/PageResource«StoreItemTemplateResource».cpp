...
PageResource«StoreItemTemplateResource»::PageResource«StoreItemTemplateResource»()
{
...
void PageResource«StoreItemTemplateResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«StoreItemTemplateResource»::toJson() const
{
...
void PageResource«StoreItemTemplateResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<StoreItemTemplateResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<StoreItemTemplateResource> newItem(new StoreItemTemplateResource());
...
void PageResource«StoreItemTemplateResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«StoreItemTemplateResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<StoreItemTemplateResource>>& PageResource«StoreItemTemplateResource»::getContent()
{
    return m_Content;
}

void PageResource«StoreItemTemplateResource»::setContent(std::vector<std::shared_ptr<StoreItemTemplateResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«StoreItemTemplateResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«StoreItemTemplateResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«StoreItemTemplateResource»::getFirst() const
{
    return m_First;
}


void PageResource«StoreItemTemplateResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«StoreItemTemplateResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«StoreItemTemplateResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«StoreItemTemplateResource»::getLast() const
{
    return m_Last;
}


void PageResource«StoreItemTemplateResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«StoreItemTemplateResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«StoreItemTemplateResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«StoreItemTemplateResource»::getNumber() const
{
    return m_number;
}


void PageResource«StoreItemTemplateResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«StoreItemTemplateResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«StoreItemTemplateResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«StoreItemTemplateResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«StoreItemTemplateResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«StoreItemTemplateResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«StoreItemTemplateResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«StoreItemTemplateResource»::getSize() const
{
    return m_Size;
}


void PageResource«StoreItemTemplateResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«StoreItemTemplateResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«StoreItemTemplateResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«StoreItemTemplateResource»::getSort()
{
    return m_Sort;
}

void PageResource«StoreItemTemplateResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«StoreItemTemplateResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«StoreItemTemplateResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«StoreItemTemplateResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«StoreItemTemplateResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«StoreItemTemplateResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«StoreItemTemplateResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«StoreItemTemplateResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«StoreItemTemplateResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«StoreItemTemplateResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«StoreItemTemplateResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
