...
bool PageResource«UserRelationshipResource»::number_of_elementsIsSet() const
{
...
bool PageResource«UserRelationshipResource»::total_elementsIsSet() const
{
...
bool PageResource«UserRelationshipResource»::total_pagesIsSet() const
{
