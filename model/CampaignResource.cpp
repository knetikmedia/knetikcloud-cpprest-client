...
void CampaignResource::setAdditionalProperties(std::map<utility::string_t, std::shared_ptr<Property>> value)
{
    m_Additional_properties = value;
    m_Additional_propertiesIsSet = true;
}
bool CampaignResource::additionalPropertiesIsSet() const
{
...
bool CampaignResource::createdDateIsSet() const
{
...
bool CampaignResource::leaderboardStrategyIsSet() const
{
...
bool CampaignResource::longDescriptionIsSet() const
{
...
bool CampaignResource::nextChallengeIsSet() const
{
...
bool CampaignResource::nextChallengeDateIsSet() const
{
...
bool CampaignResource::rewardSetIsSet() const
{
...
bool CampaignResource::rewardStatusIsSet() const
{
...
bool CampaignResource::shortDescriptionIsSet() const
{
...
bool CampaignResource::updatedDateIsSet() const
{
