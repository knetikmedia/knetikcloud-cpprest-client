...
/*
 * PageResource«string».h
 *
 * 
 */

#ifndef PageResource«string»_H_
#define PageResource«string»_H_
...
/// 
/// </summary>
class  PageResource«string»
    : public ModelBase
{
public:
    PageResource«string»();
    virtual ~PageResource«string»();
    ...
    void unsetContent();
    void setContent(std::vector<utility::string_t> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
