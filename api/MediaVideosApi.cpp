...
pplx::task<void> MediaVideosApi::addUserToVideoWhitelist(int64_t id, int32_t userId)
{
...
pplx::task<std::shared_ptr<FlagResource>> MediaVideosApi::addVideoFlag(int64_t videoId, utility::string_t reason)
{
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        requestHttpContentType = U("multipart/form-data");
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
        multipart->add(ModelBase::toHttpContent("reason", reason));
...
pplx::task<std::shared_ptr<PageResource«VideoResource»>> MediaVideosApi::getUserVideos(int32_t userId, bool excludeFlagged, int32_t size, int32_t page)
{
...
pplx::task<std::shared_ptr<PageResource«CommentResource»>> MediaVideosApi::getVideoComments(int32_t videoId, int32_t size, int32_t page)
{
...
pplx::task<std::shared_ptr<PageResource«DispositionResource»>> MediaVideosApi::getVideoDispositions(int32_t videoId, int32_t size, int32_t page)
{
...
pplx::task<std::shared_ptr<PageResource«VideoRelationshipResource»>> MediaVideosApi::getVideoRelationships(int64_t videoId, int32_t size, int32_t page)
{
...
pplx::task<std::shared_ptr<PageResource«VideoResource»>> MediaVideosApi::getVideos(bool excludeFlagged, utility::string_t filterVideosByUploader, utility::string_t filterCategory, utility::string_t filterTagset, utility::string_t filterVideosByName, utility::string_t filterVideosByContributor, utility::string_t filterVideosByAuthor, bool filterHasAuthor, bool filterHasUploader, utility::string_t filterRelatedTo, bool filterFriends, utility::string_t filterDisposition, int32_t size, int32_t page, utility::string_t order)
{
...
pplx::task<void> MediaVideosApi::updateVideoComment(int64_t videoId, int64_t id, utility::string_t content)
{
...
pplx::task<void> MediaVideosApi::updateVideoRelationship(int64_t videoId, int64_t relationshipId, utility::string_t details)
{
...
boost::replace_all(path, U("{") U("relationship_id") U("}"), ApiClient::parameterToString(relationshipId));
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        requestHttpContentType = U("multipart/form-data");
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
        multipart->add(ModelBase::toHttpContent("details", details));
