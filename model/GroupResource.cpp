...
bool GroupResource::additional_propertiesIsSet() const
{
...
bool GroupResource::member_countIsSet() const
{
...
bool GroupResource::message_of_the_dayIsSet() const
{
...
bool GroupResource::sub_member_countIsSet() const
{
