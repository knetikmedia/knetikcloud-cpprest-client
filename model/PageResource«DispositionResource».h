...
/*
 * PageResource«DispositionResource».h
 *
 * 
 */

#ifndef PageResource«DispositionResource»_H_
#define PageResource«DispositionResource»_H_
...
/// 
/// </summary>
class  PageResource«DispositionResource»
    : public ModelBase
{
public:
    PageResource«DispositionResource»();
    virtual ~PageResource«DispositionResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«DispositionResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<DispositionResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<DispositionResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<DispositionResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«DispositionResource»_H_ */
