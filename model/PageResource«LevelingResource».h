...
/*
 * PageResource«LevelingResource».h
 *
 * 
 */

#ifndef PageResource«LevelingResource»_H_
#define PageResource«LevelingResource»_H_
...
/// 
/// </summary>
class  PageResource«LevelingResource»
    : public ModelBase
{
public:
    PageResource«LevelingResource»();
    virtual ~PageResource«LevelingResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«LevelingResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<LevelingResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<LevelingResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<LevelingResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«LevelingResource»_H_ */
