...
bool ItemTemplateResource::getAllowAdditional() const
{
    return m_Allow_additional;
}


void ItemTemplateResource::setAllowAdditional(bool value)
{
    m_Allow_additional = value;
    m_Allow_additionalIsSet = true;
}
bool ItemTemplateResource::allowAdditionalIsSet() const
{
    return m_Allow_additionalIsSet;
}

void ItemTemplateResource::unsetAllow_additional()
{
    m_Allow_additionalIsSet = false;
}
