...
/*
 * Payments_TransactionsApi.h
 *
 * 
 */

#ifndef Payments_TransactionsApi_H_
#define Payments_TransactionsApi_H_
...
{
public:
    Payments_TransactionsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Payments_TransactionsApi();
    /// <summary>
...
#endif /* Payments_TransactionsApi_H_ */
