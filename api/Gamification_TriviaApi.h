...
/*
 * Gamification_TriviaApi.h
 *
 * 
 */

#ifndef Gamification_TriviaApi_H_
#define Gamification_TriviaApi_H_
...
{
public:
    Gamification_TriviaApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Gamification_TriviaApi();
    /// <summary>
...
#endif /* Gamification_TriviaApi_H_ */
