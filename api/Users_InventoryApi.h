...
/*
 * Users_InventoryApi.h
 *
 * 
 */

#ifndef Users_InventoryApi_H_
#define Users_InventoryApi_H_
...
{
public:
    Users_InventoryApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Users_InventoryApi();
    /// <summary>
    ...
    pplx::task<std::shared_ptr<UserInventoryResource>> getUserInventory(utility::string_t userId, int32_t id);
    /// <summary>
    ...
    pplx::task<void> updateUserInventoryStatus(int32_t userId, int32_t id, std::shared_ptr<InventoryStatusWrapper> inventoryStatus);
    /// <summary>
    /// Use an item
    /// </summary>
    /// <remarks>
