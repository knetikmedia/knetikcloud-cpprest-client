...
#ifndef PageResource«CurrencyResource»_H_
#define PageResource«CurrencyResource»_H_
...
/// 
/// </summary>
class  PageResource«CurrencyResource»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«CurrencyResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CurrencyResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<CurrencyResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<CurrencyResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«CurrencyResource»_H_ */
