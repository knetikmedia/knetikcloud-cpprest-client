...
InvoiceResource::InvoiceResource()
{
    ...
    m_Remaining_balance = 0.0;
    m_Remaining_balanceIsSet = false;
    m_Shipping = 0.0;
...
web::json::value InvoiceResource::toJson() const
{
    ...
    if(m_Remaining_balanceIsSet)
    {
        val[U("remaining_balance")] = ModelBase::toJson(m_Remaining_balance);
    }
    if(m_ShippingIsSet)
    {
...
void InvoiceResource::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("remaining_balance")))
    {
        setRemainingBalance(ModelBase::doubleFromJson(val[U("remaining_balance")]));
    }
...
void InvoiceResource::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Remaining_balanceIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + U("remaining_balance"), m_Remaining_balance));
    }
    if(m_ShippingIsSet)
    {
...
void InvoiceResource::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(U("remaining_balance")))
    {
        setRemainingBalance(ModelBase::doubleFromHttpContent(multipart->getContent(U("remaining_balance"))));
    }
...
bool InvoiceResource::billingAddress1IsSet() const
{
...
bool InvoiceResource::billingAddress2IsSet() const
{
...
bool InvoiceResource::billingCityNameIsSet() const
{
...
bool InvoiceResource::billingCountryNameIsSet() const
{
...
bool InvoiceResource::billingFullNameIsSet() const
{
...
bool InvoiceResource::billingPostalCodeIsSet() const
{
...
bool InvoiceResource::billingStateNameIsSet() const
{
...
bool InvoiceResource::cartIdIsSet() const
{
...
bool InvoiceResource::createdDateIsSet() const
{
...
bool InvoiceResource::currentFulfillmentStatusIsSet() const
{
...
bool InvoiceResource::currentPaymentStatusIsSet() const
{
...
bool InvoiceResource::externalRefIsSet() const
{
...
bool InvoiceResource::fedTaxIsSet() const
{
...
bool InvoiceResource::grandTotalIsSet() const
{
...
bool InvoiceResource::invoiceNumberIsSet() const
{
...
void InvoiceResource::setItems(std::vector<std::shared_ptr<InvoiceItemResource>> value)
{
    m_Items = value;
    m_ItemsIsSet = true;
}
...
bool InvoiceResource::namePrefixIsSet() const
{
...
bool InvoiceResource::orderNotesIsSet() const
{
...
bool InvoiceResource::parentInvoiceIdIsSet() const
{
...
bool InvoiceResource::paymentMethodIdIsSet() const
{
...
bool InvoiceResource::phoneNumberIsSet() const
{
...
double InvoiceResource::getRemainingBalance() const
{
    return m_Remaining_balance;
}


void InvoiceResource::setRemainingBalance(double value)
{
    m_Remaining_balance = value;
    m_Remaining_balanceIsSet = true;
}
bool InvoiceResource::remainingBalanceIsSet() const
{
    return m_Remaining_balanceIsSet;
}

void InvoiceResource::unsetRemaining_balance()
{
    m_Remaining_balanceIsSet = false;
}
...
bool InvoiceResource::shippingAddress1IsSet() const
{
...
bool InvoiceResource::shippingAddress2IsSet() const
{
...
bool InvoiceResource::shippingCityNameIsSet() const
{
...
bool InvoiceResource::shippingCountryNameIsSet() const
{
...
bool InvoiceResource::shippingFullNameIsSet() const
{
...
bool InvoiceResource::shippingPostalCodeIsSet() const
{
...
bool InvoiceResource::shippingStateNameIsSet() const
{
...
bool InvoiceResource::stateTaxIsSet() const
{
...
bool InvoiceResource::updatedDateIsSet() const
{
...
bool InvoiceResource::vendorIdIsSet() const
{
...
bool InvoiceResource::vendorNameIsSet() const
{
