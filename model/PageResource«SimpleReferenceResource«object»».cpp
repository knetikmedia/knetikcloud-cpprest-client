...
PageResource«SimpleReferenceResource«object»»::PageResource«SimpleReferenceResource«object»»()
{
...
void PageResource«SimpleReferenceResource«object»»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«SimpleReferenceResource«object»»::toJson() const
{
...
void PageResource«SimpleReferenceResource«object»»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<SimpleReferenceResource«object»>(nullptr) );
            }
            else
            {
                std::shared_ptr<SimpleReferenceResource«object»> newItem(new SimpleReferenceResource«object»());
...
void PageResource«SimpleReferenceResource«object»»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«SimpleReferenceResource«object»»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<SimpleReferenceResource«object»>>& PageResource«SimpleReferenceResource«object»»::getContent()
{
    return m_Content;
}

void PageResource«SimpleReferenceResource«object»»::setContent(std::vector<std::shared_ptr<SimpleReferenceResource«object»>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«SimpleReferenceResource«object»»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«SimpleReferenceResource«object»»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«SimpleReferenceResource«object»»::getFirst() const
{
    return m_First;
}


void PageResource«SimpleReferenceResource«object»»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«SimpleReferenceResource«object»»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«SimpleReferenceResource«object»»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«SimpleReferenceResource«object»»::getLast() const
{
    return m_Last;
}


void PageResource«SimpleReferenceResource«object»»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«SimpleReferenceResource«object»»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«SimpleReferenceResource«object»»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«SimpleReferenceResource«object»»::getNumber() const
{
    return m_number;
}


void PageResource«SimpleReferenceResource«object»»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«SimpleReferenceResource«object»»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«SimpleReferenceResource«object»»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«SimpleReferenceResource«object»»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«SimpleReferenceResource«object»»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«SimpleReferenceResource«object»»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«SimpleReferenceResource«object»»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«SimpleReferenceResource«object»»::getSize() const
{
    return m_Size;
}


void PageResource«SimpleReferenceResource«object»»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«SimpleReferenceResource«object»»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«SimpleReferenceResource«object»»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«SimpleReferenceResource«object»»::getSort()
{
    return m_Sort;
}

void PageResource«SimpleReferenceResource«object»»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«SimpleReferenceResource«object»»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«SimpleReferenceResource«object»»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«SimpleReferenceResource«object»»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«SimpleReferenceResource«object»»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«SimpleReferenceResource«object»»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«SimpleReferenceResource«object»»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«SimpleReferenceResource«object»»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«SimpleReferenceResource«object»»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«SimpleReferenceResource«object»»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«SimpleReferenceResource«object»»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
