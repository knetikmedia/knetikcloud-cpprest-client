...
/*
 * PageResource«ChallengeResource».h
 *
 * 
 */

#ifndef PageResource«ChallengeResource»_H_
#define PageResource«ChallengeResource»_H_
...
/// 
/// </summary>
class  PageResource«ChallengeResource»
    : public ModelBase
{
public:
    PageResource«ChallengeResource»();
    virtual ~PageResource«ChallengeResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«ChallengeResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ChallengeResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ChallengeResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ChallengeResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ChallengeResource»_H_ */
