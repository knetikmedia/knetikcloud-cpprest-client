...
#ifndef PageResource«CategoryResource»_H_
#define PageResource«CategoryResource»_H_
...
/// 
/// </summary>
class  PageResource«CategoryResource»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«CategoryResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CategoryResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<CategoryResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<CategoryResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«CategoryResource»_H_ */
