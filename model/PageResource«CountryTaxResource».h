...
/*
 * PageResource«CountryTaxResource».h
 *
 * 
 */

#ifndef PageResource«CountryTaxResource»_H_
#define PageResource«CountryTaxResource»_H_
...
/// 
/// </summary>
class  PageResource«CountryTaxResource»
    : public ModelBase
{
public:
    PageResource«CountryTaxResource»();
    virtual ~PageResource«CountryTaxResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«CountryTaxResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CountryTaxResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<CountryTaxResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<CountryTaxResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«CountryTaxResource»_H_ */
