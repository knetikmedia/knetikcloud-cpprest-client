...
#ifndef PageResource«BareActivityResource»_H_
#define PageResource«BareActivityResource»_H_
...
/// 
/// </summary>
class  PageResource«BareActivityResource»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«BareActivityResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<BareActivityResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<BareActivityResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<BareActivityResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«BareActivityResource»_H_ */
