...
/*
 * PageResource«DeviceResource».h
 *
 * 
 */

#ifndef PageResource«DeviceResource»_H_
#define PageResource«DeviceResource»_H_
...
/// 
/// </summary>
class  PageResource«DeviceResource»
    : public ModelBase
{
public:
    PageResource«DeviceResource»();
    virtual ~PageResource«DeviceResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«DeviceResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<DeviceResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<DeviceResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<DeviceResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«DeviceResource»_H_ */
