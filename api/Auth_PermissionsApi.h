...
/*
 * Auth_PermissionsApi.h
 *
 * 
 */

#ifndef Auth_PermissionsApi_H_
#define Auth_PermissionsApi_H_
...
{
public:
    Auth_PermissionsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Auth_PermissionsApi();
    /// <summary>
