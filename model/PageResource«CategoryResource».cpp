...
PageResource«CategoryResource»::PageResource«CategoryResource»()
{
...
void PageResource«CategoryResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«CategoryResource»::toJson() const
{
...
void PageResource«CategoryResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<CategoryResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<CategoryResource> newItem(new CategoryResource());
...
void PageResource«CategoryResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«CategoryResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<CategoryResource>>& PageResource«CategoryResource»::getContent()
{
    return m_Content;
}

void PageResource«CategoryResource»::setContent(std::vector<std::shared_ptr<CategoryResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«CategoryResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«CategoryResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«CategoryResource»::getFirst() const
{
    return m_First;
}


void PageResource«CategoryResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«CategoryResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«CategoryResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«CategoryResource»::getLast() const
{
    return m_Last;
}


void PageResource«CategoryResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«CategoryResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«CategoryResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«CategoryResource»::getNumber() const
{
    return m_number;
}


void PageResource«CategoryResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«CategoryResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«CategoryResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«CategoryResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«CategoryResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«CategoryResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«CategoryResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«CategoryResource»::getSize() const
{
    return m_Size;
}


void PageResource«CategoryResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«CategoryResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«CategoryResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«CategoryResource»::getSort()
{
    return m_Sort;
}

void PageResource«CategoryResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«CategoryResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«CategoryResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«CategoryResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«CategoryResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«CategoryResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«CategoryResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«CategoryResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«CategoryResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«CategoryResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«CategoryResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
