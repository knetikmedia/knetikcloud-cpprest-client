...
/*
 * PageResource«WalletTransactionResource».h
 *
 * 
 */

#ifndef PageResource«WalletTransactionResource»_H_
#define PageResource«WalletTransactionResource»_H_
...
/// 
/// </summary>
class  PageResource«WalletTransactionResource»
    : public ModelBase
{
public:
    PageResource«WalletTransactionResource»();
    virtual ~PageResource«WalletTransactionResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«WalletTransactionResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<WalletTransactionResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<WalletTransactionResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<WalletTransactionResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«WalletTransactionResource»_H_ */
