...
/*
 * Gamification_AchievementsApi.h
 *
 * 
 */

#ifndef Gamification_AchievementsApi_H_
#define Gamification_AchievementsApi_H_
...
{
public:
    Gamification_AchievementsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Gamification_AchievementsApi();
    /// <summary>
...
#endif /* Gamification_AchievementsApi_H_ */
