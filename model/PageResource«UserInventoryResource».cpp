...
void PageResource«UserInventoryResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«UserInventoryResource»::toJson() const
{
...
void PageResource«UserInventoryResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<UserInventoryResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<UserInventoryResource> newItem(new UserInventoryResource());
...
void PageResource«UserInventoryResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«UserInventoryResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<UserInventoryResource>>& PageResource«UserInventoryResource»::getContent()
{
    return m_Content;
}

void PageResource«UserInventoryResource»::setContent(std::vector<std::shared_ptr<UserInventoryResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«UserInventoryResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«UserInventoryResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«UserInventoryResource»::getFirst() const
{
    return m_First;
}


void PageResource«UserInventoryResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«UserInventoryResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«UserInventoryResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«UserInventoryResource»::getLast() const
{
    return m_Last;
}


void PageResource«UserInventoryResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«UserInventoryResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«UserInventoryResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«UserInventoryResource»::getNumber() const
{
    return m_number;
}


void PageResource«UserInventoryResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«UserInventoryResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«UserInventoryResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«UserInventoryResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«UserInventoryResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«UserInventoryResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«UserInventoryResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«UserInventoryResource»::getSize() const
{
    return m_Size;
}


void PageResource«UserInventoryResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«UserInventoryResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«UserInventoryResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«UserInventoryResource»::getSort()
{
    return m_Sort;
}

void PageResource«UserInventoryResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«UserInventoryResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«UserInventoryResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«UserInventoryResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«UserInventoryResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«UserInventoryResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«UserInventoryResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«UserInventoryResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«UserInventoryResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«UserInventoryResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«UserInventoryResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
