...
bool CartLineItem::currencyCodeIsSet() const
{
...
bool CartLineItem::lineTotalIsSet() const
{
...
bool CartLineItem::originalLineTotalIsSet() const
{
...
bool CartLineItem::originalUnitPriceIsSet() const
{
...
bool CartLineItem::saleNameIsSet() const
{
...
bool CartLineItem::skuDescriptionIsSet() const
{
...
bool CartLineItem::storeItemIdIsSet() const
{
...
void CartLineItem::setTags(std::vector<utility::string_t> value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}
...
bool CartLineItem::thumbUrlIsSet() const
{
...
utility::string_t CartLineItem::getUniqueKey() const
{
    return m_Unique_key;
}


void CartLineItem::setUniqueKey(utility::string_t value)
{
    m_Unique_key = value;
    m_Unique_keyIsSet = true;
}
bool CartLineItem::uniqueKeyIsSet() const
{
    return m_Unique_keyIsSet;
}

void CartLineItem::unsetUnique_key()
{
    m_Unique_keyIsSet = false;
}
...
bool CartLineItem::unitPriceIsSet() const
{
...
bool CartLineItem::vendorIdIsSet() const
{
...
bool CartLineItem::vendorNameIsSet() const
{
