...
/*
 * PageResource«PermissionResource».h
 *
 * 
 */

#ifndef PageResource«PermissionResource»_H_
#define PageResource«PermissionResource»_H_
...
/// 
/// </summary>
class  PageResource«PermissionResource»
    : public ModelBase
{
public:
    PageResource«PermissionResource»();
    virtual ~PageResource«PermissionResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«PermissionResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<PermissionResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<PermissionResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<PermissionResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«PermissionResource»_H_ */
