...
#ifndef PageResource«AggregateCountResource»_H_
#define PageResource«AggregateCountResource»_H_
...
/// 
/// </summary>
class  PageResource«AggregateCountResource»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«AggregateCountResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AggregateCountResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<AggregateCountResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<AggregateCountResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«AggregateCountResource»_H_ */
