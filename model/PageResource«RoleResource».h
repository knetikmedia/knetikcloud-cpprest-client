...
/*
 * PageResource«RoleResource».h
 *
 * 
 */

#ifndef PageResource«RoleResource»_H_
#define PageResource«RoleResource»_H_
...
/// 
/// </summary>
class  PageResource«RoleResource»
    : public ModelBase
{
public:
    PageResource«RoleResource»();
    virtual ~PageResource«RoleResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«RoleResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<RoleResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<RoleResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<RoleResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«RoleResource»_H_ */
