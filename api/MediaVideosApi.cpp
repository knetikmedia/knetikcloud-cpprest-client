...
pplx::task<std::shared_ptr<PageResource«VideoResource»>> MediaVideosApi::getVideos(bool excludeFlagged, int32_t filterVideosByUploader, utility::string_t filterCategory, utility::string_t filterTagset, utility::string_t filterVideosByName, int32_t filterVideosByContributor, int32_t filterVideosByAuthor, bool filterHasAuthor, bool filterHasUploader, utility::string_t filterRelatedTo, bool filterFriends, utility::string_t filterDisposition, int32_t size, int32_t page, utility::string_t order)
{
