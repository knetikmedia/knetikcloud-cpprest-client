...
/*
 * Reporting_SubscriptionsApi.h
 *
 * 
 */

#ifndef Reporting_SubscriptionsApi_H_
#define Reporting_SubscriptionsApi_H_
...
{
public:
    Reporting_SubscriptionsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Reporting_SubscriptionsApi();
    /// <summary>
...
#endif /* Reporting_SubscriptionsApi_H_ */
