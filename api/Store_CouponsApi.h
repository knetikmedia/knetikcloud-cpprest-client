...
#ifndef Store_CouponsApi_H_
#define Store_CouponsApi_H_
...
{
public:
    Store_CouponsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Store_CouponsApi();
    /// <summary>
