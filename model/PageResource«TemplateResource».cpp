...
PageResource«TemplateResource»::PageResource«TemplateResource»()
{
...
void PageResource«TemplateResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«TemplateResource»::toJson() const
{
...
void PageResource«TemplateResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<TemplateResource>(nullptr) );
            }
            else
            {
...
void PageResource«TemplateResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«TemplateResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<TemplateResource>>& PageResource«TemplateResource»::getContent()
{
    return m_Content;
}

void PageResource«TemplateResource»::setContent(std::vector<std::shared_ptr<TemplateResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«TemplateResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«TemplateResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«TemplateResource»::getFirst() const
{
    return m_First;
}


void PageResource«TemplateResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«TemplateResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«TemplateResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«TemplateResource»::getLast() const
{
    return m_Last;
}


void PageResource«TemplateResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«TemplateResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«TemplateResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«TemplateResource»::getNumber() const
{
    return m_number;
}


void PageResource«TemplateResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«TemplateResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«TemplateResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«TemplateResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«TemplateResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«TemplateResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«TemplateResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«TemplateResource»::getSize() const
{
    return m_Size;
}


void PageResource«TemplateResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«TemplateResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«TemplateResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«TemplateResource»::getSort()
{
    return m_Sort;
}

void PageResource«TemplateResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«TemplateResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«TemplateResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«TemplateResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«TemplateResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«TemplateResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«TemplateResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«TemplateResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«TemplateResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«TemplateResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«TemplateResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
