...
PageResource«DeviceResource»::PageResource«DeviceResource»()
{
...
void PageResource«DeviceResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«DeviceResource»::toJson() const
{
...
void PageResource«DeviceResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<DeviceResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<DeviceResource> newItem(new DeviceResource());
...
void PageResource«DeviceResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«DeviceResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<DeviceResource>>& PageResource«DeviceResource»::getContent()
{
    return m_Content;
}

void PageResource«DeviceResource»::setContent(std::vector<std::shared_ptr<DeviceResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«DeviceResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«DeviceResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«DeviceResource»::getFirst() const
{
    return m_First;
}


void PageResource«DeviceResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«DeviceResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«DeviceResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«DeviceResource»::getLast() const
{
    return m_Last;
}


void PageResource«DeviceResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«DeviceResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«DeviceResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«DeviceResource»::getNumber() const
{
    return m_number;
}


void PageResource«DeviceResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«DeviceResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«DeviceResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«DeviceResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«DeviceResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«DeviceResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«DeviceResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«DeviceResource»::getSize() const
{
    return m_Size;
}


void PageResource«DeviceResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«DeviceResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«DeviceResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«DeviceResource»::getSort()
{
    return m_Sort;
}

void PageResource«DeviceResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«DeviceResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«DeviceResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«DeviceResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«DeviceResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«DeviceResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«DeviceResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«DeviceResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«DeviceResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«DeviceResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«DeviceResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
