...
PageResource«FlagResource»::PageResource«FlagResource»()
{
...
void PageResource«FlagResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«FlagResource»::toJson() const
{
...
void PageResource«FlagResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<FlagResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<FlagResource> newItem(new FlagResource());
...
void PageResource«FlagResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«FlagResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<FlagResource>>& PageResource«FlagResource»::getContent()
{
    return m_Content;
}

void PageResource«FlagResource»::setContent(std::vector<std::shared_ptr<FlagResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«FlagResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«FlagResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«FlagResource»::getFirst() const
{
    return m_First;
}


void PageResource«FlagResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«FlagResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«FlagResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«FlagResource»::getLast() const
{
    return m_Last;
}


void PageResource«FlagResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«FlagResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«FlagResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«FlagResource»::getNumber() const
{
    return m_number;
}


void PageResource«FlagResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«FlagResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«FlagResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«FlagResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«FlagResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«FlagResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«FlagResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«FlagResource»::getSize() const
{
    return m_Size;
}


void PageResource«FlagResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«FlagResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«FlagResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«FlagResource»::getSort()
{
    return m_Sort;
}

void PageResource«FlagResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«FlagResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«FlagResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«FlagResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«FlagResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«FlagResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«FlagResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«FlagResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«FlagResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«FlagResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«FlagResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
