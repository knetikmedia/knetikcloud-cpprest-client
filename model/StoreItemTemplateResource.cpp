...
bool StoreItemTemplateResource::created_dateIsSet() const
{
...
bool StoreItemTemplateResource::sku_templateIsSet() const
{
...
bool StoreItemTemplateResource::updated_dateIsSet() const
{
