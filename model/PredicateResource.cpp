...
utility::string_t PredicateResource::getDefinition() const
{
    return m_Definition;
}


void PredicateResource::setDefinition(utility::string_t value)
{
    m_Definition = value;
    m_DefinitionIsSet = true;
}
bool PredicateResource::definitionIsSet() const
{
    return m_DefinitionIsSet;
}

void PredicateResource::unsetDefinition()
{
    m_DefinitionIsSet = false;
}
...
utility::string_t PredicateResource::getReturnType() const
{
    return m_Return_type;
}


void PredicateResource::setReturnType(utility::string_t value)
{
    m_Return_type = value;
    m_Return_typeIsSet = true;
}
bool PredicateResource::returnTypeIsSet() const
{
    return m_Return_typeIsSet;
}

void PredicateResource::unsetReturn_type()
{
    m_Return_typeIsSet = false;
}

std::vector<std::shared_ptr<OperationDefinitionResource>>& PredicateResource::getSupportedOperators()
{
    return m_Supported_operators;
}

void PredicateResource::setSupportedOperators(std::vector<std::shared_ptr<OperationDefinitionResource>> value)
{
    m_Supported_operators = value;
    m_Supported_operatorsIsSet = true;
}
bool PredicateResource::supportedOperatorsIsSet() const
{
    return m_Supported_operatorsIsSet;
}

void PredicateResource::unsetSupported_operators()
{
    m_Supported_operatorsIsSet = false;
}
