...
/*
 * PageResource«SimpleWallet».h
 *
 * 
 */

#ifndef PageResource«SimpleWallet»_H_
#define PageResource«SimpleWallet»_H_
...
/// 
/// </summary>
class  PageResource«SimpleWallet»
    : public ModelBase
{
public:
    PageResource«SimpleWallet»();
    virtual ~PageResource«SimpleWallet»();
    ...
    /////////////////////////////////////////////
    /// PageResource«SimpleWallet» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SimpleWallet>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<SimpleWallet>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<SimpleWallet>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«SimpleWallet»_H_ */
