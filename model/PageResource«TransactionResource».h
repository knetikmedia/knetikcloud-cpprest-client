...
/*
 * PageResource«TransactionResource».h
 *
 * 
 */

#ifndef PageResource«TransactionResource»_H_
#define PageResource«TransactionResource»_H_
...
/// 
/// </summary>
class  PageResource«TransactionResource»
    : public ModelBase
{
public:
    PageResource«TransactionResource»();
    virtual ~PageResource«TransactionResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«TransactionResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<TransactionResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<TransactionResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<TransactionResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«TransactionResource»_H_ */
