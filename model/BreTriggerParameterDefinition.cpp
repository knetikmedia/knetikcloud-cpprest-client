...
bool BreTriggerParameterDefinition::getImplicit() const
{
    return m_Implicit;
}


void BreTriggerParameterDefinition::setImplicit(bool value)
{
    m_Implicit = value;
    m_ImplicitIsSet = true;
}
bool BreTriggerParameterDefinition::implicitIsSet() const
{
    return m_ImplicitIsSet;
}

void BreTriggerParameterDefinition::unsetImplicit()
{
    m_ImplicitIsSet = false;
}
