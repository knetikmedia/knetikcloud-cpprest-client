...
/*
 * PageResource«UserInventoryResource».h
 *
 * 
 */

#ifndef PageResource«UserInventoryResource»_H_
#define PageResource«UserInventoryResource»_H_
...
/// 
/// </summary>
class  PageResource«UserInventoryResource»
    : public ModelBase
{
public:
    PageResource«UserInventoryResource»();
    virtual ~PageResource«UserInventoryResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«UserInventoryResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UserInventoryResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<UserInventoryResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<UserInventoryResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«UserInventoryResource»_H_ */
