...
void PriceOverridable::fromJson(web::json::value& val)
{
    ...
    {
        setMaxPrice(ModelBase::doubleFromJson(val[U("max_price")]));
    }
    if(val.has_field(U("min_price")))
    {
        setMinPrice(ModelBase::doubleFromJson(val[U("min_price")]));
    }
}
...
void PriceOverridable::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    {
        setMaxPrice(ModelBase::doubleFromHttpContent(multipart->getContent(U("max_price"))));
    }
    if(multipart->hasContent(U("min_price")))
    {
        setMinPrice(ModelBase::doubleFromHttpContent(multipart->getContent(U("min_price"))));
    }
}

double PriceOverridable::getMaxPrice() const
{
    return m_Max_price;
}


void PriceOverridable::setMaxPrice(double value)
{
    m_Max_price = value;
...
double PriceOverridable::getMinPrice() const
{
    return m_Min_price;
}


void PriceOverridable::setMinPrice(double value)
{
    m_Min_price = value;
