...
/*
 * PageResource«CartSummary».h
 *
 * 
 */

#ifndef PageResource«CartSummary»_H_
#define PageResource«CartSummary»_H_
...
/// 
/// </summary>
class  PageResource«CartSummary»
    : public ModelBase
{
public:
    PageResource«CartSummary»();
    virtual ~PageResource«CartSummary»();
    ...
    /////////////////////////////////////////////
    /// PageResource«CartSummary» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CartSummary>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<CartSummary>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<CartSummary>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«CartSummary»_H_ */
