...
/*
 * PageResource«NotificationTypeResource».h
 *
 * 
 */

#ifndef PageResource«NotificationTypeResource»_H_
#define PageResource«NotificationTypeResource»_H_
...
/// 
/// </summary>
class  PageResource«NotificationTypeResource»
    : public ModelBase
{
public:
    PageResource«NotificationTypeResource»();
    virtual ~PageResource«NotificationTypeResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«NotificationTypeResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<NotificationTypeResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<NotificationTypeResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<NotificationTypeResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«NotificationTypeResource»_H_ */
