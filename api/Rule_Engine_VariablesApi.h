...
/*
 * Rule_Engine_VariablesApi.h
 *
 * 
 */

#ifndef Rule_Engine_VariablesApi_H_
#define Rule_Engine_VariablesApi_H_
...
{
public:
    Rule_Engine_VariablesApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Rule_Engine_VariablesApi();
    /// <summary>
...
#endif /* Rule_Engine_VariablesApi_H_ */
