...
/*
 * PageResource«FlagResource».h
 *
 * 
 */

#ifndef PageResource«FlagResource»_H_
#define PageResource«FlagResource»_H_
...
/// 
/// </summary>
class  PageResource«FlagResource»
    : public ModelBase
{
public:
    PageResource«FlagResource»();
    virtual ~PageResource«FlagResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«FlagResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<FlagResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<FlagResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<FlagResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«FlagResource»_H_ */
