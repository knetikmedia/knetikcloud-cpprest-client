...
bool PageResource«BreRule»::number_of_elementsIsSet() const
{
...
bool PageResource«BreRule»::total_elementsIsSet() const
{
...
bool PageResource«BreRule»::total_pagesIsSet() const
{
