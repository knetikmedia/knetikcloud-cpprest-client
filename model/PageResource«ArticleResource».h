...
#ifndef PageResource«ArticleResource»_H_
#define PageResource«ArticleResource»_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«ArticleResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ArticleResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ArticleResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ArticleResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ArticleResource»_H_ */
