...
void BehaviorDefinitionResource::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        for( auto& item : val[U("properties")].as_array() )
        {
            if(item.is_null())
            {
                m_Properties.push_back( std::shared_ptr<PropertyFieldResource>(nullptr) );
            }
            else
            {
...
void BehaviorDefinitionResource::setPrerequisiteBehaviors(std::vector<std::shared_ptr<Behavior>> value)
{
    m_Prerequisite_behaviors = value;
    m_Prerequisite_behaviorsIsSet = true;
}
bool BehaviorDefinitionResource::prerequisiteBehaviorsIsSet() const
{
...
std::vector<std::shared_ptr<PropertyFieldResource>>& BehaviorDefinitionResource::getProperties()
{
    return m_Properties;
}

void BehaviorDefinitionResource::setProperties(std::vector<std::shared_ptr<PropertyFieldResource>> value)
{
    m_Properties = value;
