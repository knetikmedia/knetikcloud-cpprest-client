...
#ifndef Users_GroupsApi_H_
#define Users_GroupsApi_H_
...
{
public:
    Users_GroupsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Users_GroupsApi();
    /// <summary>
    ...
    pplx::task<void> updateGroupMemberStatus(utility::string_t uniqueName, int32_t userId, std::shared_ptr<GroupMemberStatusWrapper> status);
    /// <summary>
