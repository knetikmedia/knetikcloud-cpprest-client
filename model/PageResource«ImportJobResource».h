...
#ifndef PageResource«ImportJobResource»_H_
#define PageResource«ImportJobResource»_H_
...
/// 
/// </summary>
class  PageResource«ImportJobResource»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«ImportJobResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ImportJobResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ImportJobResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ImportJobResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ImportJobResource»_H_ */
