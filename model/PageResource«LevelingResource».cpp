...
PageResource«LevelingResource»::PageResource«LevelingResource»()
{
...
void PageResource«LevelingResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«LevelingResource»::toJson() const
{
...
void PageResource«LevelingResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<LevelingResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<LevelingResource> newItem(new LevelingResource());
...
void PageResource«LevelingResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«LevelingResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<LevelingResource>>& PageResource«LevelingResource»::getContent()
{
    return m_Content;
}

void PageResource«LevelingResource»::setContent(std::vector<std::shared_ptr<LevelingResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«LevelingResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«LevelingResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«LevelingResource»::getFirst() const
{
    return m_First;
}


void PageResource«LevelingResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«LevelingResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«LevelingResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«LevelingResource»::getLast() const
{
    return m_Last;
}


void PageResource«LevelingResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«LevelingResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«LevelingResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«LevelingResource»::getNumber() const
{
    return m_number;
}


void PageResource«LevelingResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«LevelingResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«LevelingResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«LevelingResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«LevelingResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«LevelingResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«LevelingResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«LevelingResource»::getSize() const
{
    return m_Size;
}


void PageResource«LevelingResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«LevelingResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«LevelingResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«LevelingResource»::getSort()
{
    return m_Sort;
}

void PageResource«LevelingResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«LevelingResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«LevelingResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«LevelingResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«LevelingResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«LevelingResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«LevelingResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«LevelingResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«LevelingResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«LevelingResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«LevelingResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
