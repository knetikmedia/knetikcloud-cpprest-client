...
public:
    ...
    pplx::task<void> addQuestionTag(utility::string_t id, utility::string_t tag);
    /// <summary>
    ...
    pplx::task<int32_t> addTagToQuestionsBatch(utility::string_t tag, utility::string_t filterSearch, utility::string_t filterIdset, utility::string_t filterCategory, utility::string_t filterTag, utility::string_t filterTagset, utility::string_t filterType, bool filterPublished, int64_t filterImportId);
    /// <summary>
