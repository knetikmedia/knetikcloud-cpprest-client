...
void PageResource«BreGlobalResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«BreGlobalResource»::toJson() const
{
...
void PageResource«BreGlobalResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<BreGlobalResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<BreGlobalResource> newItem(new BreGlobalResource());
...
void PageResource«BreGlobalResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«BreGlobalResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<BreGlobalResource>>& PageResource«BreGlobalResource»::getContent()
{
    return m_Content;
}

void PageResource«BreGlobalResource»::setContent(std::vector<std::shared_ptr<BreGlobalResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«BreGlobalResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«BreGlobalResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«BreGlobalResource»::getFirst() const
{
    return m_First;
}


void PageResource«BreGlobalResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«BreGlobalResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«BreGlobalResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«BreGlobalResource»::getLast() const
{
    return m_Last;
}


void PageResource«BreGlobalResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«BreGlobalResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«BreGlobalResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«BreGlobalResource»::getNumber() const
{
    return m_number;
}


void PageResource«BreGlobalResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«BreGlobalResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«BreGlobalResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«BreGlobalResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«BreGlobalResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«BreGlobalResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«BreGlobalResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«BreGlobalResource»::getSize() const
{
    return m_Size;
}


void PageResource«BreGlobalResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«BreGlobalResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«BreGlobalResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«BreGlobalResource»::getSort()
{
    return m_Sort;
}

void PageResource«BreGlobalResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«BreGlobalResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«BreGlobalResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«BreGlobalResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«BreGlobalResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«BreGlobalResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«BreGlobalResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«BreGlobalResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«BreGlobalResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«BreGlobalResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«BreGlobalResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
