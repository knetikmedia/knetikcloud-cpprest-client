...
PageResource«EntitlementItem»::PageResource«EntitlementItem»()
{
...
void PageResource«EntitlementItem»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«EntitlementItem»::toJson() const
{
...
void PageResource«EntitlementItem»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<EntitlementItem>(nullptr) );
            }
            else
            {
                std::shared_ptr<EntitlementItem> newItem(new EntitlementItem());
...
void PageResource«EntitlementItem»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«EntitlementItem»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<EntitlementItem>>& PageResource«EntitlementItem»::getContent()
{
    return m_Content;
}

void PageResource«EntitlementItem»::setContent(std::vector<std::shared_ptr<EntitlementItem>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«EntitlementItem»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«EntitlementItem»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«EntitlementItem»::getFirst() const
{
    return m_First;
}


void PageResource«EntitlementItem»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«EntitlementItem»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«EntitlementItem»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«EntitlementItem»::getLast() const
{
    return m_Last;
}


void PageResource«EntitlementItem»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«EntitlementItem»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«EntitlementItem»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«EntitlementItem»::getNumber() const
{
    return m_number;
}


void PageResource«EntitlementItem»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«EntitlementItem»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«EntitlementItem»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«EntitlementItem»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«EntitlementItem»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«EntitlementItem»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«EntitlementItem»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«EntitlementItem»::getSize() const
{
    return m_Size;
}


void PageResource«EntitlementItem»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«EntitlementItem»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«EntitlementItem»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«EntitlementItem»::getSort()
{
    return m_Sort;
}

void PageResource«EntitlementItem»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«EntitlementItem»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«EntitlementItem»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«EntitlementItem»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«EntitlementItem»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«EntitlementItem»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«EntitlementItem»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«EntitlementItem»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«EntitlementItem»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«EntitlementItem»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«EntitlementItem»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
