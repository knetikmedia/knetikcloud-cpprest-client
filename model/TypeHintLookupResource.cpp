...
utility::string_t TypeHintLookupResource::getDefinition() const
{
    return m_Definition;
}


void TypeHintLookupResource::setDefinition(utility::string_t value)
{
    m_Definition = value;
    m_DefinitionIsSet = true;
}
bool TypeHintLookupResource::definitionIsSet() const
{
    return m_DefinitionIsSet;
}

void TypeHintLookupResource::unsetDefinition()
{
    m_DefinitionIsSet = false;
}
...
utility::string_t TypeHintLookupResource::getRequiredKeyType() const
{
    return m_Required_key_type;
}


void TypeHintLookupResource::setRequiredKeyType(utility::string_t value)
{
    m_Required_key_type = value;
    m_Required_key_typeIsSet = true;
}
bool TypeHintLookupResource::requiredKeyTypeIsSet() const
{
    return m_Required_key_typeIsSet;
}

void TypeHintLookupResource::unsetRequired_key_type()
{
    m_Required_key_typeIsSet = false;
}
