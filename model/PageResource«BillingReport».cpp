...
bool PageResource«BillingReport»::number_of_elementsIsSet() const
{
...
bool PageResource«BillingReport»::total_elementsIsSet() const
{
...
bool PageResource«BillingReport»::total_pagesIsSet() const
{
