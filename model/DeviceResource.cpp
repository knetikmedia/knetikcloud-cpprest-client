...
void DeviceResource::fromJson(web::json::value& val)
{
    ...
    }
    {
        ...
        {  
            ...
            m_Data.insert(std::pair<utility::string_t,utility::string_t>( key, ModelBase::stringFromJson(item[U("value")])));
        }
        }
    }
...
void DeviceResource::setData(std::map<utility::string_t, utility::string_t> value)
{
    m_Data = value;
    m_DataIsSet = true;
}
