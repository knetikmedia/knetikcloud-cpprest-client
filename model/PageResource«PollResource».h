...
/*
 * PageResource«PollResource».h
 *
 * 
 */

#ifndef PageResource«PollResource»_H_
#define PageResource«PollResource»_H_
...
/// 
/// </summary>
class  PageResource«PollResource»
    : public ModelBase
{
public:
    PageResource«PollResource»();
    virtual ~PageResource«PollResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«PollResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<PollResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<PollResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<PollResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«PollResource»_H_ */
