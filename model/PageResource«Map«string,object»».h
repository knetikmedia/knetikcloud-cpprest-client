...
#ifndef PageResource«Map«string,object»»_H_
#define PageResource«Map«string,object»»_H_
...
/// 
/// </summary>
class  PageResource«Map«string,object»»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«Map«string,object»» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<Map«string,object»>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<Map«string,object»>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<Map«string,object»>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«Map«string,object»»_H_ */
