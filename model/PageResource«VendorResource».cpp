...
PageResource«VendorResource»::PageResource«VendorResource»()
{
...
void PageResource«VendorResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«VendorResource»::toJson() const
{
...
void PageResource«VendorResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<VendorResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<VendorResource> newItem(new VendorResource());
...
void PageResource«VendorResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«VendorResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<VendorResource>>& PageResource«VendorResource»::getContent()
{
    return m_Content;
}

void PageResource«VendorResource»::setContent(std::vector<std::shared_ptr<VendorResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«VendorResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«VendorResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«VendorResource»::getFirst() const
{
    return m_First;
}


void PageResource«VendorResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«VendorResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«VendorResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«VendorResource»::getLast() const
{
    return m_Last;
}


void PageResource«VendorResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«VendorResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«VendorResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«VendorResource»::getNumber() const
{
    return m_number;
}


void PageResource«VendorResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«VendorResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«VendorResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«VendorResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«VendorResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«VendorResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«VendorResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«VendorResource»::getSize() const
{
    return m_Size;
}


void PageResource«VendorResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«VendorResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«VendorResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«VendorResource»::getSort()
{
    return m_Sort;
}

void PageResource«VendorResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«VendorResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«VendorResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«VendorResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«VendorResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«VendorResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«VendorResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«VendorResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«VendorResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«VendorResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«VendorResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
