...
/*
 * PageResource«CatalogSale».h
 *
 * 
 */

#ifndef PageResource«CatalogSale»_H_
#define PageResource«CatalogSale»_H_
...
/// 
/// </summary>
class  PageResource«CatalogSale»
    : public ModelBase
{
public:
    PageResource«CatalogSale»();
    virtual ~PageResource«CatalogSale»();
    ...
    /////////////////////////////////////////////
    /// PageResource«CatalogSale» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CatalogSale>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<CatalogSale>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<CatalogSale>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«CatalogSale»_H_ */
