...
void ChallengeResource::setAdditionalProperties(std::map<utility::string_t, std::shared_ptr<Property>> value)
{
    m_Additional_properties = value;
    m_Additional_propertiesIsSet = true;
}
bool ChallengeResource::additionalPropertiesIsSet() const
{
...
bool ChallengeResource::campaignIdIsSet() const
{
...
bool ChallengeResource::copyOfIsSet() const
{
...
bool ChallengeResource::createdDateIsSet() const
{
...
bool ChallengeResource::endDateIsSet() const
{
...
bool ChallengeResource::leaderboardStrategyIsSet() const
{
...
bool ChallengeResource::longDescriptionIsSet() const
{
...
bool ChallengeResource::nextEventDateIsSet() const
{
...
bool ChallengeResource::rewardLagMinutesIsSet() const
{
...
bool ChallengeResource::rewardSetIsSet() const
{
...
bool ChallengeResource::shortDescriptionIsSet() const
{
...
bool ChallengeResource::startDateIsSet() const
{
...
bool ChallengeResource::updatedDateIsSet() const
{
