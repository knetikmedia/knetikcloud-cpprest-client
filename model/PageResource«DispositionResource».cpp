...
PageResource«DispositionResource»::PageResource«DispositionResource»()
{
...
void PageResource«DispositionResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«DispositionResource»::toJson() const
{
...
void PageResource«DispositionResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<DispositionResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<DispositionResource> newItem(new DispositionResource());
...
void PageResource«DispositionResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«DispositionResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<DispositionResource>>& PageResource«DispositionResource»::getContent()
{
    return m_Content;
}

void PageResource«DispositionResource»::setContent(std::vector<std::shared_ptr<DispositionResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«DispositionResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«DispositionResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«DispositionResource»::getFirst() const
{
    return m_First;
}


void PageResource«DispositionResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«DispositionResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«DispositionResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«DispositionResource»::getLast() const
{
    return m_Last;
}


void PageResource«DispositionResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«DispositionResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«DispositionResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«DispositionResource»::getNumber() const
{
    return m_number;
}


void PageResource«DispositionResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«DispositionResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«DispositionResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«DispositionResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«DispositionResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«DispositionResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«DispositionResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«DispositionResource»::getSize() const
{
    return m_Size;
}


void PageResource«DispositionResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«DispositionResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«DispositionResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«DispositionResource»::getSort()
{
    return m_Sort;
}

void PageResource«DispositionResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«DispositionResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«DispositionResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«DispositionResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«DispositionResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«DispositionResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«DispositionResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«DispositionResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«DispositionResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«DispositionResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«DispositionResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
