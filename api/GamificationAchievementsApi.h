...
public:
    ...
    pplx::task<std::shared_ptr<UserAchievementGroupResource>> incrementAchievementProgress(int32_t userId, utility::string_t achievementName, int32_t progress);
    /// <summary>
    ...
    pplx::task<std::shared_ptr<UserAchievementGroupResource>> setAchievementProgress(int32_t userId, utility::string_t achievementName, int32_t progress);
    /// <summary>
