...
PageResource«BreRule»::PageResource«BreRule»()
{
...
void PageResource«BreRule»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«BreRule»::toJson() const
{
...
void PageResource«BreRule»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<BreRule>(nullptr) );
            }
            else
            {
                std::shared_ptr<BreRule> newItem(new BreRule());
...
void PageResource«BreRule»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«BreRule»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<BreRule>>& PageResource«BreRule»::getContent()
{
    return m_Content;
}

void PageResource«BreRule»::setContent(std::vector<std::shared_ptr<BreRule>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«BreRule»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«BreRule»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«BreRule»::getFirst() const
{
    return m_First;
}


void PageResource«BreRule»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«BreRule»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«BreRule»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«BreRule»::getLast() const
{
    return m_Last;
}


void PageResource«BreRule»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«BreRule»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«BreRule»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«BreRule»::getNumber() const
{
    return m_number;
}


void PageResource«BreRule»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«BreRule»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«BreRule»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«BreRule»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«BreRule»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«BreRule»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«BreRule»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«BreRule»::getSize() const
{
    return m_Size;
}


void PageResource«BreRule»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«BreRule»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«BreRule»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«BreRule»::getSort()
{
    return m_Sort;
}

void PageResource«BreRule»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«BreRule»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«BreRule»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«BreRule»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«BreRule»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«BreRule»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«BreRule»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«BreRule»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«BreRule»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«BreRule»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«BreRule»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
