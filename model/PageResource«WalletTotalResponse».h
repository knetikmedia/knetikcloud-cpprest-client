...
/*
 * PageResource«WalletTotalResponse».h
 *
 * 
 */

#ifndef PageResource«WalletTotalResponse»_H_
#define PageResource«WalletTotalResponse»_H_
...
/// 
/// </summary>
class  PageResource«WalletTotalResponse»
    : public ModelBase
{
public:
    PageResource«WalletTotalResponse»();
    virtual ~PageResource«WalletTotalResponse»();
    ...
    /////////////////////////////////////////////
    /// PageResource«WalletTotalResponse» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<WalletTotalResponse>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<WalletTotalResponse>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<WalletTotalResponse>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«WalletTotalResponse»_H_ */
