...
void LookupResource::validate()
{
    // TODO: implement validation
}

web::json::value LookupResource::toJson() const
{
...
void LookupResource::fromJson(web::json::value& val)
{
...
void LookupResource::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void LookupResource::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
utility::string_t LookupResource::getDefinition() const
{
    return m_Definition;
}


void LookupResource::setDefinition(utility::string_t value)
{
    m_Definition = value;
    m_DefinitionIsSet = true;
}
bool LookupResource::definitionIsSet() const
{
    return m_DefinitionIsSet;
}

void LookupResource::unsetDefinition()
{
    m_DefinitionIsSet = false;
}

std::shared_ptr<ExpressionResource> LookupResource::getLookupKey() const
{
    return m_Lookup_key;
}


void LookupResource::setLookupKey(std::shared_ptr<ExpressionResource> value)
{
    m_Lookup_key = value;
    m_Lookup_keyIsSet = true;
}
bool LookupResource::lookupKeyIsSet() const
{
    return m_Lookup_keyIsSet;
}

void LookupResource::unsetLookup_key()
{
    m_Lookup_keyIsSet = false;
}

utility::string_t LookupResource::getRequiredKeyType() const
{
    return m_Required_key_type;
}


void LookupResource::setRequiredKeyType(utility::string_t value)
{
    m_Required_key_type = value;
    m_Required_key_typeIsSet = true;
}
bool LookupResource::requiredKeyTypeIsSet() const
{
    return m_Required_key_typeIsSet;
}

void LookupResource::unsetRequired_key_type()
{
    m_Required_key_typeIsSet = false;
}

utility::string_t LookupResource::getType() const
{
    return m_Type;
}


void LookupResource::setType(utility::string_t value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
bool LookupResource::typeIsSet() const
{
    return m_TypeIsSet;
}

void LookupResource::unsetType()
{
    m_TypeIsSet = false;
}

utility::string_t LookupResource::getValueType() const
{
    return m_Value_type;
}


void LookupResource::setValueType(utility::string_t value)
{
    m_Value_type = value;
    m_Value_typeIsSet = true;
}
bool LookupResource::valueTypeIsSet() const
{
    return m_Value_typeIsSet;
}

void LookupResource::unsetValue_type()
{
    m_Value_typeIsSet = false;
}
