...
PageResource«RoleResource»::PageResource«RoleResource»()
{
...
void PageResource«RoleResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«RoleResource»::toJson() const
{
...
void PageResource«RoleResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<RoleResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<RoleResource> newItem(new RoleResource());
...
void PageResource«RoleResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«RoleResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<RoleResource>>& PageResource«RoleResource»::getContent()
{
    return m_Content;
}

void PageResource«RoleResource»::setContent(std::vector<std::shared_ptr<RoleResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«RoleResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«RoleResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«RoleResource»::getFirst() const
{
    return m_First;
}


void PageResource«RoleResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«RoleResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«RoleResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«RoleResource»::getLast() const
{
    return m_Last;
}


void PageResource«RoleResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«RoleResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«RoleResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«RoleResource»::getNumber() const
{
    return m_number;
}


void PageResource«RoleResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«RoleResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«RoleResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«RoleResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«RoleResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«RoleResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«RoleResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«RoleResource»::getSize() const
{
    return m_Size;
}


void PageResource«RoleResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«RoleResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«RoleResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«RoleResource»::getSort()
{
    return m_Sort;
}

void PageResource«RoleResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«RoleResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«RoleResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«RoleResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«RoleResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«RoleResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«RoleResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«RoleResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«RoleResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«RoleResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«RoleResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
