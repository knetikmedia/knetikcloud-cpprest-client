...
public:
    ...
    /// </remarks>
    /// <param name="limit">The amount of items returned (optional)</param>/// <param name="page">The page of the request (optional)</param>/// <param name="useCatalog">Whether to remove items that are not intended for display or not in date (optional)</param>/// <param name="ignoreLocation">Whether to ignore country restrictions based on the caller&#39;s location (optional)</param>/// <param name="inStockOnly">Whether only in-stock items should be returned.  Default value is false (optional, default to false)</param>
    pplx::task<std::shared_ptr<PageResource«StoreItem»>> getStore(int32_t limit, int32_t page, bool useCatalog, bool ignoreLocation, bool inStockOnly);
    /// <summary>
