...
/*
 * PageResource«AchievementDefinitionResource».h
 *
 * 
 */

#ifndef PageResource«AchievementDefinitionResource»_H_
#define PageResource«AchievementDefinitionResource»_H_
...
/// 
/// </summary>
class  PageResource«AchievementDefinitionResource»
    : public ModelBase
{
public:
    PageResource«AchievementDefinitionResource»();
    virtual ~PageResource«AchievementDefinitionResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«AchievementDefinitionResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AchievementDefinitionResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<AchievementDefinitionResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<AchievementDefinitionResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«AchievementDefinitionResource»_H_ */
