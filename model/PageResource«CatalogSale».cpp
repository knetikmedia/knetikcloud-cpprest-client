...
bool PageResource«CatalogSale»::number_of_elementsIsSet() const
{
...
bool PageResource«CatalogSale»::total_elementsIsSet() const
{
...
bool PageResource«CatalogSale»::total_pagesIsSet() const
{
