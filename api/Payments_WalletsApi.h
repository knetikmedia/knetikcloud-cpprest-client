...
/*
 * Payments_WalletsApi.h
 *
 * 
 */

#ifndef Payments_WalletsApi_H_
#define Payments_WalletsApi_H_
...
{
public:
    Payments_WalletsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Payments_WalletsApi();
    /// <summary>
