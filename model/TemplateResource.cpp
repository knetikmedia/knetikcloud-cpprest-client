...
bool TemplateResource::getAllowAdditional() const
{
    return m_Allow_additional;
}


void TemplateResource::setAllowAdditional(bool value)
{
    m_Allow_additional = value;
    m_Allow_additionalIsSet = true;
}
bool TemplateResource::allowAdditionalIsSet() const
{
    return m_Allow_additionalIsSet;
}

void TemplateResource::unsetAllow_additional()
{
    m_Allow_additionalIsSet = false;
}
