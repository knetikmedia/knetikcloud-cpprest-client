...
/*
 * Users_SubscriptionsApi.h
 *
 * 
 */

#ifndef Users_SubscriptionsApi_H_
#define Users_SubscriptionsApi_H_
...
{
public:
    Users_SubscriptionsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Users_SubscriptionsApi();
    /// <summary>
    ...
    /// </remarks>
    /// <param name="userId">The id of the user</param>/// <param name="inventoryId">The id of the user&#39;s inventory</param>/// <param name="status">The new status for the subscription</param>
    pplx::task<void> setSubscriptionStatus(int32_t userId, int32_t inventoryId, std::shared_ptr<SubscriptionStatusWrapper> status);
    /// <summary>
...
#endif /* Users_SubscriptionsApi_H_ */
