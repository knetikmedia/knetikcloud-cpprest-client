...
PageResource«BareChallengeActivityResource»::PageResource«BareChallengeActivityResource»()
{
...
void PageResource«BareChallengeActivityResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«BareChallengeActivityResource»::toJson() const
{
...
void PageResource«BareChallengeActivityResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<BareChallengeActivityResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<BareChallengeActivityResource> newItem(new BareChallengeActivityResource());
...
void PageResource«BareChallengeActivityResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«BareChallengeActivityResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<BareChallengeActivityResource>>& PageResource«BareChallengeActivityResource»::getContent()
{
    return m_Content;
}

void PageResource«BareChallengeActivityResource»::setContent(std::vector<std::shared_ptr<BareChallengeActivityResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«BareChallengeActivityResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«BareChallengeActivityResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«BareChallengeActivityResource»::getFirst() const
{
    return m_First;
}


void PageResource«BareChallengeActivityResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«BareChallengeActivityResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«BareChallengeActivityResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«BareChallengeActivityResource»::getLast() const
{
    return m_Last;
}


void PageResource«BareChallengeActivityResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«BareChallengeActivityResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«BareChallengeActivityResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«BareChallengeActivityResource»::getNumber() const
{
    return m_number;
}


void PageResource«BareChallengeActivityResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«BareChallengeActivityResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«BareChallengeActivityResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«BareChallengeActivityResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«BareChallengeActivityResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«BareChallengeActivityResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«BareChallengeActivityResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«BareChallengeActivityResource»::getSize() const
{
    return m_Size;
}


void PageResource«BareChallengeActivityResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«BareChallengeActivityResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«BareChallengeActivityResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«BareChallengeActivityResource»::getSort()
{
    return m_Sort;
}

void PageResource«BareChallengeActivityResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«BareChallengeActivityResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«BareChallengeActivityResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«BareChallengeActivityResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«BareChallengeActivityResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«BareChallengeActivityResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«BareChallengeActivityResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«BareChallengeActivityResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«BareChallengeActivityResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«BareChallengeActivityResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«BareChallengeActivityResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
