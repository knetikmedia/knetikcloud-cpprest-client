...
PageResource«ChallengeResource»::PageResource«ChallengeResource»()
{
...
void PageResource«ChallengeResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«ChallengeResource»::toJson() const
{
...
void PageResource«ChallengeResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<ChallengeResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<ChallengeResource> newItem(new ChallengeResource());
...
void PageResource«ChallengeResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«ChallengeResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<ChallengeResource>>& PageResource«ChallengeResource»::getContent()
{
    return m_Content;
}

void PageResource«ChallengeResource»::setContent(std::vector<std::shared_ptr<ChallengeResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«ChallengeResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«ChallengeResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«ChallengeResource»::getFirst() const
{
    return m_First;
}


void PageResource«ChallengeResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«ChallengeResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«ChallengeResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«ChallengeResource»::getLast() const
{
    return m_Last;
}


void PageResource«ChallengeResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«ChallengeResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«ChallengeResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«ChallengeResource»::getNumber() const
{
    return m_number;
}


void PageResource«ChallengeResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«ChallengeResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«ChallengeResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«ChallengeResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«ChallengeResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«ChallengeResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«ChallengeResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«ChallengeResource»::getSize() const
{
    return m_Size;
}


void PageResource«ChallengeResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«ChallengeResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«ChallengeResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«ChallengeResource»::getSort()
{
    return m_Sort;
}

void PageResource«ChallengeResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«ChallengeResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«ChallengeResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«ChallengeResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«ChallengeResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«ChallengeResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«ChallengeResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«ChallengeResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«ChallengeResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«ChallengeResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«ChallengeResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
