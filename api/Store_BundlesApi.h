...
#ifndef Store_BundlesApi_H_
#define Store_BundlesApi_H_
...
{
public:
    Store_BundlesApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Store_BundlesApi();
    /// <summary>
