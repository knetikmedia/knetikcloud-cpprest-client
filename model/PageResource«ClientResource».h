...
/*
 * PageResource«ClientResource».h
 *
 * 
 */

#ifndef PageResource«ClientResource»_H_
#define PageResource«ClientResource»_H_
...
/// 
/// </summary>
class  PageResource«ClientResource»
    : public ModelBase
{
public:
    PageResource«ClientResource»();
    virtual ~PageResource«ClientResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«ClientResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ClientResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ClientResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ClientResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ClientResource»_H_ */
