...
void QuestionResource::setAdditionalProperties(std::map<utility::string_t, std::shared_ptr<Property>> value)
{
    m_Additional_properties = value;
    m_Additional_propertiesIsSet = true;
}
bool QuestionResource::additionalPropertiesIsSet() const
{
...
void QuestionResource::setAnswers(std::vector<std::shared_ptr<AnswerResource>> value)
{
    m_Answers = value;
    m_AnswersIsSet = true;
}
...
bool QuestionResource::createdDateIsSet() const
{
...
bool QuestionResource::importIdIsSet() const
{
...
bool QuestionResource::publishedDateIsSet() const
{
...
void QuestionResource::setTags(std::vector<utility::string_t> value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}
...
bool QuestionResource::updatedDateIsSet() const
{
