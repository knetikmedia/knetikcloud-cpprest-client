...
PageResource«NotificationTypeResource»::PageResource«NotificationTypeResource»()
{
...
void PageResource«NotificationTypeResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«NotificationTypeResource»::toJson() const
{
...
void PageResource«NotificationTypeResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<NotificationTypeResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<NotificationTypeResource> newItem(new NotificationTypeResource());
...
void PageResource«NotificationTypeResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«NotificationTypeResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<NotificationTypeResource>>& PageResource«NotificationTypeResource»::getContent()
{
    return m_Content;
}

void PageResource«NotificationTypeResource»::setContent(std::vector<std::shared_ptr<NotificationTypeResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«NotificationTypeResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«NotificationTypeResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«NotificationTypeResource»::getFirst() const
{
    return m_First;
}


void PageResource«NotificationTypeResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«NotificationTypeResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«NotificationTypeResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«NotificationTypeResource»::getLast() const
{
    return m_Last;
}


void PageResource«NotificationTypeResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«NotificationTypeResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«NotificationTypeResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«NotificationTypeResource»::getNumber() const
{
    return m_number;
}


void PageResource«NotificationTypeResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«NotificationTypeResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«NotificationTypeResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«NotificationTypeResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«NotificationTypeResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«NotificationTypeResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«NotificationTypeResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«NotificationTypeResource»::getSize() const
{
    return m_Size;
}


void PageResource«NotificationTypeResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«NotificationTypeResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«NotificationTypeResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«NotificationTypeResource»::getSort()
{
    return m_Sort;
}

void PageResource«NotificationTypeResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«NotificationTypeResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«NotificationTypeResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«NotificationTypeResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«NotificationTypeResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«NotificationTypeResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«NotificationTypeResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«NotificationTypeResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«NotificationTypeResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«NotificationTypeResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«NotificationTypeResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
