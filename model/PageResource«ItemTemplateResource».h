...
/*
 * PageResource«ItemTemplateResource».h
 *
 * 
 */

#ifndef PageResource«ItemTemplateResource»_H_
#define PageResource«ItemTemplateResource»_H_
...
/// 
/// </summary>
class  PageResource«ItemTemplateResource»
    : public ModelBase
{
public:
    PageResource«ItemTemplateResource»();
    virtual ~PageResource«ItemTemplateResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«ItemTemplateResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ItemTemplateResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ItemTemplateResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ItemTemplateResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ItemTemplateResource»_H_ */
