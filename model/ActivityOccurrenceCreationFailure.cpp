...
void ActivityOccurrenceCreationFailure::setUserResults(std::vector<std::shared_ptr<ActivityOccurrenceJoinResult>> value)
{
    m_User_results = value;
    m_User_resultsIsSet = true;
}
bool ActivityOccurrenceCreationFailure::userResultsIsSet() const
{
