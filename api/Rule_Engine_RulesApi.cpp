...
#include "Rule_Engine_RulesApi.h"
#include "IHttpBody.h"
#include "JsonBody.h"
...
Rule_Engine_RulesApi::Rule_Engine_RulesApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<BreRule>> Rule_Engine_RulesApi::createBRERule(std::shared_ptr<BreRule> breRule)
{
    ...
    {
        throw ApiException(400, U("Rule_Engine_RulesApi->createBRERule does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Rule_Engine_RulesApi->createBRERule does not consume any supported media type"));
    }
...
pplx::task<void> Rule_Engine_RulesApi::deleteBRERule(utility::string_t id)
{
    ...
    {
        throw ApiException(400, U("Rule_Engine_RulesApi->deleteBRERule does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Rule_Engine_RulesApi->deleteBRERule does not consume any supported media type"));
    }
...
pplx::task<utility::string_t> Rule_Engine_RulesApi::getBREExpressionAsString(std::shared_ptr<Expression«object»> expression)
{
    ...
    {
        throw ApiException(400, U("Rule_Engine_RulesApi->getBREExpressionAsString does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Rule_Engine_RulesApi->getBREExpressionAsString does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<BreRule>> Rule_Engine_RulesApi::getBRERule(utility::string_t id)
{
    ...
    {
        throw ApiException(400, U("Rule_Engine_RulesApi->getBRERule does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Rule_Engine_RulesApi->getBRERule does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<PageResource«BreRule»>> Rule_Engine_RulesApi::getBRERules(utility::string_t filterName, bool filterEnabled, bool filterSystem, utility::string_t filterTrigger, utility::string_t filterAction, utility::string_t filterCondition, int32_t size, int32_t page)
{
    ...
    {
        throw ApiException(400, U("Rule_Engine_RulesApi->getBRERules does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Rule_Engine_RulesApi->getBRERules does not consume any supported media type"));
    }
...
pplx::task<void> Rule_Engine_RulesApi::setBRERule(utility::string_t id, std::shared_ptr<BooleanResource> enabled)
{
    ...
    {
        throw ApiException(400, U("Rule_Engine_RulesApi->setBRERule does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Rule_Engine_RulesApi->setBRERule does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<BreRule>> Rule_Engine_RulesApi::updateBRERule(utility::string_t id, std::shared_ptr<BreRule> breRule)
{
    ...
    {
        throw ApiException(400, U("Rule_Engine_RulesApi->updateBRERule does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Rule_Engine_RulesApi->updateBRERule does not consume any supported media type"));
    }
