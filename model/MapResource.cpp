...
utility::string_t MapResource::getDefinition() const
{
    return m_Definition;
}


void MapResource::setDefinition(utility::string_t value)
{
    m_Definition = value;
    m_DefinitionIsSet = true;
}
bool MapResource::definitionIsSet() const
{
    return m_DefinitionIsSet;
}

void MapResource::unsetDefinition()
{
    m_DefinitionIsSet = false;
}
