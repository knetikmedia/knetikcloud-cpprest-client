...
void PageResource«UserItemLogResource»::setContent(std::vector<std::shared_ptr<UserItemLogResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
bool PageResource«UserItemLogResource»::numberOfElementsIsSet() const
{
...
void PageResource«UserItemLogResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
...
bool PageResource«UserItemLogResource»::totalElementsIsSet() const
{
...
bool PageResource«UserItemLogResource»::totalPagesIsSet() const
{
