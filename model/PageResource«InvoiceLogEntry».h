...
/*
 * PageResource«InvoiceLogEntry».h
 *
 * 
 */

#ifndef PageResource«InvoiceLogEntry»_H_
#define PageResource«InvoiceLogEntry»_H_
...
/// 
/// </summary>
class  PageResource«InvoiceLogEntry»
    : public ModelBase
{
public:
    PageResource«InvoiceLogEntry»();
    virtual ~PageResource«InvoiceLogEntry»();
    ...
    /////////////////////////////////////////////
    /// PageResource«InvoiceLogEntry» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<InvoiceLogEntry>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<InvoiceLogEntry>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<InvoiceLogEntry>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«InvoiceLogEntry»_H_ */
