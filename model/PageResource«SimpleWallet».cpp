...
PageResource«SimpleWallet»::PageResource«SimpleWallet»()
{
...
void PageResource«SimpleWallet»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«SimpleWallet»::toJson() const
{
...
void PageResource«SimpleWallet»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<SimpleWallet>(nullptr) );
            }
            else
            {
                std::shared_ptr<SimpleWallet> newItem(new SimpleWallet());
...
void PageResource«SimpleWallet»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«SimpleWallet»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<SimpleWallet>>& PageResource«SimpleWallet»::getContent()
{
    return m_Content;
}

void PageResource«SimpleWallet»::setContent(std::vector<std::shared_ptr<SimpleWallet>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«SimpleWallet»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«SimpleWallet»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«SimpleWallet»::getFirst() const
{
    return m_First;
}


void PageResource«SimpleWallet»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«SimpleWallet»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«SimpleWallet»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«SimpleWallet»::getLast() const
{
    return m_Last;
}


void PageResource«SimpleWallet»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«SimpleWallet»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«SimpleWallet»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«SimpleWallet»::getNumber() const
{
    return m_number;
}


void PageResource«SimpleWallet»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«SimpleWallet»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«SimpleWallet»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«SimpleWallet»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«SimpleWallet»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«SimpleWallet»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«SimpleWallet»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«SimpleWallet»::getSize() const
{
    return m_Size;
}


void PageResource«SimpleWallet»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«SimpleWallet»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«SimpleWallet»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«SimpleWallet»::getSort()
{
    return m_Sort;
}

void PageResource«SimpleWallet»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«SimpleWallet»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«SimpleWallet»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«SimpleWallet»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«SimpleWallet»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«SimpleWallet»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«SimpleWallet»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«SimpleWallet»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«SimpleWallet»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«SimpleWallet»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«SimpleWallet»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
