...
SocialFacebookApi::SocialFacebookApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<void> SocialFacebookApi::linkAccounts(std::shared_ptr<FacebookToken> facebookToken)
{
    ...
    {
        throw ApiException(400, U("SocialFacebookApi->linkAccounts does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("SocialFacebookApi->linkAccounts does not consume any supported media type"));
    }
