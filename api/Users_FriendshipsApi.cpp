...
#include "Users_FriendshipsApi.h"
#include "IHttpBody.h"
#include "JsonBody.h"
...
Users_FriendshipsApi::Users_FriendshipsApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<void> Users_FriendshipsApi::addFriend(utility::string_t userId, int32_t id)
{
...
boost::replace_all(path, U("{") U("id") U("}"), ApiClient::parameterToString(id));
    ...
    {
        throw ApiException(400, U("Users_FriendshipsApi->addFriend does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Users_FriendshipsApi->addFriend does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<PageResource«SimpleUserResource»>> Users_FriendshipsApi::getFriends(utility::string_t userId, utility::string_t filterUsername, int32_t filterUserId, int32_t size, int32_t page)
{
    ...
    {
        throw ApiException(400, U("Users_FriendshipsApi->getFriends does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Users_FriendshipsApi->getFriends does not consume any supported media type"));
    }
...
pplx::task<utility::string_t> Users_FriendshipsApi::getInviteToken(utility::string_t userId)
{
    ...
    {
        throw ApiException(400, U("Users_FriendshipsApi->getInviteToken does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Users_FriendshipsApi->getInviteToken does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<PageResource«SimpleUserResource»>> Users_FriendshipsApi::getInvites(utility::string_t userId, int32_t size, int32_t page)
{
    ...
    {
        throw ApiException(400, U("Users_FriendshipsApi->getInvites does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Users_FriendshipsApi->getInvites does not consume any supported media type"));
    }
...
pplx::task<void> Users_FriendshipsApi::redeemFriendshipToken(utility::string_t userId, std::shared_ptr<StringWrapper> token)
{
    ...
    {
        throw ApiException(400, U("Users_FriendshipsApi->redeemFriendshipToken does not produce any supported media type"));
    }
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        std::shared_ptr<MultipartFormData> multipart(new MultipartFormData);
                if(token.get())
        {
            token->toMultipart(multipart, U("token"));
        }
    ...
    {
        throw ApiException(415, U("Users_FriendshipsApi->redeemFriendshipToken does not consume any supported media type"));
    }
...
pplx::task<void> Users_FriendshipsApi::removeOrDeclineFriend(utility::string_t userId, int32_t id)
{
...
boost::replace_all(path, U("{") U("id") U("}"), ApiClient::parameterToString(id));
    ...
    {
        throw ApiException(400, U("Users_FriendshipsApi->removeOrDeclineFriend does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("Users_FriendshipsApi->removeOrDeclineFriend does not consume any supported media type"));
    }
