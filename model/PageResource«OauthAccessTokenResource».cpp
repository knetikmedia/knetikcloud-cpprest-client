...
void PageResource«OauthAccessTokenResource»::setContent(std::vector<std::shared_ptr<OauthAccessTokenResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
bool PageResource«OauthAccessTokenResource»::numberOfElementsIsSet() const
{
...
void PageResource«OauthAccessTokenResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
...
bool PageResource«OauthAccessTokenResource»::totalElementsIsSet() const
{
...
bool PageResource«OauthAccessTokenResource»::totalPagesIsSet() const
{
