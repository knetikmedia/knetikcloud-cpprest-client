...
{
    {
        ...
        for( auto& item : val[U("actions")].as_array() )
        {
            if(item.is_null())
            {
                m_Actions.push_back( std::shared_ptr<ActionContext«object»>(nullptr) );
            }
            else
            {
                std::shared_ptr<ActionContext«object»> newItem(new ActionContext«object»());
    ...
    if(val.has_field(U("condition")))
    {
        ...
        {
            std::shared_ptr<PredicateResource> newItem(new PredicateResource());
...
std::vector<std::shared_ptr<ActionContext«object»>>& BreRule::getActions()
{
    return m_Actions;
}

void BreRule::setActions(std::vector<std::shared_ptr<ActionContext«object»>> value)
{
    m_Actions = value;
    
}
std::shared_ptr<PredicateResource> BreRule::getCondition() const
{
    return m_Condition;
}


void BreRule::setCondition(std::shared_ptr<PredicateResource> value)
{
    m_Condition = value;
...
bool BreRule::conditionTextIsSet() const
{
...
bool BreRule::endDateIsSet() const
{
...
bool BreRule::startDateIsSet() const
{
...
bool BreRule::systemRuleIsSet() const
{
