...
void PageResource«CampaignResource»::setContent(std::vector<std::shared_ptr<CampaignResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
...
bool PageResource«CampaignResource»::numberOfElementsIsSet() const
{
...
void PageResource«CampaignResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
...
bool PageResource«CampaignResource»::totalElementsIsSet() const
{
...
bool PageResource«CampaignResource»::totalPagesIsSet() const
{
