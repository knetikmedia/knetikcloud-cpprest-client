...
PageResource«CartSummary»::PageResource«CartSummary»()
{
...
void PageResource«CartSummary»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«CartSummary»::toJson() const
{
...
void PageResource«CartSummary»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<CartSummary>(nullptr) );
            }
            else
            {
                std::shared_ptr<CartSummary> newItem(new CartSummary());
...
void PageResource«CartSummary»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«CartSummary»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<CartSummary>>& PageResource«CartSummary»::getContent()
{
    return m_Content;
}

void PageResource«CartSummary»::setContent(std::vector<std::shared_ptr<CartSummary>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«CartSummary»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«CartSummary»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«CartSummary»::getFirst() const
{
    return m_First;
}


void PageResource«CartSummary»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«CartSummary»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«CartSummary»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«CartSummary»::getLast() const
{
    return m_Last;
}


void PageResource«CartSummary»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«CartSummary»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«CartSummary»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«CartSummary»::getNumber() const
{
    return m_number;
}


void PageResource«CartSummary»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«CartSummary»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«CartSummary»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«CartSummary»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«CartSummary»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«CartSummary»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«CartSummary»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«CartSummary»::getSize() const
{
    return m_Size;
}


void PageResource«CartSummary»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«CartSummary»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«CartSummary»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«CartSummary»::getSort()
{
    return m_Sort;
}

void PageResource«CartSummary»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«CartSummary»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«CartSummary»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«CartSummary»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«CartSummary»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«CartSummary»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«CartSummary»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«CartSummary»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«CartSummary»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«CartSummary»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«CartSummary»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
