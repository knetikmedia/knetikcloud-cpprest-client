...
bool PageResource«BreEventLog»::number_of_elementsIsSet() const
{
...
bool PageResource«BreEventLog»::total_elementsIsSet() const
{
...
bool PageResource«BreEventLog»::total_pagesIsSet() const
{
