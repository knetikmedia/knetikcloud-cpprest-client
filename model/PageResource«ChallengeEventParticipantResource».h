...
/*
 * PageResource«ChallengeEventParticipantResource».h
 *
 * 
 */

#ifndef PageResource«ChallengeEventParticipantResource»_H_
#define PageResource«ChallengeEventParticipantResource»_H_
...
/// 
/// </summary>
class  PageResource«ChallengeEventParticipantResource»
    : public ModelBase
{
public:
    PageResource«ChallengeEventParticipantResource»();
    virtual ~PageResource«ChallengeEventParticipantResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«ChallengeEventParticipantResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ChallengeEventParticipantResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ChallengeEventParticipantResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ChallengeEventParticipantResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ChallengeEventParticipantResource»_H_ */
