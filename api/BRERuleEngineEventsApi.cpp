...
#include "BRERuleEngineEventsApi.h"
#include "IHttpBody.h"
#include "JsonBody.h"
...
BRERuleEngineEventsApi::BRERuleEngineEventsApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<utility::string_t> BRERuleEngineEventsApi::sendBREEvent(std::shared_ptr<BreEvent> breEvent)
{
    ...
    {
        throw ApiException(400, U("BRERuleEngineEventsApi->sendBREEvent does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("BRERuleEngineEventsApi->sendBREEvent does not consume any supported media type"));
    }
