...
PageResource«BreTriggerResource»::PageResource«BreTriggerResource»()
{
...
void PageResource«BreTriggerResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«BreTriggerResource»::toJson() const
{
...
void PageResource«BreTriggerResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<BreTriggerResource>(nullptr) );
            }
            else
            {
...
void PageResource«BreTriggerResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«BreTriggerResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<BreTriggerResource>>& PageResource«BreTriggerResource»::getContent()
{
    return m_Content;
}

void PageResource«BreTriggerResource»::setContent(std::vector<std::shared_ptr<BreTriggerResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«BreTriggerResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«BreTriggerResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«BreTriggerResource»::getFirst() const
{
    return m_First;
}


void PageResource«BreTriggerResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«BreTriggerResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«BreTriggerResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«BreTriggerResource»::getLast() const
{
    return m_Last;
}


void PageResource«BreTriggerResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«BreTriggerResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«BreTriggerResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«BreTriggerResource»::getNumber() const
{
    return m_number;
}


void PageResource«BreTriggerResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«BreTriggerResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«BreTriggerResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«BreTriggerResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«BreTriggerResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«BreTriggerResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«BreTriggerResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«BreTriggerResource»::getSize() const
{
    return m_Size;
}


void PageResource«BreTriggerResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«BreTriggerResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«BreTriggerResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«BreTriggerResource»::getSort()
{
    return m_Sort;
}

void PageResource«BreTriggerResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«BreTriggerResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«BreTriggerResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«BreTriggerResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«BreTriggerResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«BreTriggerResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«BreTriggerResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«BreTriggerResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«BreTriggerResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«BreTriggerResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«BreTriggerResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
