...
/*
 * PageResource«SubscriptionTemplateResource».h
 *
 * 
 */

#ifndef PageResource«SubscriptionTemplateResource»_H_
#define PageResource«SubscriptionTemplateResource»_H_
...
/// 
/// </summary>
class  PageResource«SubscriptionTemplateResource»
    : public ModelBase
{
public:
    PageResource«SubscriptionTemplateResource»();
    virtual ~PageResource«SubscriptionTemplateResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«SubscriptionTemplateResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SubscriptionTemplateResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<SubscriptionTemplateResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<SubscriptionTemplateResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«SubscriptionTemplateResource»_H_ */
