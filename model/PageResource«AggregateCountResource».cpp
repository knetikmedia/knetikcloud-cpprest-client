...
bool PageResource«AggregateCountResource»::number_of_elementsIsSet() const
{
...
bool PageResource«AggregateCountResource»::total_elementsIsSet() const
{
...
bool PageResource«AggregateCountResource»::total_pagesIsSet() const
{
