...
/*
 * PageResource«PaymentMethodTypeResource».h
 *
 * 
 */

#ifndef PageResource«PaymentMethodTypeResource»_H_
#define PageResource«PaymentMethodTypeResource»_H_
...
/// 
/// </summary>
class  PageResource«PaymentMethodTypeResource»
    : public ModelBase
{
public:
    PageResource«PaymentMethodTypeResource»();
    virtual ~PageResource«PaymentMethodTypeResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«PaymentMethodTypeResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<PaymentMethodTypeResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<PaymentMethodTypeResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<PaymentMethodTypeResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«PaymentMethodTypeResource»_H_ */
