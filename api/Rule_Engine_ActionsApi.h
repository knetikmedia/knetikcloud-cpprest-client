...
/*
 * Rule_Engine_ActionsApi.h
 *
 * 
 */

#ifndef Rule_Engine_ActionsApi_H_
#define Rule_Engine_ActionsApi_H_
...
class  Rule_Engine_ActionsApi
{
public:
    Rule_Engine_ActionsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Rule_Engine_ActionsApi();
    /// <summary>
...
#endif /* Rule_Engine_ActionsApi_H_ */
