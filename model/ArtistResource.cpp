...
void ArtistResource::setAdditionalProperties(std::map<utility::string_t, std::shared_ptr<Property>> value)
{
    m_Additional_properties = value;
    m_Additional_propertiesIsSet = true;
}
bool ArtistResource::additionalPropertiesIsSet() const
{
...
bool ArtistResource::contributionCountIsSet() const
{
...
void ArtistResource::setContributions(std::vector<std::shared_ptr<ContributionResource>> value)
{
    m_Contributions = value;
    m_ContributionsIsSet = true;
}
...
bool ArtistResource::createdDateIsSet() const
{
...
bool ArtistResource::longDescriptionIsSet() const
{
...
bool ArtistResource::shortDescriptionIsSet() const
{
...
bool ArtistResource::updatedDateIsSet() const
{
