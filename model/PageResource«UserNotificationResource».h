...
/*
 * PageResource«UserNotificationResource».h
 *
 * 
 */

#ifndef PageResource«UserNotificationResource»_H_
#define PageResource«UserNotificationResource»_H_
...
public:
    ...
    virtual ~PageResource«UserNotificationResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«UserNotificationResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UserNotificationResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<UserNotificationResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<UserNotificationResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«UserNotificationResource»_H_ */
