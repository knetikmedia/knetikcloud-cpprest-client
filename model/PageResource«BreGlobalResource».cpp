...
bool PageResource«BreGlobalResource»::number_of_elementsIsSet() const
{
...
bool PageResource«BreGlobalResource»::total_elementsIsSet() const
{
...
bool PageResource«BreGlobalResource»::total_pagesIsSet() const
{
