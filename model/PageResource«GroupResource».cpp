...
void PageResource«GroupResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«GroupResource»::toJson() const
{
...
void PageResource«GroupResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<GroupResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<GroupResource> newItem(new GroupResource());
...
void PageResource«GroupResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«GroupResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<GroupResource>>& PageResource«GroupResource»::getContent()
{
    return m_Content;
}

void PageResource«GroupResource»::setContent(std::vector<std::shared_ptr<GroupResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«GroupResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«GroupResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«GroupResource»::getFirst() const
{
    return m_First;
}


void PageResource«GroupResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«GroupResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«GroupResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«GroupResource»::getLast() const
{
    return m_Last;
}


void PageResource«GroupResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«GroupResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«GroupResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«GroupResource»::getNumber() const
{
    return m_number;
}


void PageResource«GroupResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«GroupResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«GroupResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«GroupResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«GroupResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«GroupResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«GroupResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«GroupResource»::getSize() const
{
    return m_Size;
}


void PageResource«GroupResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«GroupResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«GroupResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«GroupResource»::getSort()
{
    return m_Sort;
}

void PageResource«GroupResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«GroupResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«GroupResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«GroupResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«GroupResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«GroupResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«GroupResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«GroupResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«GroupResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«GroupResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«GroupResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
