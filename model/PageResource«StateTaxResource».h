...
/*
 * PageResource«StateTaxResource».h
 *
 * 
 */

#ifndef PageResource«StateTaxResource»_H_
#define PageResource«StateTaxResource»_H_
...
public:
    ...
    virtual ~PageResource«StateTaxResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«StateTaxResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<StateTaxResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<StateTaxResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<StateTaxResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«StateTaxResource»_H_ */
