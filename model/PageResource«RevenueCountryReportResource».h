...
#ifndef PageResource«RevenueCountryReportResource»_H_
#define PageResource«RevenueCountryReportResource»_H_
...
/// 
/// </summary>
class  PageResource«RevenueCountryReportResource»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«RevenueCountryReportResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<RevenueCountryReportResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<RevenueCountryReportResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<RevenueCountryReportResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«RevenueCountryReportResource»_H_ */
