...
PageResource«ArtistResource»::PageResource«ArtistResource»()
{
...
void PageResource«ArtistResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«ArtistResource»::toJson() const
{
...
void PageResource«ArtistResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<ArtistResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<ArtistResource> newItem(new ArtistResource());
...
void PageResource«ArtistResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«ArtistResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<ArtistResource>>& PageResource«ArtistResource»::getContent()
{
    return m_Content;
}

void PageResource«ArtistResource»::setContent(std::vector<std::shared_ptr<ArtistResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«ArtistResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«ArtistResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«ArtistResource»::getFirst() const
{
    return m_First;
}


void PageResource«ArtistResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«ArtistResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«ArtistResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«ArtistResource»::getLast() const
{
    return m_Last;
}


void PageResource«ArtistResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«ArtistResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«ArtistResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«ArtistResource»::getNumber() const
{
    return m_number;
}


void PageResource«ArtistResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«ArtistResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«ArtistResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«ArtistResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«ArtistResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«ArtistResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«ArtistResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«ArtistResource»::getSize() const
{
    return m_Size;
}


void PageResource«ArtistResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«ArtistResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«ArtistResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«ArtistResource»::getSort()
{
    return m_Sort;
}

void PageResource«ArtistResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«ArtistResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«ArtistResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«ArtistResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«ArtistResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«ArtistResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«ArtistResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«ArtistResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«ArtistResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«ArtistResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«ArtistResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
