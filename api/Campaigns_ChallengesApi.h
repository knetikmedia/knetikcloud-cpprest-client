...
/*
 * Campaigns_ChallengesApi.h
 *
 * 
 */

#ifndef Campaigns_ChallengesApi_H_
#define Campaigns_ChallengesApi_H_
...
{
public:
    Campaigns_ChallengesApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Campaigns_ChallengesApi();
    /// <summary>
    /// Create a challenge
    /// </summary>
    /// <remarks>
    ...
    pplx::task<void> updateChallengeActivity(int64_t id, int64_t challengeId, std::shared_ptr<ChallengeActivityResource> challengeActivityResource, bool validateSettings);
    /// <summary>
...
#endif /* Campaigns_ChallengesApi_H_ */
