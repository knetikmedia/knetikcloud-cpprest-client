...
/*
 * PageResource«RevenueProductReportResource».h
 *
 * 
 */

#ifndef PageResource«RevenueProductReportResource»_H_
#define PageResource«RevenueProductReportResource»_H_
...
/// 
/// </summary>
class  PageResource«RevenueProductReportResource»
    : public ModelBase
{
public:
    PageResource«RevenueProductReportResource»();
    virtual ~PageResource«RevenueProductReportResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«RevenueProductReportResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<RevenueProductReportResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<RevenueProductReportResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<RevenueProductReportResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«RevenueProductReportResource»_H_ */
