...
/*
 * PageResource«CampaignResource».h
 *
 * 
 */

#ifndef PageResource«CampaignResource»_H_
#define PageResource«CampaignResource»_H_
...
/// 
/// </summary>
class  PageResource«CampaignResource»
    : public ModelBase
{
public:
    PageResource«CampaignResource»();
    virtual ~PageResource«CampaignResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«CampaignResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<CampaignResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<CampaignResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<CampaignResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«CampaignResource»_H_ */
