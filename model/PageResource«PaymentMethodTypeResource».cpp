...
PageResource«PaymentMethodTypeResource»::PageResource«PaymentMethodTypeResource»()
{
...
void PageResource«PaymentMethodTypeResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«PaymentMethodTypeResource»::toJson() const
{
...
void PageResource«PaymentMethodTypeResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<PaymentMethodTypeResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<PaymentMethodTypeResource> newItem(new PaymentMethodTypeResource());
...
void PageResource«PaymentMethodTypeResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«PaymentMethodTypeResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<PaymentMethodTypeResource>>& PageResource«PaymentMethodTypeResource»::getContent()
{
    return m_Content;
}

void PageResource«PaymentMethodTypeResource»::setContent(std::vector<std::shared_ptr<PaymentMethodTypeResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«PaymentMethodTypeResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«PaymentMethodTypeResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«PaymentMethodTypeResource»::getFirst() const
{
    return m_First;
}


void PageResource«PaymentMethodTypeResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«PaymentMethodTypeResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«PaymentMethodTypeResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«PaymentMethodTypeResource»::getLast() const
{
    return m_Last;
}


void PageResource«PaymentMethodTypeResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«PaymentMethodTypeResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«PaymentMethodTypeResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«PaymentMethodTypeResource»::getNumber() const
{
    return m_number;
}


void PageResource«PaymentMethodTypeResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«PaymentMethodTypeResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«PaymentMethodTypeResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«PaymentMethodTypeResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«PaymentMethodTypeResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«PaymentMethodTypeResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«PaymentMethodTypeResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«PaymentMethodTypeResource»::getSize() const
{
    return m_Size;
}


void PageResource«PaymentMethodTypeResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«PaymentMethodTypeResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«PaymentMethodTypeResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«PaymentMethodTypeResource»::getSort()
{
    return m_Sort;
}

void PageResource«PaymentMethodTypeResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«PaymentMethodTypeResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«PaymentMethodTypeResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«PaymentMethodTypeResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«PaymentMethodTypeResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«PaymentMethodTypeResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«PaymentMethodTypeResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«PaymentMethodTypeResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«PaymentMethodTypeResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«PaymentMethodTypeResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«PaymentMethodTypeResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
