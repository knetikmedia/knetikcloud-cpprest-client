...
/*
 * PageResource«AggregateInvoiceReportResource».h
 *
 * 
 */

#ifndef PageResource«AggregateInvoiceReportResource»_H_
#define PageResource«AggregateInvoiceReportResource»_H_
...
/// 
/// </summary>
class  PageResource«AggregateInvoiceReportResource»
    : public ModelBase
{
public:
    PageResource«AggregateInvoiceReportResource»();
    virtual ~PageResource«AggregateInvoiceReportResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«AggregateInvoiceReportResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AggregateInvoiceReportResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<AggregateInvoiceReportResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<AggregateInvoiceReportResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«AggregateInvoiceReportResource»_H_ */
