...
bool PageResource«string»::number_of_elementsIsSet() const
{
...
bool PageResource«string»::total_elementsIsSet() const
{
...
bool PageResource«string»::total_pagesIsSet() const
{
