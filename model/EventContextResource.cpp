...
utility::string_t EventContextResource::getDefinition() const
{
    return m_Definition;
}


void EventContextResource::setDefinition(utility::string_t value)
{
    m_Definition = value;
    m_DefinitionIsSet = true;
}
bool EventContextResource::definitionIsSet() const
{
    return m_DefinitionIsSet;
}

void EventContextResource::unsetDefinition()
{
    m_DefinitionIsSet = false;
}
