...
/*
 * PageResource«UserRelationshipResource».h
 *
 * 
 */

#ifndef PageResource«UserRelationshipResource»_H_
#define PageResource«UserRelationshipResource»_H_
...
/// 
/// </summary>
class  PageResource«UserRelationshipResource»
    : public ModelBase
{
public:
    PageResource«UserRelationshipResource»();
    virtual ~PageResource«UserRelationshipResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«UserRelationshipResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UserRelationshipResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<UserRelationshipResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<UserRelationshipResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«UserRelationshipResource»_H_ */
