...
/*
 * PageResource«GroupResource».h
 *
 * 
 */

#ifndef PageResource«GroupResource»_H_
#define PageResource«GroupResource»_H_
...
/// 
/// </summary>
class  PageResource«GroupResource»
    : public ModelBase
{
public:
    PageResource«GroupResource»();
    virtual ~PageResource«GroupResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«GroupResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<GroupResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<GroupResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<GroupResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«GroupResource»_H_ */
