...
/*
 * PageResource«TemplateResource».h
 *
 * 
 */

#ifndef PageResource«TemplateResource»_H_
#define PageResource«TemplateResource»_H_
...
/// 
/// </summary>
class  PageResource«TemplateResource»
    : public ModelBase
{
public:
    PageResource«TemplateResource»();
    virtual ~PageResource«TemplateResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«TemplateResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<TemplateResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<TemplateResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<TemplateResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«TemplateResource»_H_ */
