...
/*
 * PageResource«UserAchievementGroupResource».h
 *
 * 
 */

#ifndef PageResource«UserAchievementGroupResource»_H_
#define PageResource«UserAchievementGroupResource»_H_
...
/// 
/// </summary>
class  PageResource«UserAchievementGroupResource»
    : public ModelBase
{
public:
    PageResource«UserAchievementGroupResource»();
    virtual ~PageResource«UserAchievementGroupResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«UserAchievementGroupResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<UserAchievementGroupResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<UserAchievementGroupResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<UserAchievementGroupResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«UserAchievementGroupResource»_H_ */
