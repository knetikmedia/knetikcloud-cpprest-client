...
PageResource«Config»::PageResource«Config»()
{
...
void PageResource«Config»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«Config»::toJson() const
{
...
void PageResource«Config»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<Config>(nullptr) );
            }
            else
            {
                std::shared_ptr<Config> newItem(new Config());
...
void PageResource«Config»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«Config»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<Config>>& PageResource«Config»::getContent()
{
    return m_Content;
}

void PageResource«Config»::setContent(std::vector<std::shared_ptr<Config>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«Config»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«Config»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«Config»::getFirst() const
{
    return m_First;
}


void PageResource«Config»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«Config»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«Config»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«Config»::getLast() const
{
    return m_Last;
}


void PageResource«Config»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«Config»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«Config»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«Config»::getNumber() const
{
    return m_number;
}


void PageResource«Config»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«Config»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«Config»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«Config»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«Config»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«Config»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«Config»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«Config»::getSize() const
{
    return m_Size;
}


void PageResource«Config»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«Config»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«Config»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«Config»::getSort()
{
    return m_Sort;
}

void PageResource«Config»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«Config»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«Config»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«Config»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«Config»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«Config»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«Config»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«Config»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«Config»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«Config»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«Config»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
