...
/*
 * PageResource«QuestionTemplateResource».h
 *
 * 
 */

#ifndef PageResource«QuestionTemplateResource»_H_
#define PageResource«QuestionTemplateResource»_H_
...
/// 
/// </summary>
class  PageResource«QuestionTemplateResource»
    : public ModelBase
{
public:
    PageResource«QuestionTemplateResource»();
    virtual ~PageResource«QuestionTemplateResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«QuestionTemplateResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<QuestionTemplateResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<QuestionTemplateResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<QuestionTemplateResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«QuestionTemplateResource»_H_ */
