...
/*
 * PageResource«SavedAddressResource».h
 *
 * 
 */

#ifndef PageResource«SavedAddressResource»_H_
#define PageResource«SavedAddressResource»_H_
...
/// 
/// </summary>
class  PageResource«SavedAddressResource»
    : public ModelBase
{
public:
    PageResource«SavedAddressResource»();
    virtual ~PageResource«SavedAddressResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«SavedAddressResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<SavedAddressResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<SavedAddressResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<SavedAddressResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«SavedAddressResource»_H_ */
