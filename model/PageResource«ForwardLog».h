...
/*
 * PageResource«ForwardLog».h
 *
 * 
 */

#ifndef PageResource«ForwardLog»_H_
#define PageResource«ForwardLog»_H_
...
public:
    ...
    virtual ~PageResource«ForwardLog»();
    ...
    /////////////////////////////////////////////
    /// PageResource«ForwardLog» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ForwardLog>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ForwardLog>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ForwardLog>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ForwardLog»_H_ */
