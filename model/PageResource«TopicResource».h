...
#ifndef PageResource«TopicResource»_H_
#define PageResource«TopicResource»_H_
...
/// 
/// </summary>
class  PageResource«TopicResource»
    : public ModelBase
{
public:
    ...
    /////////////////////////////////////////////
    /// PageResource«TopicResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<TopicResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<TopicResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<TopicResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«TopicResource»_H_ */
