...
/*
 * Gamification_LeaderboardsApi.h
 *
 * 
 */

#ifndef Gamification_LeaderboardsApi_H_
#define Gamification_LeaderboardsApi_H_
...
{
public:
    Gamification_LeaderboardsApi( std::shared_ptr<ApiClient> apiClient );
    virtual ~Gamification_LeaderboardsApi();
    /// <summary>
...
#endif /* Gamification_LeaderboardsApi_H_ */
