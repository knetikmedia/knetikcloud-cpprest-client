...
utility::string_t IntegerOperationResource::getDefinition() const
{
    return m_Definition;
}


void IntegerOperationResource::setDefinition(utility::string_t value)
{
    m_Definition = value;
    m_DefinitionIsSet = true;
}
bool IntegerOperationResource::definitionIsSet() const
{
    return m_DefinitionIsSet;
}

void IntegerOperationResource::unsetDefinition()
{
    m_DefinitionIsSet = false;
}
...
utility::string_t IntegerOperationResource::getReturnType() const
{
    return m_Return_type;
}


void IntegerOperationResource::setReturnType(utility::string_t value)
{
    m_Return_type = value;
    m_Return_typeIsSet = true;
}
bool IntegerOperationResource::returnTypeIsSet() const
{
    return m_Return_typeIsSet;
}

void IntegerOperationResource::unsetReturn_type()
{
    m_Return_typeIsSet = false;
}

std::vector<std::shared_ptr<OperationDefinitionResource>>& IntegerOperationResource::getSupportedOperators()
{
    return m_Supported_operators;
}

void IntegerOperationResource::setSupportedOperators(std::vector<std::shared_ptr<OperationDefinitionResource>> value)
{
    m_Supported_operators = value;
    m_Supported_operatorsIsSet = true;
}
bool IntegerOperationResource::supportedOperatorsIsSet() const
{
    return m_Supported_operatorsIsSet;
}

void IntegerOperationResource::unsetSupported_operators()
{
    m_Supported_operatorsIsSet = false;
}
