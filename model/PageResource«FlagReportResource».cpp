...
PageResource«FlagReportResource»::PageResource«FlagReportResource»()
{
...
void PageResource«FlagReportResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«FlagReportResource»::toJson() const
{
...
void PageResource«FlagReportResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<FlagReportResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<FlagReportResource> newItem(new FlagReportResource());
...
void PageResource«FlagReportResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«FlagReportResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<FlagReportResource>>& PageResource«FlagReportResource»::getContent()
{
    return m_Content;
}

void PageResource«FlagReportResource»::setContent(std::vector<std::shared_ptr<FlagReportResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«FlagReportResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«FlagReportResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«FlagReportResource»::getFirst() const
{
    return m_First;
}


void PageResource«FlagReportResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«FlagReportResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«FlagReportResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«FlagReportResource»::getLast() const
{
    return m_Last;
}


void PageResource«FlagReportResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«FlagReportResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«FlagReportResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«FlagReportResource»::getNumber() const
{
    return m_number;
}


void PageResource«FlagReportResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«FlagReportResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«FlagReportResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«FlagReportResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«FlagReportResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«FlagReportResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«FlagReportResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«FlagReportResource»::getSize() const
{
    return m_Size;
}


void PageResource«FlagReportResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«FlagReportResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«FlagReportResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«FlagReportResource»::getSort()
{
    return m_Sort;
}

void PageResource«FlagReportResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«FlagReportResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«FlagReportResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«FlagReportResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«FlagReportResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«FlagReportResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«FlagReportResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«FlagReportResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«FlagReportResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«FlagReportResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«FlagReportResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
