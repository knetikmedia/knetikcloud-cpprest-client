...
/*
 * PageResource«ObjectResource».h
 *
 * 
 */

#ifndef PageResource«ObjectResource»_H_
#define PageResource«ObjectResource»_H_
...
/// 
/// </summary>
class  PageResource«ObjectResource»
    : public ModelBase
{
public:
    PageResource«ObjectResource»();
    virtual ~PageResource«ObjectResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«ObjectResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<ObjectResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<ObjectResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<ObjectResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«ObjectResource»_H_ */
