...
/*
 * PageResource«NotificationUserTypeResource».h
 *
 * 
 */

#ifndef PageResource«NotificationUserTypeResource»_H_
#define PageResource«NotificationUserTypeResource»_H_
...
/// 
/// </summary>
class  PageResource«NotificationUserTypeResource»
    : public ModelBase
{
public:
    PageResource«NotificationUserTypeResource»();
    virtual ~PageResource«NotificationUserTypeResource»();
    ...
    /////////////////////////////////////////////
    /// PageResource«NotificationUserTypeResource» members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<NotificationUserTypeResource>>& getContent();
    bool contentIsSet() const;
    void unsetContent();
    void setContent(std::vector<std::shared_ptr<NotificationUserTypeResource>> value);
    /// <summary>
    /// 
    /// </summary>
    bool getFirst() const;
...
protected:
    std::vector<std::shared_ptr<NotificationUserTypeResource>> m_Content;
    bool m_ContentIsSet;
    bool m_First;
    bool m_FirstIsSet;
    bool m_Last;
...
#endif /* PageResource«NotificationUserTypeResource»_H_ */
