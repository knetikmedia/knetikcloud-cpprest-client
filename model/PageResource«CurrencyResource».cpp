...
PageResource«CurrencyResource»::PageResource«CurrencyResource»()
{
...
void PageResource«CurrencyResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«CurrencyResource»::toJson() const
{
...
void PageResource«CurrencyResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<CurrencyResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<CurrencyResource> newItem(new CurrencyResource());
...
void PageResource«CurrencyResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«CurrencyResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<CurrencyResource>>& PageResource«CurrencyResource»::getContent()
{
    return m_Content;
}

void PageResource«CurrencyResource»::setContent(std::vector<std::shared_ptr<CurrencyResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«CurrencyResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«CurrencyResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«CurrencyResource»::getFirst() const
{
    return m_First;
}


void PageResource«CurrencyResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«CurrencyResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«CurrencyResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«CurrencyResource»::getLast() const
{
    return m_Last;
}


void PageResource«CurrencyResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«CurrencyResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«CurrencyResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«CurrencyResource»::getNumber() const
{
    return m_number;
}


void PageResource«CurrencyResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«CurrencyResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«CurrencyResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«CurrencyResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«CurrencyResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«CurrencyResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«CurrencyResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«CurrencyResource»::getSize() const
{
    return m_Size;
}


void PageResource«CurrencyResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«CurrencyResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«CurrencyResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«CurrencyResource»::getSort()
{
    return m_Sort;
}

void PageResource«CurrencyResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«CurrencyResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«CurrencyResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«CurrencyResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«CurrencyResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«CurrencyResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«CurrencyResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«CurrencyResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«CurrencyResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«CurrencyResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«CurrencyResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
