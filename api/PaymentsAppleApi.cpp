...
PaymentsAppleApi::PaymentsAppleApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<utility::string_t> PaymentsAppleApi::verifyAppleReceipt(std::shared_ptr<ApplyPaymentRequest> request)
{
    ...
    {
        throw ApiException(400, U("PaymentsAppleApi->verifyAppleReceipt does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, U("PaymentsAppleApi->verifyAppleReceipt does not consume any supported media type"));
    }
