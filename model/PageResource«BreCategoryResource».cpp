...
PageResource«BreCategoryResource»::PageResource«BreCategoryResource»()
{
...
void PageResource«BreCategoryResource»::validate()
{
    // TODO: implement validation
}

web::json::value PageResource«BreCategoryResource»::toJson() const
{
...
void PageResource«BreCategoryResource»::fromJson(web::json::value& val)
{
    {
        m_Content.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[U("content")].as_array() )
        {
            if(item.is_null())
            {
                m_Content.push_back( std::shared_ptr<BreCategoryResource>(nullptr) );
            }
            else
            {
                std::shared_ptr<BreCategoryResource> newItem(new BreCategoryResource());
...
void PageResource«BreCategoryResource»::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PageResource«BreCategoryResource»::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::vector<std::shared_ptr<BreCategoryResource>>& PageResource«BreCategoryResource»::getContent()
{
    return m_Content;
}

void PageResource«BreCategoryResource»::setContent(std::vector<std::shared_ptr<BreCategoryResource>> value)
{
    m_Content = value;
    m_ContentIsSet = true;
}
bool PageResource«BreCategoryResource»::contentIsSet() const
{
    return m_ContentIsSet;
}

void PageResource«BreCategoryResource»::unsetContent()
{
    m_ContentIsSet = false;
}

bool PageResource«BreCategoryResource»::getFirst() const
{
    return m_First;
}


void PageResource«BreCategoryResource»::setFirst(bool value)
{
    m_First = value;
    m_FirstIsSet = true;
}
bool PageResource«BreCategoryResource»::firstIsSet() const
{
    return m_FirstIsSet;
}

void PageResource«BreCategoryResource»::unsetFirst()
{
    m_FirstIsSet = false;
}

bool PageResource«BreCategoryResource»::getLast() const
{
    return m_Last;
}


void PageResource«BreCategoryResource»::setLast(bool value)
{
    m_Last = value;
    m_LastIsSet = true;
}
bool PageResource«BreCategoryResource»::lastIsSet() const
{
    return m_LastIsSet;
}

void PageResource«BreCategoryResource»::unsetLast()
{
    m_LastIsSet = false;
}

int32_t PageResource«BreCategoryResource»::getNumber() const
{
    return m_number;
}


void PageResource«BreCategoryResource»::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}
bool PageResource«BreCategoryResource»::numberIsSet() const
{
    return m_numberIsSet;
}

void PageResource«BreCategoryResource»::unsetnumber()
{
    m_numberIsSet = false;
}

int32_t PageResource«BreCategoryResource»::getNumberOfElements() const
{
    return m_Number_of_elements;
}


void PageResource«BreCategoryResource»::setNumberOfElements(int32_t value)
{
    m_Number_of_elements = value;
    m_Number_of_elementsIsSet = true;
}
bool PageResource«BreCategoryResource»::numberOfElementsIsSet() const
{
    return m_Number_of_elementsIsSet;
}

void PageResource«BreCategoryResource»::unsetNumber_of_elements()
{
    m_Number_of_elementsIsSet = false;
}

int32_t PageResource«BreCategoryResource»::getSize() const
{
    return m_Size;
}


void PageResource«BreCategoryResource»::setSize(int32_t value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
bool PageResource«BreCategoryResource»::sizeIsSet() const
{
    return m_SizeIsSet;
}

void PageResource«BreCategoryResource»::unsetSize()
{
    m_SizeIsSet = false;
}

std::vector<std::shared_ptr<Order>>& PageResource«BreCategoryResource»::getSort()
{
    return m_Sort;
}

void PageResource«BreCategoryResource»::setSort(std::vector<std::shared_ptr<Order>> value)
{
    m_Sort = value;
    m_SortIsSet = true;
}
bool PageResource«BreCategoryResource»::sortIsSet() const
{
    return m_SortIsSet;
}

void PageResource«BreCategoryResource»::unsetSort()
{
    m_SortIsSet = false;
}

int64_t PageResource«BreCategoryResource»::getTotalElements() const
{
    return m_Total_elements;
}


void PageResource«BreCategoryResource»::setTotalElements(int64_t value)
{
    m_Total_elements = value;
    m_Total_elementsIsSet = true;
}
bool PageResource«BreCategoryResource»::totalElementsIsSet() const
{
    return m_Total_elementsIsSet;
}

void PageResource«BreCategoryResource»::unsetTotal_elements()
{
    m_Total_elementsIsSet = false;
}

int32_t PageResource«BreCategoryResource»::getTotalPages() const
{
    return m_Total_pages;
}


void PageResource«BreCategoryResource»::setTotalPages(int32_t value)
{
    m_Total_pages = value;
    m_Total_pagesIsSet = true;
}
bool PageResource«BreCategoryResource»::totalPagesIsSet() const
{
    return m_Total_pagesIsSet;
}

void PageResource«BreCategoryResource»::unsetTotal_pages()
{
    m_Total_pagesIsSet = false;
}
