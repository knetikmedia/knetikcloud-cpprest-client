...
utility::string_t ConstantResource::getDefinition() const
{
    return m_Definition;
}


void ConstantResource::setDefinition(utility::string_t value)
{
    m_Definition = value;
    m_DefinitionIsSet = true;
}
bool ConstantResource::definitionIsSet() const
{
    return m_DefinitionIsSet;
}

void ConstantResource::unsetDefinition()
{
    m_DefinitionIsSet = false;
}
